	...
	if (!req.body.status) {
		...
		component: req.body.component == null ? "6723e788f072dffc31fe548f" : req.body.component,
		checkId: checkId,
	name: req.body.name,
		    nameRhs: null,
	racism: req.body.racism,
		    racismRhs: null,
	violentbehaviour: req.body.violentbehaviour,
		    violentbehaviourRhs: null,
	...
	misrepresentation: req.body.misrepresentation,
		    misrepresentationRhs: null,
	...
	status: req.body.status,
		...
		.then(data => {
			...
			.then(async caseData => {
			    await socialmedia.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
			//.then(caseData => {
			    let checksEntered = 0
		    ...
		    Case
			.update({ _id: req.body.case }, { $push: { actualComponents: "socialmedia" } })
			.then(data => {
		...
		.catch(err => {
		    res.status(500).json({
			message: err.message || 'Some error while saving socialmedia'
		    })
		})
	};
...
exports.findAllForACase = (req, res) => {
		...
		.catch(err => {
		    res.status(500).json({
			message: err.message || 'Some error while retrieving socialmedia for cases'
		    })
		})
	};
	...
	exports.update = (req, res) => {
	    ...
	    socialmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
	...
	exports.findOne = (req, res) => {
	    socialmedia.findOne({ case: req.params.caseId, _id: req.params.componentId })
		.then(data => {
		    res.json(data)
		})
		.catch(err => {
	...
	exports.findComponentsForVendorManager = (req, res) => {
		...
		socialmedia.find({ status: req.params.status })
		.sort({ _id: 1 })
		.skip(offSet)
		.limit(200)
		.populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
  ...
  try {
    ...
    const existing = await socialmedia.findOne({ case: caseId, _id: componentId });
	...
	// violentbehaviourRhs: req.body.violentbehaviourRhs,
	...
	// misrepresentationRhs: req.body.misrepresentationRhs,
	// verifiedbyRhs: req.body.verifiedbyRhs,
	// verifiedonRhs: req.body.verifiedonRhs,
	...
	exports.updateFeVerificationStatus = (req, res) => {
	    socialmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,racismRhs: req.body.racismRhs,violentbehaviourRhs: req.body.violentbehaviourRhs,unlawfulactivityRhs: req.body.unlawfulactivityRhs,sexuallyRhs: req.body.sexuallyRhs,religiousbeliefsRhs: req.body.religiousbeliefsRhs,misrepresentationRhs: req.body.misrepresentationRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
	status: req.body.status,
	...
	exports.updateVendorVerificationStatus = (req, res) => {
	    socialmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
		nameRhs: req.body.nameRhs,racismRhs: req.body.racismRhs,violentbehaviourRhs: req.body.violentbehaviourRhs,unlawfulactivityRhs: req.body.unlawfulactivityRhs,sexuallyRhs: req.body.sexuallyRhs,religiousbeliefsRhs: req.body.religiousbeliefsRhs,misrepresentationRhs: req.body.misrepresentationRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
	status: req.body.status,
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'socialmedia Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
	...
	// 	socialmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,racismRhs: req.body.data.racismRhs,violentbehaviourRhs: req.body.data.violentbehaviourRhs,unlawfulactivityRhs: req.body.data.unlawfulactivityRhs,sexuallyRhs: req.body.data.sexuallyRhs,religiousbeliefsRhs: req.body.data.religiousbeliefsRhs,misrepresentationRhs: req.body.data.misrepresentationRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
	// status: req.body.status,
	// 	mentorReviewCompletionDate: new Date(),
	// 		mentorReviewComments: req.body.mentorReviewComments,
	// 		mentorReviewCompletedBy: req.user.user_id
	...
	// 				    let mailText = subclientNotificationData.template.content
	// 				    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'socialmedia Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
	// 				    let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    socialmedia.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await socialmedia.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await socialmedia.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await socialmedia.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In socialmedia Create for CDE")
...
if (!req.body.violentbehaviour) {
            res.status(400).json({ message: "violentbehaviour is Mandatory" })
        }
...
if (!req.body.misrepresentation) {
            res.status(400).json({ message: "misrepresentation is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In socialmedia for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        socialmedia.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

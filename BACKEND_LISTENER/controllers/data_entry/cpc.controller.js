...
const cpc = require('../../models/data_entry/cpc.model')
...
if (!req.body.status) {
    ...
    const obj = new cpc({
        ...
        component: req.body.component == null ? "6722259eff5ce4ee231a907a" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
address: req.body.address,
            addressRhs: null,
policeststus: req.body.policeststus,
            policeststusRhs: null,
date: req.body.date,
            dateRhs: null,
policestation: req.body.policestation,
            policestationRhs: null,
contactdtails: req.body.contactdtails,
            contactdtailsRhs: null,
numberofyearscoverd: req.body.numberofyearscoverd,
            numberofyearscoverdRhs: null,
result: req.body.result,
            resultRhs: null,
additionalcomments: req.body.additionalcomments,
            additionalcommentsRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await cpc.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "cpc" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving cpc'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    cpc
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving cpc for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    cpc.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    cpc.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    cpc
        ...
        cpc.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await cpc.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await cpc.findOneAndUpdate(
...
// policeststusRhs: req.body.policeststusRhs,
// dateRhs: req.body.dateRhs,
// policestationRhs: req.body.policestationRhs,
// contactdtailsRhs: req.body.contactdtailsRhs,
// numberofyearscoverdRhs: req.body.numberofyearscoverdRhs,
// resultRhs: req.body.resultRhs,
// additionalcommentsRhs: req.body.additionalcommentsRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    cpc.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,fathernameRhs: req.body.fathernameRhs,dobRhs: req.body.dobRhs,addressRhs: req.body.addressRhs,policeststusRhs: req.body.policeststusRhs,dateRhs: req.body.dateRhs,policestationRhs: req.body.policestationRhs,contactdtailsRhs: req.body.contactdtailsRhs,numberofyearscoverdRhs: req.body.numberofyearscoverdRhs,resultRhs: req.body.resultRhs,additionalcommentsRhs: req.body.additionalcommentsRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'cpc Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         cpc.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,fathernameRhs: req.body.data.fathernameRhs,dobRhs: req.body.data.dobRhs,addressRhs: req.body.data.addressRhs,policeststusRhs: req.body.data.policeststusRhs,dateRhs: req.body.data.dateRhs,policestationRhs: req.body.data.policestationRhs,contactdtailsRhs: req.body.data.contactdtailsRhs,numberofyearscoverdRhs: req.body.data.numberofyearscoverdRhs,resultRhs: req.body.data.resultRhs,additionalcommentsRhs: req.body.data.additionalcommentsRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'cpc Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    cpc.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await cpc.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await cpc.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await cpc.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In cpc Create for CDE")
...
if (!req.body.policeststus) {
            res.status(400).json({ message: "policeststus is Mandatory" })
        }
if (!req.body.date) {
            res.status(400).json({ message: "date is Mandatory" })
        }
if (!req.body.policestation) {
            res.status(400).json({ message: "policestation is Mandatory" })
        }
if (!req.body.contactdtails) {
            res.status(400).json({ message: "contactdtails is Mandatory" })
        }
if (!req.body.numberofyearscoverd) {
            res.status(400).json({ message: "numberofyearscoverd is Mandatory" })
        }
if (!req.body.result) {
            res.status(400).json({ message: "result is Mandatory" })
        }
if (!req.body.additionalcomments) {
            res.status(400).json({ message: "additionalcomments is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In cpc for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        cpc.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

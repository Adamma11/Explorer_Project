...
const directorship = require('../../models/data_entry/directorship.model')
...
if (!req.body.status) {
    ...
    const obj = new directorship({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "67222b19ff5ce4ee231ac6a5" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
dob: req.body.dob,
...
fathername: req.body.fathername,
            fathernameRhs: null,
dinnumber: req.body.dinnumber,
            dinnumberRhs: null,
status: req.body.status,
            statusRhs: null,
legalobligations: req.body.legalobligations,
            legalobligationsRhs: null,
...
mov: req.body.mov,
            movRhs: null,
directorshipstatus: req.body.directorshipstatus,
            directorshipstatusRhs: null,
status: req.body.status,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await directorship.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "directorship" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving directorship'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    directorship
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving directorship for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    directorship.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    directorship.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
directorshipstatus: req.body.directorshipstatus,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    directorship
        ...
        directorship.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await directorship.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await directorship.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return directorship.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// dinnumberRhs: req.body.dinnumberRhs,
// statusRhs: req.body.statusRhs,
// legalobligationsRhs: req.body.legalobligationsRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
// movRhs: req.body.movRhs,
// directorshipstatusRhs: req.body.directorshipstatusRhs,
// status: req.body.status,
//             verificationCompletionDate: new Date(),
//             grade: req.body.grade,
//             grade1: req.body.grade,
...
exports.updateFeVerificationStatus = (req, res) => {
    directorship.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,dobRhs: req.body.dobRhs,fathernameRhs: req.body.fathernameRhs,dinnumberRhs: req.body.dinnumberRhs,statusRhs: req.body.statusRhs,legalobligationsRhs: req.body.legalobligationsRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,directorshipstatusRhs: req.body.directorshipstatusRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    directorship.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,dobRhs: req.body.dobRhs,fathernameRhs: req.body.fathernameRhs,dinnumberRhs: req.body.dinnumberRhs,statusRhs: req.body.statusRhs,legalobligationsRhs: req.body.legalobligationsRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,directorshipstatusRhs: req.body.directorshipstatusRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await directorship.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'directorship Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         directorship.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,dobRhs: req.body.data.dobRhs,fathernameRhs: req.body.data.fathernameRhs,dinnumberRhs: req.body.data.dinnumberRhs,statusRhs: req.body.data.statusRhs,legalobligationsRhs: req.body.data.legalobligationsRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,directorshipstatusRhs: req.body.data.directorshipstatusRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'directorship Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    directorship.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await directorship.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await directorship.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await directorship.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In directorship Create for CDE")
...
if (!req.body.dinnumber) {
            res.status(400).json({ message: "dinnumber is Mandatory" })
        }
if (!req.body.status) {
            res.status(400).json({ message: "status is Mandatory" })
        }
if (!req.body.legalobligations) {
            res.status(400).json({ message: "legalobligations is Mandatory" })
        }
...
if (!req.body.directorshipstatus) {
            res.status(400).json({ message: "directorshipstatus is Mandatory" })
        }
if (!req.body.status) {
    res.status(400).json({ message: 'Status required' })
}
...
exports.findOneForCde = (req, res) => {
    console.log("In directorship for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        directorship.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

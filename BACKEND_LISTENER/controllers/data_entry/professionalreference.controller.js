...
if (!req.body.status) {
    ...
    const obj = new professionalreference({
        ...
        component: req.body.component == null ? "6723e419f072dffc31fe4c93" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
rwr: req.body.rwr,
            rwrRhs: null,
knowthecandidate: req.body.knowthecandidate,
            knowthecandidateRhs: null,
...
skills: req.body.skills,
            skillsRhs: null,
managementskills: req.body.managementskills,
            managementskillsRhs: null,
...
punctuality: req.body.punctuality,
            punctualityRhs: null,
interfering: req.body.interfering,
            interferingRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await professionalreference.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
...
strengths: req.body.strengths,
weaknesses: req.body.weaknesses,
verifiedby: req.body.verifiedby,status: req.body.status,
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await professionalreference.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await professionalreference.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return professionalreference.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// emailRhs: req.body.emailRhs,
// rwrRhs: req.body.rwrRhs,
// knowthecandidateRhs: req.body.knowthecandidateRhs,
// communicationskillsRhs: req.body.communicationskillsRhs,
// pressureRhs: req.body.pressureRhs,
// skillsRhs: req.body.skillsRhs,
// managementskillsRhs: req.body.managementskillsRhs,
// reliabilityRhs: req.body.reliabilityRhs,
// honestyRhs: req.body.honestyRhs,
// punctualityRhs: req.body.punctualityRhs,
// interferingRhs: req.body.interferingRhs,
// ratingRhs: req.body.ratingRhs,
...
// goalsandobjectivesRhs: req.body.goalsandobjectivesRhs,
// strengthsRhs: req.body.strengthsRhs,
// weaknessesRhs: req.body.weaknessesRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// status: req.body.status,
//             verificationCompletionDate: new Date(),
//             grade: req.body.grade,
...
exports.updateFeVerificationStatus = (req, res) => {
    professionalreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,contactRhs: req.body.contactRhs,emailRhs: req.body.emailRhs,rwrRhs: req.body.rwrRhs,knowthecandidateRhs: req.body.knowthecandidateRhs,communicationskillsRhs: req.body.communicationskillsRhs,pressureRhs: req.body.pressureRhs,skillsRhs: req.body.skillsRhs,managementskillsRhs: req.body.managementskillsRhs,reliabilityRhs: req.body.reliabilityRhs,honestyRhs: req.body.honestyRhs,punctualityRhs: req.body.punctualityRhs,interferingRhs: req.body.interferingRhs,ratingRhs: req.body.ratingRhs,designationRhs: req.body.designationRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,dutiesandresponsibilitiesRhs: req.body.dutiesandresponsibilitiesRhs,goalsandobjectivesRhs: req.body.goalsandobjectivesRhs,strengthsRhs: req.body.strengthsRhs,weaknessesRhs: req.body.weaknessesRhs,verifiedbyRhs: req.body.verifiedbyRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    professionalreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,contactRhs: req.body.contactRhs,emailRhs: req.body.emailRhs,rwrRhs: req.body.rwrRhs,knowthecandidateRhs: req.body.knowthecandidateRhs,communicationskillsRhs: req.body.communicationskillsRhs,pressureRhs: req.body.pressureRhs,skillsRhs: req.body.skillsRhs,managementskillsRhs: req.body.managementskillsRhs,reliabilityRhs: req.body.reliabilityRhs,honestyRhs: req.body.honestyRhs,punctualityRhs: req.body.punctualityRhs,interferingRhs: req.body.interferingRhs,ratingRhs: req.body.ratingRhs,designationRhs: req.body.designationRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,dutiesandresponsibilitiesRhs: req.body.dutiesandresponsibilitiesRhs,goalsandobjectivesRhs: req.body.goalsandobjectivesRhs,strengthsRhs: req.body.strengthsRhs,weaknessesRhs: req.body.weaknessesRhs,verifiedbyRhs: req.body.verifiedbyRhs,
status: req.body.status,
...
//added code nov-07
        ...
        if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
            ...
            await professionalreference.findOneAndUpdate(
                { case: caseId, _id: componentId },
                {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'professionalreference Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         professionalreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,contactRhs: req.body.data.contactRhs,emailRhs: req.body.data.emailRhs,rwrRhs: req.body.data.rwrRhs,knowthecandidateRhs: req.body.data.knowthecandidateRhs,communicationskillsRhs: req.body.data.communicationskillsRhs,pressureRhs: req.body.data.pressureRhs,skillsRhs: req.body.data.skillsRhs,managementskillsRhs: req.body.data.managementskillsRhs,reliabilityRhs: req.body.data.reliabilityRhs,honestyRhs: req.body.data.honestyRhs,punctualityRhs: req.body.data.punctualityRhs,interferingRhs: req.body.data.interferingRhs,ratingRhs: req.body.data.ratingRhs,designationRhs: req.body.data.designationRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,dutiesandresponsibilitiesRhs: req.body.data.dutiesandresponsibilitiesRhs,goalsandobjectivesRhs: req.body.data.goalsandobjectivesRhs,strengthsRhs: req.body.data.strengthsRhs,weaknessesRhs: req.body.data.weaknessesRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'professionalreference Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await professionalreference.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await professionalreference.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await professionalreference.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In professionalreference Create for CDE")
...
if (!req.body.rwr) {
            res.status(400).json({ message: "rwr is Mandatory" })
        }
if (!req.body.knowthecandidate) {
            res.status(400).json({ message: "knowthecandidate is Mandatory" })
        }
if (!req.body.communicationskills) {
            res.status(400).json({ message: "communicationskills is Mandatory" })
        }
if (!req.body.pressure) {
            res.status(400).json({ message: "pressure is Mandatory" })
        }
if (!req.body.skills) {
            res.status(400).json({ message: "skills is Mandatory" })
        }
if (!req.body.managementskills) {
            res.status(400).json({ message: "managementskills is Mandatory" })
        }
if (!req.body.reliability) {
            res.status(400).json({ message: "reliability is Mandatory" })
        }
if (!req.body.honesty) {
            res.status(400).json({ message: "honesty is Mandatory" })
        }
if (!req.body.punctuality) {
            res.status(400).json({ message: "punctuality is Mandatory" })
        }
if (!req.body.interfering) {
            res.status(400).json({ message: "interfering is Mandatory" })
        }
if (!req.body.rating) {
            res.status(400).json({ message: "rating is Mandatory" })
        }
...
if (!req.body.goalsandobjectives) {
            res.status(400).json({ message: "goalsandobjectives is Mandatory" })
        }
if (!req.body.strengths) {
            res.status(400).json({ message: "strengths is Mandatory" })
        }
if (!req.body.weaknesses) {
            res.status(400).json({ message: "weaknesses is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In professionalreference for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        professionalreference.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

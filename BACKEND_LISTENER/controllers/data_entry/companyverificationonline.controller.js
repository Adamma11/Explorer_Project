...
const companyverificationonline = require('../../models/data_entry/companyverificationonline.model')
...
if (!req.body.status) {
    ...
    const obj = new companyverificationonline({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "67220de6ff5ce4ee231a87a3" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
companytype: req.body.companytype,
            companytypeRhs: null,
fakesearch: req.body.fakesearch,
            fakesearchRhs: null,
negativewebsearch: req.body.negativewebsearch,
            negativewebsearchRhs: null,
addressactive: req.body.addressactive,
            addressactiveRhs: null,
...
gstnumber: req.body.gstnumber,
            gstnumberRhs: null,
existingsince: req.body.existingsince,
            existingsinceRhs: null,
verifiedby: req.body.verifiedby,
            verifiedbyRhs: null,
verifiedon: req.body.verifiedon,
            verifiedonRhs: null,
nameofthedirectors: req.body.nameofthedirectors,
            nameofthedirectorsRhs: null,
mcafoundforthecompany: req.body.mcafoundforthecompany,
            mcafoundforthecompanyRhs: null,
mcastatus: req.body.mcastatus,
            mcastatusRhs: null,
dateofincorporation: req.body.dateofincorporation,
            dateofincorporationRhs: null,
lastbalancesheet: req.body.lastbalancesheet,
            lastbalancesheetRhs: null,
emailidaspermca: req.body.emailidaspermca,
            emailidaspermcaRhs: null,
mov: req.body.mov,
            movRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await companyverificationonline.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "companyverificationonline" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving companyverificationonline'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    companyverificationonline
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving companyverificationonline for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    companyverificationonline.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    companyverificationonline.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsFor = (req, res) => {
    ...
    companyverificationonline.find(query)
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    companyverificationonline
        ...
        companyverificationonline.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await companyverificationonline.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await companyverificationonline.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return companyverificationonline.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// locationRhs: req.body.locationRhs,
// companytypeRhs: req.body.companytypeRhs,
// fakesearchRhs: req.body.fakesearchRhs,
// negativewebsearchRhs: req.body.negativewebsearchRhs,
// addressactiveRhs: req.body.addressactiveRhs,
// addresstypeRhs: req.body.addresstypeRhs,
// numberRhs: req.body.numberRhs,
// emailidRhs: req.body.emailidRhs,
// epfoRhs: req.body.epfoRhs,
// gststatusRhs: req.body.gststatusRhs,
// gstnumberRhs: req.body.gstnumberRhs,
// existingsinceRhs: req.body.existingsinceRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
// nameofthedirectorsRhs: req.body.nameofthedirectorsRhs,
// mcafoundforthecompanyRhs: req.body.mcafoundforthecompanyRhs,
// mcastatusRhs: req.body.mcastatusRhs,
// dateofincorporationRhs: req.body.dateofincorporationRhs,
// lastbalancesheetRhs: req.body.lastbalancesheetRhs,
// emailidaspermcaRhs: req.body.emailidaspermcaRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    companyverificationonline.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,addressRhs: req.body.addressRhs,locationRhs: req.body.locationRhs,companytypeRhs: req.body.companytypeRhs,fakesearchRhs: req.body.fakesearchRhs,negativewebsearchRhs: req.body.negativewebsearchRhs,addressactiveRhs: req.body.addressactiveRhs,addresstypeRhs: req.body.addresstypeRhs,numberRhs: req.body.numberRhs,emailidRhs: req.body.emailidRhs,epfoRhs: req.body.epfoRhs,gststatusRhs: req.body.gststatusRhs,gstnumberRhs: req.body.gstnumberRhs,existingsinceRhs: req.body.existingsinceRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,nameofthedirectorsRhs: req.body.nameofthedirectorsRhs,mcafoundforthecompanyRhs: req.body.mcafoundforthecompanyRhs,mcastatusRhs: req.body.mcastatusRhs,dateofincorporationRhs: req.body.dateofincorporationRhs,lastbalancesheetRhs: req.body.lastbalancesheetRhs,emailidaspermcaRhs: req.body.emailidaspermcaRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    companyverificationonline.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,addressRhs: req.body.addressRhs,locationRhs: req.body.locationRhs,companytypeRhs: req.body.companytypeRhs,fakesearchRhs: req.body.fakesearchRhs,negativewebsearchRhs: req.body.negativewebsearchRhs,addressactiveRhs: req.body.addressactiveRhs,addresstypeRhs: req.body.addresstypeRhs,numberRhs: req.body.numberRhs,emailidRhs: req.body.emailidRhs,epfoRhs: req.body.epfoRhs,gststatusRhs: req.body.gststatusRhs,gstnumberRhs: req.body.gstnumberRhs,existingsinceRhs: req.body.existingsinceRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,nameofthedirectorsRhs: req.body.nameofthedirectorsRhs,mcafoundforthecompanyRhs: req.body.mcafoundforthecompanyRhs,mcastatusRhs: req.body.mcastatusRhs,dateofincorporationRhs: req.body.dateofincorporationRhs,lastbalancesheetRhs: req.body.lastbalancesheetRhs,emailidaspermcaRhs: req.body.emailidaspermcaRhs,movRhs: req.body.movRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await companyverificationonline.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'companyverificationonline Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         companyverificationonline.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,addressRhs: req.body.data.addressRhs,locationRhs: req.body.data.locationRhs,companytypeRhs: req.body.data.companytypeRhs,fakesearchRhs: req.body.data.fakesearchRhs,negativewebsearchRhs: req.body.data.negativewebsearchRhs,addressactiveRhs: req.body.data.addressactiveRhs,addresstypeRhs: req.body.data.addresstypeRhs,numberRhs: req.body.data.numberRhs,emailidRhs: req.body.data.emailidRhs,epfoRhs: req.body.data.epfoRhs,gststatusRhs: req.body.data.gststatusRhs,gstnumberRhs: req.body.data.gstnumberRhs,existingsinceRhs: req.body.data.existingsinceRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,nameofthedirectorsRhs: req.body.data.nameofthedirectorsRhs,mcafoundforthecompanyRhs: req.body.data.mcafoundforthecompanyRhs,mcastatusRhs: req.body.data.mcastatusRhs,dateofincorporationRhs: req.body.data.dateofincorporationRhs,lastbalancesheetRhs: req.body.data.lastbalancesheetRhs,emailidaspermcaRhs: req.body.data.emailidaspermcaRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'companyverificationonline Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    companyverificationonline.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await companyverificationonline.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await companyverificationonline.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await companyverificationonline.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In companyverificationonline Create for CDE")
...
if (!req.body.location) {
            res.status(400).json({ message: "location is Mandatory" })
        }
if (!req.body.companytype) {
            res.status(400).json({ message: "companytype is Mandatory" })
        }
if (!req.body.fakesearch) {
            res.status(400).json({ message: "fakesearch is Mandatory" })
        }
if (!req.body.negativewebsearch) {
            res.status(400).json({ message: "negativewebsearch is Mandatory" })
        }
if (!req.body.addressactive) {
            res.status(400).json({ message: "addressactive is Mandatory" })
        }
if (!req.body.addresstype) {
            res.status(400).json({ message: "addresstype is Mandatory" })
        }
if (!req.body.number) {
            res.status(400).json({ message: "number is Mandatory" })
        }
if (!req.body.emailid) {
            res.status(400).json({ message: "emailid is Mandatory" })
        }
if (!req.body.epfo) {
            res.status(400).json({ message: "epfo is Mandatory" })
        }
if (!req.body.gststatus) {
            res.status(400).json({ message: "gststatus is Mandatory" })
        }
if (!req.body.gstnumber) {
            res.status(400).json({ message: "gstnumber is Mandatory" })
        }
if (!req.body.existingsince) {
            res.status(400).json({ message: "existingsince is Mandatory" })
        }
...
if (!req.body.nameofthedirectors) {
            res.status(400).json({ message: "nameofthedirectors is Mandatory" })
        }
if (!req.body.mcafoundforthecompany) {
            res.status(400).json({ message: "mcafoundforthecompany is Mandatory" })
        }
if (!req.body.mcastatus) {
            res.status(400).json({ message: "mcastatus is Mandatory" })
        }
if (!req.body.dateofincorporation) {
            res.status(400).json({ message: "dateofincorporation is Mandatory" })
        }
if (!req.body.lastbalancesheet) {
            res.status(400).json({ message: "lastbalancesheet is Mandatory" })
        }
if (!req.body.emailidaspermca) {
            res.status(400).json({ message: "emailidaspermca is Mandatory" })
        }
if (!req.body.mov) {
...
exports.findOneForCde = (req, res) => {
    console.log("In companyverificationonline for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        companyverificationonline.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

...
if (!req.body.status) {
    ...
    const obj = new voterid({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6723e949f072dffc31fe59c5" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
state: req.body.state,
            stateRhs: null,
districtconstituency: req.body.districtconstituency,
            districtconstituencyRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await voterid.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "voterid" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving voterid'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    voterid
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving voterid for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    voterid.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    voterid.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
dob: req.body.dob,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    voterid
        ...
        voterid.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await voterid.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await voterid.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return voterid.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// stateRhs: req.body.stateRhs,
// districtconstituencyRhs: req.body.districtconstituencyRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    voterid.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,fathernameRhs: req.body.fathernameRhs,genderRhs: req.body.genderRhs,stateRhs: req.body.stateRhs,districtconstituencyRhs: req.body.districtconstituencyRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,dobRhs: req.body.dobRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    voterid.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,fathernameRhs: req.body.fathernameRhs,genderRhs: req.body.genderRhs,stateRhs: req.body.stateRhs,districtconstituencyRhs: req.body.districtconstituencyRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,dobRhs: req.body.dobRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await voterid.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'voterid Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         voterid.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,fathernameRhs: req.body.data.fathernameRhs,genderRhs: req.body.data.genderRhs,stateRhs: req.body.data.stateRhs,districtconstituencyRhs: req.body.data.districtconstituencyRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,dobRhs: req.body.data.dobRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'voterid Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    voterid.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await voterid.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await voterid.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await voterid.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In voterid Create for CDE")
...
if (!req.body.districtconstituency) {
            res.status(400).json({ message: "districtconstituency is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In voterid for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        voterid.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

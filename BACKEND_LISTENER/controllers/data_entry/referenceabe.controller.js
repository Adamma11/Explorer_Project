...
const referenceabe = require('../../models/data_entry/referenceabe.model')
...
if (!req.body.contact) {
                    return res.status(400).json({ message: "contact is Mandatory" })
                }
if (!req.body.emailid) {
                    return res.status(400).json({ message: "emailid is Mandatory" })
                }
if (!req.body.status) {
        res.status(400).json({ message: 'Status required' })
    }
    const obj = new referenceabe({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6723e554f072dffc31fe4e55" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
emailid: req.body.emailid,
            emailidRhs: null,
relationshipwithcandidate: req.body.relationshipwithcandidate,
            relationshipwithcandidateRhs: null,
capacity: req.body.capacity,
            capacityRhs: null,
accomplishmentsduringthetime: req.body.accomplishmentsduringthetime,
            accomplishmentsduringthetimeRhs: null,
ifyouwerepullingtogetherateamwouldyouhirethecandidate: req.body.ifyouwerepullingtogetherateamwouldyouhirethecandidate,
            ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs: null,
inwhatcapacitydoyouseethecandidate: req.body.inwhatcapacitydoyouseethecandidate,
            inwhatcapacitydoyouseethecandidateRhs: null,
whatarethecandidatestrengths: req.body.whatarethecandidatestrengths,
            whatarethecandidatestrengthsRhs: null,
haveyouseenthecandidateoperateunderstress: req.body.haveyouseenthecandidateoperateunderstress,
            haveyouseenthecandidateoperateunderstressRhs: null,
transitionintotheneworganization: req.body.transitionintotheneworganization,
            transitionintotheneworganizationRhs: null,
motivates: req.body.motivates,
            motivatesRhs: null,
interfacewithotherdepartments: req.body.interfacewithotherdepartments,
            interfacewithotherdepartmentsRhs: null,
communicationsskillsoralandwritten: req.body.communicationsskillsoralandwritten,
            communicationsskillsoralandwrittenRhs: null,
misbehavior: req.body.misbehavior,
            misbehaviorRhs: null,
otherthoughtsaboutthecandidate: req.body.otherthoughtsaboutthecandidate,
            otherthoughtsaboutthecandidateRhs: null,
leadershipcapacity: req.body.leadershipcapacity,
            leadershipcapacityRhs: null,
rate: req.body.rate,
            rateRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await referenceabe.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "referenceabe" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving referenceabe'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    referenceabe
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving referenceabe for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    referenceabe.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    referenceabe.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    referenceabe
        ...
        referenceabe.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await referenceabe.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await referenceabe.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return referenceabe.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// contactRhs: req.body.contactRhs,
// emailidRhs: req.body.emailidRhs,
// relationshipwithcandidateRhs: req.body.relationshipwithcandidateRhs,
// capacityRhs: req.body.capacityRhs,
// accomplishmentsduringthetimeRhs: req.body.accomplishmentsduringthetimeRhs,
// ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs: req.body.ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs,
// inwhatcapacitydoyouseethecandidateRhs: req.body.inwhatcapacitydoyouseethecandidateRhs,
// whatarethecandidatestrengthsRhs: req.body.whatarethecandidatestrengthsRhs,
// haveyouseenthecandidateoperateunderstressRhs: req.body.haveyouseenthecandidateoperateunderstressRhs,
// transitionintotheneworganizationRhs: req.body.transitionintotheneworganizationRhs,
// motivatesRhs: req.body.motivatesRhs,
// interfacewithotherdepartmentsRhs: req.body.interfacewithotherdepartmentsRhs,
// communicationsskillsoralandwrittenRhs: req.body.communicationsskillsoralandwrittenRhs,
// misbehaviorRhs: req.body.misbehaviorRhs,
// otherthoughtsaboutthecandidateRhs: req.body.otherthoughtsaboutthecandidateRhs,
// leadershipcapacityRhs: req.body.leadershipcapacityRhs,
// rateRhs: req.body.rateRhs,
// previousjobRhs: req.body.previousjobRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    referenceabe.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,contactRhs: req.body.contactRhs,emailidRhs: req.body.emailidRhs,relationshipwithcandidateRhs: req.body.relationshipwithcandidateRhs,capacityRhs: req.body.capacityRhs,accomplishmentsduringthetimeRhs: req.body.accomplishmentsduringthetimeRhs,ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs: req.body.ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs,inwhatcapacitydoyouseethecandidateRhs: req.body.inwhatcapacitydoyouseethecandidateRhs,whatarethecandidatestrengthsRhs: req.body.whatarethecandidatestrengthsRhs,haveyouseenthecandidateoperateunderstressRhs: req.body.haveyouseenthecandidateoperateunderstressRhs,transitionintotheneworganizationRhs: req.body.transitionintotheneworganizationRhs,motivatesRhs: req.body.motivatesRhs,interfacewithotherdepartmentsRhs: req.body.interfacewithotherdepartmentsRhs,communicationsskillsoralandwrittenRhs: req.body.communicationsskillsoralandwrittenRhs,misbehaviorRhs: req.body.misbehaviorRhs,otherthoughtsaboutthecandidateRhs: req.body.otherthoughtsaboutthecandidateRhs,leadershipcapacityRhs: req.body.leadershipcapacityRhs,rateRhs: req.body.rateRhs,previousjobRhs: req.body.previousjobRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    referenceabe.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,contactRhs: req.body.contactRhs,emailidRhs: req.body.emailidRhs,relationshipwithcandidateRhs: req.body.relationshipwithcandidateRhs,capacityRhs: req.body.capacityRhs,accomplishmentsduringthetimeRhs: req.body.accomplishmentsduringthetimeRhs,ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs: req.body.ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs,inwhatcapacitydoyouseethecandidateRhs: req.body.inwhatcapacitydoyouseethecandidateRhs,whatarethecandidatestrengthsRhs: req.body.whatarethecandidatestrengthsRhs,haveyouseenthecandidateoperateunderstressRhs: req.body.haveyouseenthecandidateoperateunderstressRhs,transitionintotheneworganizationRhs: req.body.transitionintotheneworganizationRhs,motivatesRhs: req.body.motivatesRhs,interfacewithotherdepartmentsRhs: req.body.interfacewithotherdepartmentsRhs,communicationsskillsoralandwrittenRhs: req.body.communicationsskillsoralandwrittenRhs,misbehaviorRhs: req.body.misbehaviorRhs,otherthoughtsaboutthecandidateRhs: req.body.otherthoughtsaboutthecandidateRhs,leadershipcapacityRhs: req.body.leadershipcapacityRhs,rateRhs: req.body.rateRhs,previousjobRhs: req.body.previousjobRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await referenceabe.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'referenceabe Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         referenceabe.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,contactRhs: req.body.data.contactRhs,emailidRhs: req.body.data.emailidRhs,relationshipwithcandidateRhs: req.body.data.relationshipwithcandidateRhs,capacityRhs: req.body.data.capacityRhs,accomplishmentsduringthetimeRhs: req.body.data.accomplishmentsduringthetimeRhs,ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs: req.body.data.ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs,inwhatcapacitydoyouseethecandidateRhs: req.body.data.inwhatcapacitydoyouseethecandidateRhs,whatarethecandidatestrengthsRhs: req.body.data.whatarethecandidatestrengthsRhs,haveyouseenthecandidateoperateunderstressRhs: req.body.data.haveyouseenthecandidateoperateunderstressRhs,transitionintotheneworganizationRhs: req.body.data.transitionintotheneworganizationRhs,motivatesRhs: req.body.data.motivatesRhs,interfacewithotherdepartmentsRhs: req.body.data.interfacewithotherdepartmentsRhs,communicationsskillsoralandwrittenRhs: req.body.data.communicationsskillsoralandwrittenRhs,misbehaviorRhs: req.body.data.misbehaviorRhs,otherthoughtsaboutthecandidateRhs: req.body.data.otherthoughtsaboutthecandidateRhs,leadershipcapacityRhs: req.body.data.leadershipcapacityRhs,rateRhs: req.body.data.rateRhs,previousjobRhs: req.body.data.previousjobRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'referenceabe Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    referenceabe.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await referenceabe.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await referenceabe.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await referenceabe.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In referenceabe Create for CDE")
...
if (!req.body.contact) {
            res.status(400).json({ message: "contact is Mandatory" })
        }
if (!req.body.emailid) {
            res.status(400).json({ message: "emailid is Mandatory" })
        }
if (!req.body.relationshipwithcandidate) {
            res.status(400).json({ message: "relationshipwithcandidate is Mandatory" })
        }
if (!req.body.capacity) {
            res.status(400).json({ message: "capacity is Mandatory" })
        }
if (!req.body.accomplishmentsduringthetime) {
            res.status(400).json({ message: "accomplishmentsduringthetime is Mandatory" })
        }
if (!req.body.ifyouwerepullingtogetherateamwouldyouhirethecandidate) {
            res.status(400).json({ message: "ifyouwerepullingtogetherateamwouldyouhirethecandidate is Mandatory" })
        }
if (!req.body.inwhatcapacitydoyouseethecandidate) {
            res.status(400).json({ message: "inwhatcapacitydoyouseethecandidate is Mandatory" })
        }
if (!req.body.whatarethecandidatestrengths) {
            res.status(400).json({ message: "whatarethecandidatestrengths is Mandatory" })
        }
if (!req.body.haveyouseenthecandidateoperateunderstress) {
            res.status(400).json({ message: "haveyouseenthecandidateoperateunderstress is Mandatory" })
        }
if (!req.body.transitionintotheneworganization) {
            res.status(400).json({ message: "transitionintotheneworganization is Mandatory" })
        }
if (!req.body.motivates) {
            res.status(400).json({ message: "motivates is Mandatory" })
        }
if (!req.body.interfacewithotherdepartments) {
            res.status(400).json({ message: "interfacewithotherdepartments is Mandatory" })
        }
if (!req.body.communicationsskillsoralandwritten) {
            res.status(400).json({ message: "communicationsskillsoralandwritten is Mandatory" })
        }
if (!req.body.misbehavior) {
            res.status(400).json({ message: "misbehavior is Mandatory" })
        }
if (!req.body.otherthoughtsaboutthecandidate) {
            res.status(400).json({ message: "otherthoughtsaboutthecandidate is Mandatory" })
        }
if (!req.body.leadershipcapacity) {
            res.status(400).json({ message: "leadershipcapacity is Mandatory" })
        }
if (!req.body.rate) {
            res.status(400).json({ message: "rate is Mandatory" })
        }
if (!req.body.previousjob) {
            res.status(400).json({ message: "previousjob is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In referenceabe for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        referenceabe.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

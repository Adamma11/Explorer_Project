...
const companyverificationphysical = require('../../models/data_entry/companyverificationphysical.model')
...
if (!req.body.status) {
    ...
    const obj = new companyverificationphysical({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "67222540ff5ce4ee231a8c19" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
address: req.body.address,
            addressRhs: null,
singboard: req.body.singboard,
            singboardRhs: null,
feallowed: req.body.feallowed,
            feallowedRhs: null,
officelocation: req.body.officelocation,
            officelocationRhs: null,
companysize: req.body.companysize,
            companysizeRhs: null,
companyexistingsince: req.body.companyexistingsince,
            companyexistingsinceRhs: null,
contactnumberoftheindividual: req.body.contactnumberoftheindividual,
            contactnumberoftheindividualRhs: null,
designationoftheindividual: req.body.designationoftheindividual,
            designationoftheindividualRhs: null,
designationoftheindividualwhoprovideddetails: req.body.designationoftheindividualwhoprovideddetails,
            designationoftheindividualwhoprovideddetailsRhs: null,
...
mov: req.body.mov,
            movRhs: null,
nameoftheindividual: req.body.nameoftheindividual,
            nameoftheindividualRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await companyverificationphysical.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "companyverificationphysical" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving companyverificationphysical'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    companyverificationphysical
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving companyverificationphysical for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    companyverificationphysical.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    companyverificationphysical.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
nameoftheindividual: req.body.nameoftheindividual,status: req.body.status,
...
exports.findComponentsFor = (req, res) => {
    ...
    companyverificationphysical.find(query)
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    companyverificationphysical
        ...
        companyverificationphysical.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await companyverificationphysical.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await companyverificationphysical.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return companyverificationphysical.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// singboardRhs: req.body.singboardRhs,
// feallowedRhs: req.body.feallowedRhs,
// officelocationRhs: req.body.officelocationRhs,
// companysizeRhs: req.body.companysizeRhs,
// companyexistingsinceRhs: req.body.companyexistingsinceRhs,
// contactnumberoftheindividualRhs: req.body.contactnumberoftheindividualRhs,
// designationoftheindividualRhs: req.body.designationoftheindividualRhs,
// designationoftheindividualwhoprovideddetailsRhs: req.body.designationoftheindividualwhoprovideddetailsRhs,
// locationRhs: req.body.locationRhs,
// pincodeRhs: req.body.pincodeRhs,
// stateRhs: req.body.stateRhs,
...
// nameoftheindividualRhs: req.body.nameoftheindividualRhs,
// status: req.body.status,
//             verificationCompletionDate: new Date(),
//             grade: req.body.grade,
//             grade1: req.body.grade,
...
exports.updateFeVerificationStatus = (req, res) => {
    companyverificationphysical.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,addressRhs: req.body.addressRhs,singboardRhs: req.body.singboardRhs,feallowedRhs: req.body.feallowedRhs,officelocationRhs: req.body.officelocationRhs,companysizeRhs: req.body.companysizeRhs,companyexistingsinceRhs: req.body.companyexistingsinceRhs,contactnumberoftheindividualRhs: req.body.contactnumberoftheindividualRhs,designationoftheindividualRhs: req.body.designationoftheindividualRhs,designationoftheindividualwhoprovideddetailsRhs: req.body.designationoftheindividualwhoprovideddetailsRhs,locationRhs: req.body.locationRhs,pincodeRhs: req.body.pincodeRhs,stateRhs: req.body.stateRhs,countryRhs: req.body.countryRhs,landmarkRhs: req.body.landmarkRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,nameoftheindividualRhs: req.body.nameoftheindividualRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    companyverificationphysical.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,addressRhs: req.body.addressRhs,singboardRhs: req.body.singboardRhs,feallowedRhs: req.body.feallowedRhs,officelocationRhs: req.body.officelocationRhs,companysizeRhs: req.body.companysizeRhs,companyexistingsinceRhs: req.body.companyexistingsinceRhs,contactnumberoftheindividualRhs: req.body.contactnumberoftheindividualRhs,designationoftheindividualRhs: req.body.designationoftheindividualRhs,designationoftheindividualwhoprovideddetailsRhs: req.body.designationoftheindividualwhoprovideddetailsRhs,locationRhs: req.body.locationRhs,pincodeRhs: req.body.pincodeRhs,stateRhs: req.body.stateRhs,countryRhs: req.body.countryRhs,landmarkRhs: req.body.landmarkRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,nameoftheindividualRhs: req.body.nameoftheindividualRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await companyverificationphysical.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'companyverificationphysical Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         companyverificationphysical.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,addressRhs: req.body.data.addressRhs,singboardRhs: req.body.data.singboardRhs,feallowedRhs: req.body.data.feallowedRhs,officelocationRhs: req.body.data.officelocationRhs,companysizeRhs: req.body.data.companysizeRhs,companyexistingsinceRhs: req.body.data.companyexistingsinceRhs,contactnumberoftheindividualRhs: req.body.data.contactnumberoftheindividualRhs,designationoftheindividualRhs: req.body.data.designationoftheindividualRhs,designationoftheindividualwhoprovideddetailsRhs: req.body.data.designationoftheindividualwhoprovideddetailsRhs,locationRhs: req.body.data.locationRhs,pincodeRhs: req.body.data.pincodeRhs,stateRhs: req.body.data.stateRhs,countryRhs: req.body.data.countryRhs,landmarkRhs: req.body.data.landmarkRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,nameoftheindividualRhs: req.body.data.nameoftheindividualRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'companyverificationphysical Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    companyverificationphysical.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await companyverificationphysical.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await companyverificationphysical.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await companyverificationphysical.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In companyverificationphysical Create for CDE")
...
if (!req.body.singboard) {
            res.status(400).json({ message: "singboard is Mandatory" })
        }
if (!req.body.feallowed) {
            res.status(400).json({ message: "feallowed is Mandatory" })
        }
if (!req.body.officelocation) {
            res.status(400).json({ message: "officelocation is Mandatory" })
        }
if (!req.body.companysize) {
            res.status(400).json({ message: "companysize is Mandatory" })
        }
if (!req.body.companyexistingsince) {
            res.status(400).json({ message: "companyexistingsince is Mandatory" })
        }
if (!req.body.contactnumberoftheindividual) {
            res.status(400).json({ message: "contactnumberoftheindividual is Mandatory" })
        }
if (!req.body.designationoftheindividual) {
            res.status(400).json({ message: "designationoftheindividual is Mandatory" })
        }
if (!req.body.designationoftheindividualwhoprovideddetails) {
            res.status(400).json({ message: "designationoftheindividualwhoprovideddetails is Mandatory" })
        }
if (!req.body.location) {
            res.status(400).json({ message: "location is Mandatory" })
        }
if (!req.body.pincode) {
            res.status(400).json({ message: "pincode is Mandatory" })
        }
if (!req.body.state) {
            res.status(400).json({ message: "state is Mandatory" })
        }
if (!req.body.country) {
            res.status(400).json({ message: "country is Mandatory" })
        }
if (!req.body.landmark) {
            res.status(400).json({ message: "landmark is Mandatory" })
        }
...
if (!req.body.nameoftheindividual) {
            res.status(400).json({ message: "nameoftheindividual is Mandatory" })
        }
if (!req.body.status) {
    res.status(400).json({ message: 'Status required' })
}
...
exports.findOneForCde = (req, res) => {
    console.log("In companyverificationphysical for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        companyverificationphysical.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

...
const previousemployment = require('../../models/data_entry/previousemployment.model')
...
if (!req.body.company) {
                    return res.status(400).json({ message: "company is Mandatory" })
                }
if (!req.body.officeaddress) {
                    return res.status(400).json({ message: "officeaddress is Mandatory" })
                }
if (!req.body.employeeid) {
                    return res.status(400).json({ message: "employeeid is Mandatory" })
                }
if (!req.body.doj) {
                    return res.status(400).json({ message: "doj is Mandatory" })
                }
if (!req.body.dor) {
...
if (!req.body.worktype) {
                    return res.status(400).json({ message: "worktype is Mandatory" })
                }
if (!req.body.reportingmanager) {
                    return res.status(400).json({ message: "reportingmanager is Mandatory" })
                }
if (!req.body.reportingmanagercontact) {
                    return res.status(400).json({ message: "reportingmanagercontact is Mandatory" })
                }
if (!req.body.monthlysalary) {
                    return res.status(400).json({ message: "monthlysalary is Mandatory" })
                }
if (!req.body.annualcosttocompany) {
                    return res.status(400).json({ message: "annualcosttocompany is Mandatory" })
                }
if (!req.body.reasonforleaving) {
                    return res.status(400).json({ message: "reasonforleaving is Mandatory" })
                }
if (!req.body.status) {
        res.status(400).json({ message: 'Status required' })
    }
    const obj = new previousemployment({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "68d3782ea9c6178d41438295" : req.body.component,
        checkId: checkId,
company: req.body.company,
            companyRhs: null,
officeaddress: req.body.officeaddress,
            officeaddressRhs: null,
...
reportingmanager: req.body.reportingmanager,
            reportingmanagerRhs: null,
reportingmanagercontact: req.body.reportingmanagercontact,
            reportingmanagercontactRhs: null,
monthlysalary: req.body.monthlysalary,
            monthlysalaryRhs: null,
annualcosttocompany: req.body.annualcosttocompany,
            annualcosttocompanyRhs: null,
reasonforleaving: req.body.reasonforleaving,
            reasonforleavingRhs: null,
verifiedby: req.body.verifiedby,
            verifiedbyRhs: null,
verifierdesignation: req.body.verifierdesignation,
            verifierdesignationRhs: null,
duties: req.body.duties,
            dutiesRhs: null,
integrity: req.body.integrity,
            integrityRhs: null,
officialresignation: req.body.officialresignation,
            officialresignationRhs: null,
eligibleforrehire: req.body.eligibleforrehire,
            eligibleforrehireRhs: null,
exitformalities: req.body.exitformalities,
            exitformalitiesRhs: null,
mov: req.body.mov,
            movRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await previousemployment.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "previousemployment" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving previousemployment'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    previousemployment
      // .find({ case: req.params.case })
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving previousemployment for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    previousemployment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    previousemployment.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exitformalities: req.body.exitformalities,
mov: req.body.mov,
remarks: req.body.remarks,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    previousemployment
        ...
        previousemployment.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
//new code added sep-29//
exports.updateVerificationStatus = async (req, res) => {
    try {
        const { caseId, componentId } = req.params;
        const existing = await previousemployment.findOne({ case: caseId, _id: componentId });
        ...
        if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
            ...
            const updated = await previousemployment.findOneAndUpdate(
        ...
        if (req.body.status === 'DRAFT') {
            return previousemployment.findOneAndUpdate(
                { case: caseId, _id: componentId },
                {
                    ...updateData,
                    stage: 'WIP'
...
//         previousemployment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
// companyRhs: req.body.companyRhs,
// officeaddressRhs: req.body.officeaddressRhs,
// employeeidRhs: req.body.employeeidRhs,
// dojRhs: req.body.dojRhs,
// dorRhs: req.body.dorRhs,
// designationRhs: req.body.designationRhs,
// worktypeRhs: req.body.worktypeRhs,
// reportingmanagerRhs: req.body.reportingmanagerRhs,
// reportingmanagercontactRhs: req.body.reportingmanagercontactRhs,
// monthlysalaryRhs: req.body.monthlysalaryRhs,
// annualcosttocompanyRhs: req.body.annualcosttocompanyRhs,
// reasonforleavingRhs: req.body.reasonforleavingRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifierdesignationRhs: req.body.verifierdesignationRhs,
// dutiesRhs: req.body.dutiesRhs,
// integrityRhs: req.body.integrityRhs,
// officialresignationRhs: req.body.officialresignationRhs,
// eligibleforrehireRhs: req.body.eligibleforrehireRhs,
// exitformalitiesRhs: req.body.exitformalitiesRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    previousemployment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {companyRhs: req.body.companyRhs,officeaddressRhs: req.body.officeaddressRhs,employeeidRhs: req.body.employeeidRhs,dojRhs: req.body.dojRhs,dorRhs: req.body.dorRhs,designationRhs: req.body.designationRhs,worktypeRhs: req.body.worktypeRhs,reportingmanagerRhs: req.body.reportingmanagerRhs,reportingmanagercontactRhs: req.body.reportingmanagercontactRhs,monthlysalaryRhs: req.body.monthlysalaryRhs,annualcosttocompanyRhs: req.body.annualcosttocompanyRhs,reasonforleavingRhs: req.body.reasonforleavingRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifierdesignationRhs: req.body.verifierdesignationRhs,dutiesRhs: req.body.dutiesRhs,integrityRhs: req.body.integrityRhs,officialresignationRhs: req.body.officialresignationRhs,eligibleforrehireRhs: req.body.eligibleforrehireRhs,exitformalitiesRhs: req.body.exitformalitiesRhs,movRhs: req.body.movRhs,remarksRhs: req.body.remarksRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    previousemployment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        companyRhs: req.body.companyRhs,officeaddressRhs: req.body.officeaddressRhs,employeeidRhs: req.body.employeeidRhs,dojRhs: req.body.dojRhs,dorRhs: req.body.dorRhs,designationRhs: req.body.designationRhs,worktypeRhs: req.body.worktypeRhs,reportingmanagerRhs: req.body.reportingmanagerRhs,reportingmanagercontactRhs: req.body.reportingmanagercontactRhs,monthlysalaryRhs: req.body.monthlysalaryRhs,annualcosttocompanyRhs: req.body.annualcosttocompanyRhs,reasonforleavingRhs: req.body.reasonforleavingRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifierdesignationRhs: req.body.verifierdesignationRhs,dutiesRhs: req.body.dutiesRhs,integrityRhs: req.body.integrityRhs,officialresignationRhs: req.body.officialresignationRhs,eligibleforrehireRhs: req.body.eligibleforrehireRhs,exitformalitiesRhs: req.body.exitformalitiesRhs,movRhs: req.body.movRhs,remarksRhs: req.body.remarksRhs,
status: req.body.status,
...
//         previousemployment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {companyRhs: req.body.data.companyRhs,officeaddressRhs: req.body.data.officeaddressRhs,employeeidRhs: req.body.data.employeeidRhs,dojRhs: req.body.data.dojRhs,dorRhs: req.body.data.dorRhs,designationRhs: req.body.data.designationRhs,worktypeRhs: req.body.data.worktypeRhs,reportingmanagerRhs: req.body.data.reportingmanagerRhs,reportingmanagercontactRhs: req.body.data.reportingmanagercontactRhs,monthlysalaryRhs: req.body.data.monthlysalaryRhs,annualcosttocompanyRhs: req.body.data.annualcosttocompanyRhs,reasonforleavingRhs: req.body.data.reasonforleavingRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifierdesignationRhs: req.body.data.verifierdesignationRhs,dutiesRhs: req.body.data.dutiesRhs,integrityRhs: req.body.data.integrityRhs,officialresignationRhs: req.body.data.officialresignationRhs,eligibleforrehireRhs: req.body.data.eligibleforrehireRhs,exitformalitiesRhs: req.body.data.exitformalitiesRhs,movRhs: req.body.data.movRhs,remarksRhs: req.body.data.remarksRhs,
// status: req.body.status,
...
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'previousemployment Details'</td><td>${data.company}</td><td>${data.gradingComments}</td></tr></table>`
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let mailText = subclientNotificationData.template.content;
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'previousemployment Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
                let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails);
...
exports.deleteCheck = (req, res) => {
    previousemployment.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await previousemployment.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await previousemployment.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await previousemployment.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In previousemployment Create for CDE")
    let caseId = req.caseId
    if (!req.body.case) {
        res.status(400).json({ message: "Case Id is Mandatory" })
    }
if (!req.body.company) {
            res.status(400).json({ message: "company is Mandatory" })
        }
if (!req.body.officeaddress) {
            res.status(400).json({ message: "officeaddress is Mandatory" })
        }
if (!req.body.employeeid) {
            res.status(400).json({ message: "employeeid is Mandatory" })
        }
if (!req.body.doj) {
            res.status(400).json({ message: "doj is Mandatory" })
        }
if (!req.body.dor) {
            res.status(400).json({ message: "dor is Mandatory" })
        }
if (!req.body.designation) {
            res.status(400).json({ message: "designation is Mandatory" })
        }
if (!req.body.worktype) {
            res.status(400).json({ message: "worktype is Mandatory" })
        }
if (!req.body.reportingmanager) {
            res.status(400).json({ message: "reportingmanager is Mandatory" })
        }
if (!req.body.reportingmanagercontact) {
            res.status(400).json({ message: "reportingmanagercontact is Mandatory" })
        }
if (!req.body.monthlysalary) {
            res.status(400).json({ message: "monthlysalary is Mandatory" })
        }
if (!req.body.annualcosttocompany) {
            res.status(400).json({ message: "annualcosttocompany is Mandatory" })
        }
if (!req.body.reasonforleaving) {
            res.status(400).json({ message: "reasonforleaving is Mandatory" })
        }
if (!req.body.verifiedby) {
            res.status(400).json({ message: "verifiedby is Mandatory" })
        }
if (!req.body.verifierdesignation) {
            res.status(400).json({ message: "verifierdesignation is Mandatory" })
        }
if (!req.body.duties) {
            res.status(400).json({ message: "duties is Mandatory" })
        }
if (!req.body.integrity) {
            res.status(400).json({ message: "integrity is Mandatory" })
        }
if (!req.body.officialresignation) {
            res.status(400).json({ message: "officialresignation is Mandatory" })
        }
if (!req.body.eligibleforrehire) {
            res.status(400).json({ message: "eligibleforrehire is Mandatory" })
        }
if (!req.body.exitformalities) {
            res.status(400).json({ message: "exitformalities is Mandatory" })
        }
if (!req.body.mov) {
            res.status(400).json({ message: "mov is Mandatory" })
        }
if (!req.body.remarks) {
            res.status(400).json({ message: "remarks is Mandatory" })
        }
if (!req.body.status) {
    res.status(400).json({ message: 'Status required' })
}
...
exports.findOneForCde = (req, res) => {
    console.log("In previousemployment for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        previousemployment.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

...
const fourpaneldrugabusecheck = require('../../models/data_entry/fourpaneldrugabusecheck.model')
...
if (!req.body.status) {
    ...
    const obj = new fourpaneldrugabusecheck({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6721fe0b84af88ec008d333f" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
mov: req.body.mov,
            movRhs: null,
drugschecked: req.body.drugschecked,
            drugscheckedRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await fourpaneldrugabusecheck.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "fourpaneldrugabusecheck" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving fourpaneldrugabusecheck'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    fourpaneldrugabusecheck
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving fourpaneldrugabusecheck for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    fourpaneldrugabusecheck.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    fourpaneldrugabusecheck.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
drugschecked: req.body.drugschecked,status: req.body.status,
...
exports.findComponentsFor = (req, res) => {
    ...
    fourpaneldrugabusecheck.find(query)
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    fourpaneldrugabusecheck
        ...
        fourpaneldrugabusecheck.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await fourpaneldrugabusecheck.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await fourpaneldrugabusecheck.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return fourpaneldrugabusecheck.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// drugscheckedRhs: req.body.drugscheckedRhs,
// status: req.body.status,
//             verificationCompletionDate: new Date(),
//             grade: req.body.grade,
//             grade1: req.body.grade,
...
exports.updateFeVerificationStatus = (req, res) => {
    fourpaneldrugabusecheck.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,resultRhs: req.body.resultRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,drugscheckedRhs: req.body.drugscheckedRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    fourpaneldrugabusecheck.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,resultRhs: req.body.resultRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,drugscheckedRhs: req.body.drugscheckedRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await fourpaneldrugabusecheck.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'fourpaneldrugabusecheck Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         fourpaneldrugabusecheck.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,resultRhs: req.body.data.resultRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,drugscheckedRhs: req.body.data.drugscheckedRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'fourpaneldrugabusecheck Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    fourpaneldrugabusecheck.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await fourpaneldrugabusecheck.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await fourpaneldrugabusecheck.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await fourpaneldrugabusecheck.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In fourpaneldrugabusecheck Create for CDE")
...
if (!req.body.drugschecked) {
            res.status(400).json({ message: "drugschecked is Mandatory" })
        }
if (!req.body.status) {
    res.status(400).json({ message: 'Status required' })
}
...
exports.findOneForCde = (req, res) => {
    console.log("In fourpaneldrugabusecheck for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        fourpaneldrugabusecheck.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

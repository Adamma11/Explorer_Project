...
const currentaddress = require('../../models/data_entry/currentaddress.model')
...
if (!req.body.status) {
    ...
    const obj = new currentaddress({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "67222912ff5ce4ee231ab0cc" : req.body.component,
        checkId: checkId,
city: req.body.city,
            cityRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await currentaddress.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "currentaddress" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving currentaddress'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    currentaddress
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving currentaddress for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    currentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    currentaddress.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
mov: req.body.mov,
address: req.body.address,
verifiedon: req.body.verifiedon,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    currentaddress
        ...
        currentaddress.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateFeVerificationStatus = (req, res) => {
    currentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,landmarkRhs: req.body.landmarkRhs,posRhs: req.body.posRhs,nocRhs: req.body.nocRhs,verifiedbyRhs: req.body.verifiedbyRhs,movRhs: req.body.movRhs,addressRhs: req.body.addressRhs,verifiedonRhs: req.body.verifiedonRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    currentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,landmarkRhs: req.body.landmarkRhs,posRhs: req.body.posRhs,nocRhs: req.body.nocRhs,verifiedbyRhs: req.body.verifiedbyRhs,movRhs: req.body.movRhs,addressRhs: req.body.addressRhs,verifiedonRhs: req.body.verifiedonRhs,
status: req.body.status,
...
/*exports.updateMentorReviewStatus = (req, res) => {
        ...
        currentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,postalcodeRhs: req.body.data.postalcodeRhs,landmarkRhs: req.body.data.landmarkRhs,posRhs: req.body.data.posRhs,nocRhs: req.body.data.nocRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,movRhs: req.body.data.movRhs,addressRhs: req.body.data.addressRhs,verifiedonRhs: req.body.data.verifiedonRhs,
status: req.body.status,
                        ...
                        if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                            Case
                                ...
                                .then(caseData => {
                                    ...
                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'currentaddress Details'</td><td>${data.city}</td><td>${data.gradingComments}</td></tr></table>`
...
exports.deleteCheck = (req, res) => {
    currentaddress.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await currentaddress.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await currentaddress.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await currentaddress.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In currentaddress Create for CDE")
...
exports.findOneForCde = (req, res) => {
    console.log("In currentaddress for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        currentaddress.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await currentaddress.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await currentaddress.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return currentaddress.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await currentaddress.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let mailText = subclientNotificationData.template.content;
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'currentaddress Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
                let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails);

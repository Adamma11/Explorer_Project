...
const gapanalysis = require('../../models/data_entry/gapanalysis.model')
...
if (!req.body.status) {
    ...
    const obj = new gapanalysis({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6723cabe1272f0f57d27e5ca" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
gapinedu: req.body.gapinedu,
            gapineduRhs: null,
gapinemp: req.body.gapinemp,
            gapinempRhs: null,
reasoninemp: req.body.reasoninemp,
            reasoninempRhs: null,
...
mov: req.body.mov,
            movRhs: null,
reasoninedu: req.body.reasoninedu,
            reasonineduRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await gapanalysis.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "gapanalysis" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving gapanalysis'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    gapanalysis
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving gapanalysis for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    gapanalysis.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    gapanalysis.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
reasoninedu: req.body.reasoninedu,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    gapanalysis
        ...
        gapanalysis.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await gapanalysis.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await gapanalysis.findOneAndUpdate(
...
// gapineduRhs: req.body.gapineduRhs,
// gapinempRhs: req.body.gapinempRhs,
// reasoninempRhs: req.body.reasoninempRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
// movRhs: req.body.movRhs,
// reasonineduRhs: req.body.reasonineduRhs,
// status: req.body.status,
//             verificationCompletionDate: new Date(),
//             grade: req.body.grade,
//             grade1: req.body.grade,
...
exports.updateFeVerificationStatus = (req, res) => {
    gapanalysis.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,gapineduRhs: req.body.gapineduRhs,gapinempRhs: req.body.gapinempRhs,reasoninempRhs: req.body.reasoninempRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,reasonineduRhs: req.body.reasonineduRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    gapanalysis.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,gapineduRhs: req.body.gapineduRhs,gapinempRhs: req.body.gapinempRhs,reasoninempRhs: req.body.reasoninempRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,reasonineduRhs: req.body.reasonineduRhs,
status: req.body.status,
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'gapanalysis Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         gapanalysis.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,gapineduRhs: req.body.data.gapineduRhs,gapinempRhs: req.body.data.gapinempRhs,reasoninempRhs: req.body.data.reasoninempRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,reasonineduRhs: req.body.data.reasonineduRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'gapanalysis Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    gapanalysis.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await gapanalysis.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await gapanalysis.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await gapanalysis.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In gapanalysis Create for CDE")
...
if (!req.body.gapinedu) {
            res.status(400).json({ message: "gapinedu is Mandatory" })
        }
if (!req.body.gapinemp) {
            res.status(400).json({ message: "gapinemp is Mandatory" })
        }
if (!req.body.reasoninemp) {
            res.status(400).json({ message: "reasoninemp is Mandatory" })
        }
...
if (!req.body.reasoninedu) {
            res.status(400).json({ message: "reasoninedu is Mandatory" })
        }
if (!req.body.status) {
    res.status(400).json({ message: 'Status required' })
}
...
exports.findOneForCde = (req, res) => {
    console.log("In gapanalysis for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        gapanalysis.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

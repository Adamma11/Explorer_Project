...
const emergencycontact = require('../../models/data_entry/emergencycontact.model')
...
if (!req.body.status) {
    ...
    const obj = new emergencycontact({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6723b3621272f0f57d27d305" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
contactnumberone: req.body.contactnumberone,
            contactnumberoneRhs: null,
relationshipone: req.body.relationshipone,
            relationshiponeRhs: null,
contactnumbertwo: req.body.contactnumbertwo,
            contactnumbertwoRhs: null,
relationshiptwo: req.body.relationshiptwo,
            relationshiptwoRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await emergencycontact.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "emergencycontact" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving emergencycontact'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    emergencycontact
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving emergencycontact for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    emergencycontact.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    emergencycontact.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    emergencycontact
        ...
        emergencycontact.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await emergencycontact.findOne({ case: caseId, _id: componentId });
...
// contactnumberoneRhs: req.body.contactnumberoneRhs,
// relationshiponeRhs: req.body.relationshiponeRhs,
// contactnumbertwoRhs: req.body.contactnumbertwoRhs,
// relationshiptwoRhs: req.body.relationshiptwoRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    emergencycontact.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,contactnumberoneRhs: req.body.contactnumberoneRhs,relationshiponeRhs: req.body.relationshiponeRhs,contactnumbertwoRhs: req.body.contactnumbertwoRhs,relationshiptwoRhs: req.body.relationshiptwoRhs,dateofcontactRhs: req.body.dateofcontactRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    emergencycontact.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,contactnumberoneRhs: req.body.contactnumberoneRhs,relationshiponeRhs: req.body.relationshiponeRhs,contactnumbertwoRhs: req.body.contactnumbertwoRhs,relationshiptwoRhs: req.body.relationshiptwoRhs,dateofcontactRhs: req.body.dateofcontactRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'emergencycontact Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         emergencycontact.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,contactnumberoneRhs: req.body.data.contactnumberoneRhs,relationshiponeRhs: req.body.data.relationshiponeRhs,contactnumbertwoRhs: req.body.data.contactnumbertwoRhs,relationshiptwoRhs: req.body.data.relationshiptwoRhs,dateofcontactRhs: req.body.data.dateofcontactRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'emergencycontact Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    emergencycontact.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await emergencycontact.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await emergencycontact.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await emergencycontact.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In emergencycontact Create for CDE")
...
if (!req.body.contactnumberone) {
            res.status(400).json({ message: "contactnumberone is Mandatory" })
        }
if (!req.body.relationshipone) {
            res.status(400).json({ message: "relationshipone is Mandatory" })
        }
if (!req.body.contactnumbertwo) {
            res.status(400).json({ message: "contactnumbertwo is Mandatory" })
        }
if (!req.body.relationshiptwo) {
            res.status(400).json({ message: "relationshiptwo is Mandatory" })
        }
if (!req.body.dateofcontact) {
            res.status(400).json({ message: "dateofcontact is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In emergencycontact for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        emergencycontact.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

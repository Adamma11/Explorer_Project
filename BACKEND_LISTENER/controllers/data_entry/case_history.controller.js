...
const fs = require('fs')
exports.create = (acase,component,check,operation,status,remarks,nextfollowupdate,allocatedToFe,allocatedToVerifier,user,allocatedToVendor)=>{
//exports.create = (acase,component,check,operation,status,remarks,allocatedToVendor,allocatedToFe,allocatedToVerifier,user)=>{

	console.log("response:History",acase);
	...
	allocatedToVerifier:allocatedToVerifier,    
	 ...
	 console.log("response",caseHistory);
    if(acase != null){	
	    console.log("response",caseHistory);
      caseHistory
      .save(caseHistory)

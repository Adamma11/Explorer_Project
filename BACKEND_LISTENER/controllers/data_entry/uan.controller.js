...
if (!req.body.status) {
    ...
    const obj = new uan({
        ...
        component: req.body.component == null ? "6723e8fdf072dffc31fe5873" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
dob: req.body.dob,
...
result: req.body.result,
            resultRhs: null,
previouscompanyone: req.body.previouscompanyone,
            previouscompanyoneRhs: null,
dojone: req.body.dojone,
            dojoneRhs: null,
dorone: req.body.dorone,
            doroneRhs: null,
previouscompanytwo: req.body.previouscompanytwo,
            previouscompanytwoRhs: null,
dojtwo: req.body.dojtwo,
            dojtwoRhs: null,
dortwo: req.body.dortwo,
            dortwoRhs: null,
previouscompanythree: req.body.previouscompanythree,
            previouscompanythreeRhs: null,
dojthree: req.body.dojthree,
            dojthreeRhs: null,
dorthree: req.body.dorthree,
            dorthreeRhs: null,
previouscompanyfour: req.body.previouscompanyfour,
            previouscompanyfourRhs: null,
dojfour: req.body.dojfour,
            dojfourRhs: null,
dorfour: req.body.dorfour,
            dorfourRhs: null,
previouscompanyfive: req.body.previouscompanyfive,
            previouscompanyfiveRhs: null,
dojfive: req.body.dojfive,
            dojfiveRhs: null,
dorfive: req.body.dorfive,
            dorfiveRhs: null,
previouscompanysix: req.body.previouscompanysix,
            previouscompanysixRhs: null,
dojsix: req.body.dojsix,
            dojsixRhs: null,
dorsix: req.body.dorsix,
            dorsixRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await uan.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "uan" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving uan'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    uan
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving uan for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    uan.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    uan.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    uan
        ...
        uan.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await uan.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await uan.findOneAndUpdate(
...
// uannumberRhs: req.body.uannumberRhs,
// resultRhs: req.body.resultRhs,
// previouscompanyoneRhs: req.body.previouscompanyoneRhs,
// dojoneRhs: req.body.dojoneRhs,
// doroneRhs: req.body.doroneRhs,
// previouscompanytwoRhs: req.body.previouscompanytwoRhs,
// dojtwoRhs: req.body.dojtwoRhs,
// dortwoRhs: req.body.dortwoRhs,
// previouscompanythreeRhs: req.body.previouscompanythreeRhs,
// dojthreeRhs: req.body.dojthreeRhs,
// dorthreeRhs: req.body.dorthreeRhs,
// previouscompanyfourRhs: req.body.previouscompanyfourRhs,
// dojfourRhs: req.body.dojfourRhs,
// dorfourRhs: req.body.dorfourRhs,
// previouscompanyfiveRhs: req.body.previouscompanyfiveRhs,
// dojfiveRhs: req.body.dojfiveRhs,
// dorfiveRhs: req.body.dorfiveRhs,
// previouscompanysixRhs: req.body.previouscompanysixRhs,
// dojsixRhs: req.body.dojsixRhs,
// dorsixRhs: req.body.dorsixRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    uan.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,dobRhs: req.body.dobRhs,fathernameRhs: req.body.fathernameRhs,uannumberRhs: req.body.uannumberRhs,resultRhs: req.body.resultRhs,previouscompanyoneRhs: req.body.previouscompanyoneRhs,dojoneRhs: req.body.dojoneRhs,doroneRhs: req.body.doroneRhs,previouscompanytwoRhs: req.body.previouscompanytwoRhs,dojtwoRhs: req.body.dojtwoRhs,dortwoRhs: req.body.dortwoRhs,previouscompanythreeRhs: req.body.previouscompanythreeRhs,dojthreeRhs: req.body.dojthreeRhs,dorthreeRhs: req.body.dorthreeRhs,previouscompanyfourRhs: req.body.previouscompanyfourRhs,dojfourRhs: req.body.dojfourRhs,dorfourRhs: req.body.dorfourRhs,previouscompanyfiveRhs: req.body.previouscompanyfiveRhs,dojfiveRhs: req.body.dojfiveRhs,dorfiveRhs: req.body.dorfiveRhs,previouscompanysixRhs: req.body.previouscompanysixRhs,dojsixRhs: req.body.dojsixRhs,dorsixRhs: req.body.dorsixRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    uan.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,dobRhs: req.body.dobRhs,fathernameRhs: req.body.fathernameRhs,uannumberRhs: req.body.uannumberRhs,resultRhs: req.body.resultRhs,previouscompanyoneRhs: req.body.previouscompanyoneRhs,dojoneRhs: req.body.dojoneRhs,doroneRhs: req.body.doroneRhs,previouscompanytwoRhs: req.body.previouscompanytwoRhs,dojtwoRhs: req.body.dojtwoRhs,dortwoRhs: req.body.dortwoRhs,previouscompanythreeRhs: req.body.previouscompanythreeRhs,dojthreeRhs: req.body.dojthreeRhs,dorthreeRhs: req.body.dorthreeRhs,previouscompanyfourRhs: req.body.previouscompanyfourRhs,dojfourRhs: req.body.dojfourRhs,dorfourRhs: req.body.dorfourRhs,previouscompanyfiveRhs: req.body.previouscompanyfiveRhs,dojfiveRhs: req.body.dojfiveRhs,dorfiveRhs: req.body.dorfiveRhs,previouscompanysixRhs: req.body.previouscompanysixRhs,dojsixRhs: req.body.dojsixRhs,dorsixRhs: req.body.dorsixRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
//added code nov-07
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'uan Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         uan.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,dobRhs: req.body.data.dobRhs,fathernameRhs: req.body.data.fathernameRhs,uannumberRhs: req.body.data.uannumberRhs,resultRhs: req.body.data.resultRhs,previouscompanyoneRhs: req.body.data.previouscompanyoneRhs,dojoneRhs: req.body.data.dojoneRhs,doroneRhs: req.body.data.doroneRhs,previouscompanytwoRhs: req.body.data.previouscompanytwoRhs,dojtwoRhs: req.body.data.dojtwoRhs,dortwoRhs: req.body.data.dortwoRhs,previouscompanythreeRhs: req.body.data.previouscompanythreeRhs,dojthreeRhs: req.body.data.dojthreeRhs,dorthreeRhs: req.body.data.dorthreeRhs,previouscompanyfourRhs: req.body.data.previouscompanyfourRhs,dojfourRhs: req.body.data.dojfourRhs,dorfourRhs: req.body.data.dorfourRhs,previouscompanyfiveRhs: req.body.data.previouscompanyfiveRhs,dojfiveRhs: req.body.data.dojfiveRhs,dorfiveRhs: req.body.data.dorfiveRhs,previouscompanysixRhs: req.body.data.previouscompanysixRhs,dojsixRhs: req.body.data.dojsixRhs,dorsixRhs: req.body.data.dorsixRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'uan Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    uan.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await uan.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await uan.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await uan.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In uan Create for CDE")
...
if (!req.body.uannumber) {
            res.status(400).json({ message: "uannumber is Mandatory" })
        }
if (!req.body.result) {
            res.status(400).json({ message: "result is Mandatory" })
        }
if (!req.body.previouscompanyone) {
            res.status(400).json({ message: "previouscompanyone is Mandatory" })
        }
if (!req.body.dojone) {
            res.status(400).json({ message: "dojone is Mandatory" })
        }
if (!req.body.dorone) {
            res.status(400).json({ message: "dorone is Mandatory" })
        }
if (!req.body.previouscompanytwo) {
            res.status(400).json({ message: "previouscompanytwo is Mandatory" })
        }
if (!req.body.dojtwo) {
            res.status(400).json({ message: "dojtwo is Mandatory" })
        }
if (!req.body.dortwo) {
            res.status(400).json({ message: "dortwo is Mandatory" })
        }
if (!req.body.previouscompanythree) {
            res.status(400).json({ message: "previouscompanythree is Mandatory" })
        }
if (!req.body.dojthree) {
            res.status(400).json({ message: "dojthree is Mandatory" })
        }
if (!req.body.dorthree) {
            res.status(400).json({ message: "dorthree is Mandatory" })
        }
if (!req.body.previouscompanyfour) {
            res.status(400).json({ message: "previouscompanyfour is Mandatory" })
        }
if (!req.body.dojfour) {
            res.status(400).json({ message: "dojfour is Mandatory" })
        }
if (!req.body.dorfour) {
            res.status(400).json({ message: "dorfour is Mandatory" })
        }
if (!req.body.previouscompanyfive) {
            res.status(400).json({ message: "previouscompanyfive is Mandatory" })
        }
if (!req.body.dojfive) {
            res.status(400).json({ message: "dojfive is Mandatory" })
        }
if (!req.body.dorfive) {
            res.status(400).json({ message: "dorfive is Mandatory" })
        }
if (!req.body.previouscompanysix) {
            res.status(400).json({ message: "previouscompanysix is Mandatory" })
        }
if (!req.body.dojsix) {
            res.status(400).json({ message: "dojsix is Mandatory" })
        }
if (!req.body.dorsix) {
            res.status(400).json({ message: "dorsix is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In uan for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        uan.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

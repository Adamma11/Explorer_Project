...
const efir = require('../../models/data_entry/efir.model')
...
if (!req.body.efir) {
                    return res.status(400).json({ message: "efir is Mandatory" })
                }
if (!req.body.dateoffir) {
                    return res.status(400).json({ message: "dateoffir is Mandatory" })
                }
if (!req.body.ps) {
                    return res.status(400).json({ message: "ps is Mandatory" })
                }
if (!req.body.city) {
...
if (!req.body.status) {
    ...
    const obj = new efir({
        ...
        component: req.body.component == null ? "68d3751da9c6178d4143797f" : req.body.component,
        checkId: checkId,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await efir.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "efir" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving efir'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    efir
      // .find({ case: req.params.case })
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving efir for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    efir.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    efir.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    efir
        ...
        efir.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
    try {
        ...
        const existing = await efir.findOne({ case: caseId, _id: componentId });
        ...
        if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
            ...
            const updated = await efir.findOneAndUpdate(
...
// efirRhs: req.body.efirRhs,
// dateoffirRhs: req.body.dateoffirRhs,
// psRhs: req.body.psRhs,
// cityRhs: req.body.cityRhs,
// stateRhs: req.body.stateRhs,
...
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
// resultsRhs: req.body.resultsRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    efir.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {fathernameRhs: req.body.fathernameRhs,dobRhs: req.body.dobRhs,addressRhs: req.body.addressRhs,posRhs: req.body.posRhs,efirRhs: req.body.efirRhs,dateoffirRhs: req.body.dateoffirRhs,psRhs: req.body.psRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,countryRhs: req.body.countryRhs,movRhs: req.body.movRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,resultsRhs: req.body.resultsRhs,remarksRhs: req.body.remarksRhs,nameRhs: req.body.nameRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    efir.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        fathernameRhs: req.body.fathernameRhs,dobRhs: req.body.dobRhs,addressRhs: req.body.addressRhs,posRhs: req.body.posRhs,efirRhs: req.body.efirRhs,dateoffirRhs: req.body.dateoffirRhs,psRhs: req.body.psRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,countryRhs: req.body.countryRhs,movRhs: req.body.movRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,resultsRhs: req.body.resultsRhs,remarksRhs: req.body.remarksRhs,nameRhs: req.body.nameRhs,
status: req.body.status,
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'efir Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         efir.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {fathernameRhs: req.body.data.fathernameRhs,dobRhs: req.body.data.dobRhs,addressRhs: req.body.data.addressRhs,posRhs: req.body.data.posRhs,efirRhs: req.body.data.efirRhs,dateoffirRhs: req.body.data.dateoffirRhs,psRhs: req.body.data.psRhs,cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,countryRhs: req.body.data.countryRhs,movRhs: req.body.data.movRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,resultsRhs: req.body.data.resultsRhs,remarksRhs: req.body.data.remarksRhs,nameRhs: req.body.data.nameRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'efir Details'</td><td>${data.fathername}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    efir.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await efir.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await efir.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await efir.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In efir Create for CDE")
...
if (!req.body.efir) {
            res.status(400).json({ message: "efir is Mandatory" })
        }
if (!req.body.dateoffir) {
            res.status(400).json({ message: "dateoffir is Mandatory" })
        }
if (!req.body.ps) {
            res.status(400).json({ message: "ps is Mandatory" })
        }
if (!req.body.city) {
...
if (!req.body.results) {
            res.status(400).json({ message: "results is Mandatory" })
        }
if (!req.body.remarks) {
...
exports.findOneForCde = (req, res) => {
    console.log("In efir for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        efir.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

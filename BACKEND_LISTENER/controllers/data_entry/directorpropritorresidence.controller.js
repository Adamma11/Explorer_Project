...
const directorpropritorresidence = require('../../models/data_entry/directorpropritorresidence.model')
...
if (!req.body.status) {
    ...
    const obj = new directorpropritorresidence({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "67222a0cff5ce4ee231abc01" : req.body.component,
        checkId: checkId,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await directorpropritorresidence.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "directorpropritorresidence" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving directorpropritorresidence'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    directorpropritorresidence
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving directorpropritorresidence for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    directorpropritorresidence.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    directorpropritorresidence.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsFor = (req, res) => {
    ...
    directorpropritorresidence.find(query)
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    directorpropritorresidence
        ...
        directorpropritorresidence.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await directorpropritorresidence.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await directorpropritorresidence.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return directorpropritorresidence.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
exports.updateFeVerificationStatus = (req, res) => {
    directorpropritorresidence.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {addressRhs: req.body.addressRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,landmarkRhs: req.body.landmarkRhs,posRhs: req.body.posRhs,natureofoccupancyRhs: req.body.natureofoccupancyRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await directorpropritorresidence.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'directorpropritorresidence Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         directorpropritorresidence.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {addressRhs: req.body.data.addressRhs,cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,postalcodeRhs: req.body.data.postalcodeRhs,landmarkRhs: req.body.data.landmarkRhs,posRhs: req.body.data.posRhs,natureofoccupancyRhs: req.body.data.natureofoccupancyRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'directorpropritorresidence Details'</td><td>${data.address}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    directorpropritorresidence.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await directorpropritorresidence.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await directorpropritorresidence.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await directorpropritorresidence.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In directorpropritorresidence Create for CDE")
...
exports.findOneForCde = (req, res) => {
    console.log("In directorpropritorresidence for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        directorpropritorresidence.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

...
const licensecertification = require('../../models/data_entry/licensecertification.model')
...
if (!req.body.city) {
                    return res.status(400).json({ message: "city is Mandatory" })
                }
if (!req.body.state) {
                    return res.status(400).json({ message: "state is Mandatory" })
                }
if (!req.body.country) {
                    return res.status(400).json({ message: "country is Mandatory" })
                }
if (!req.body.number) {
...
if (!req.body.status) {
    ...
    const obj = new licensecertification({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6723e3cbf072dffc31fe4ad0" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
city: req.body.city,
...
regnumber: req.body.regnumber,
            regnumberRhs: null,
monthandyearoflicense: req.body.monthandyearoflicense,
            monthandyearoflicenseRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await licensecertification.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "licensecertification" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving licensecertification'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    licensecertification
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving licensecertification for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    licensecertification.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    licensecertification.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsFor = (req, res) => {
    ...
    licensecertification.find(query)
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    licensecertification
        ...
        licensecertification.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
areaRhs: req.body.areaRhs,
regnumberRhs: req.body.regnumberRhs,
monthandyearoflicenseRhs: req.body.monthandyearoflicenseRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    licensecertification.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,countryRhs: req.body.countryRhs,numberRhs: req.body.numberRhs,areaRhs: req.body.areaRhs,regnumberRhs: req.body.regnumberRhs,monthandyearoflicenseRhs: req.body.monthandyearoflicenseRhs,validtillRhs: req.body.validtillRhs,verifiernameRhs: req.body.verifiernameRhs,verifierdesignationRhs: req.body.verifierdesignationRhs,emailidRhs: req.body.emailidRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    licensecertification.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,countryRhs: req.body.countryRhs,numberRhs: req.body.numberRhs,areaRhs: req.body.areaRhs,regnumberRhs: req.body.regnumberRhs,monthandyearoflicenseRhs: req.body.monthandyearoflicenseRhs,validtillRhs: req.body.validtillRhs,verifiernameRhs: req.body.verifiernameRhs,verifierdesignationRhs: req.body.verifierdesignationRhs,emailidRhs: req.body.emailidRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
/*exports.updateMentorReviewStatus = (req, res) => {
        ...
        licensecertification.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,countryRhs: req.body.data.countryRhs,numberRhs: req.body.data.numberRhs,areaRhs: req.body.data.areaRhs,regnumberRhs: req.body.data.regnumberRhs,monthandyearoflicenseRhs: req.body.data.monthandyearoflicenseRhs,validtillRhs: req.body.data.validtillRhs,verifiernameRhs: req.body.data.verifiernameRhs,verifierdesignationRhs: req.body.data.verifierdesignationRhs,emailidRhs: req.body.data.emailidRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
status: req.body.status,
                        ...
                        if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                            Case
                                ...
                                .then(caseData => {
                                    ...
                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'licensecertification Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
...
exports.deleteCheck = (req, res) => {
    licensecertification.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await licensecertification.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await licensecertification.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await licensecertification.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In licensecertification Create for CDE")
...
if (!req.body.area) {
            res.status(400).json({ message: "area is Mandatory" })
        }
if (!req.body.regnumber) {
            res.status(400).json({ message: "regnumber is Mandatory" })
        }
if (!req.body.monthandyearoflicense) {
            res.status(400).json({ message: "monthandyearoflicense is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In licensecertification for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        licensecertification.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await licensecertification.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await licensecertification.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return licensecertification.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await licensecertification.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let mailText = subclientNotificationData.template.content;
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'licensecertification Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
                let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails);

...
const webandmedia = require('../../models/data_entry/webandmedia.model')
...
if (!req.body.status) {
    ...
    const obj = new webandmedia({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "672b14e6e48735add470c892" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
internationalmedia: req.body.internationalmedia,
            internationalmediaRhs: null,
racism: req.body.racism,
            racismRhs: null,
behavior: req.body.behavior,
            behaviorRhs: null,
unlawfulactivity: req.body.unlawfulactivity,
            unlawfulactivityRhs: null,
sexually: req.body.sexually,
            sexuallyRhs: null,
religiousbeliefs: req.body.religiousbeliefs,
            religiousbeliefsRhs: null,
profileandcredentials: req.body.profileandcredentials,
            profileandcredentialsRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await webandmedia.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "webandmedia" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving webandmedia'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    webandmedia
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving webandmedia for cases'
            })
        })
};
...
exports.findOne = (req, res) => {
    webandmedia.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    webandmedia
        ...
        webandmedia.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await webandmedia.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await webandmedia.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return webandmedia.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// internationalmediaRhs: req.body.internationalmediaRhs,
// racismRhs: req.body.racismRhs,
// behaviorRhs: req.body.behaviorRhs,
// unlawfulactivityRhs: req.body.unlawfulactivityRhs,
// sexuallyRhs: req.body.sexuallyRhs,
// religiousbeliefsRhs: req.body.religiousbeliefsRhs,
// profileandcredentialsRhs: req.body.profileandcredentialsRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    webandmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,internationalmediaRhs: req.body.internationalmediaRhs,racismRhs: req.body.racismRhs,behaviorRhs: req.body.behaviorRhs,unlawfulactivityRhs: req.body.unlawfulactivityRhs,sexuallyRhs: req.body.sexuallyRhs,religiousbeliefsRhs: req.body.religiousbeliefsRhs,profileandcredentialsRhs: req.body.profileandcredentialsRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    webandmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,internationalmediaRhs: req.body.internationalmediaRhs,racismRhs: req.body.racismRhs,behaviorRhs: req.body.behaviorRhs,unlawfulactivityRhs: req.body.unlawfulactivityRhs,sexuallyRhs: req.body.sexuallyRhs,religiousbeliefsRhs: req.body.religiousbeliefsRhs,profileandcredentialsRhs: req.body.profileandcredentialsRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await webandmedia.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'webandmedia Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         webandmedia.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,internationalmediaRhs: req.body.data.internationalmediaRhs,racismRhs: req.body.data.racismRhs,behaviorRhs: req.body.data.behaviorRhs,unlawfulactivityRhs: req.body.data.unlawfulactivityRhs,sexuallyRhs: req.body.data.sexuallyRhs,religiousbeliefsRhs: req.body.data.religiousbeliefsRhs,profileandcredentialsRhs: req.body.data.profileandcredentialsRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'webandmedia Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    webandmedia.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await webandmedia.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await webandmedia.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await webandmedia.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In webandmedia Create for CDE")
...
if (!req.body.internationalmedia) {
            res.status(400).json({ message: "internationalmedia is Mandatory" })
        }
if (!req.body.racism) {
            res.status(400).json({ message: "racism is Mandatory" })
        }
if (!req.body.behavior) {
            res.status(400).json({ message: "behavior is Mandatory" })
        }
if (!req.body.unlawfulactivity) {
            res.status(400).json({ message: "unlawfulactivity is Mandatory" })
        }
if (!req.body.sexually) {
            res.status(400).json({ message: "sexually is Mandatory" })
        }
if (!req.body.religiousbeliefs) {
            res.status(400).json({ message: "religiousbeliefs is Mandatory" })
        }
if (!req.body.profileandcredentials) {
            res.status(400).json({ message: "profileandcredentials is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In webandmedia for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        webandmedia.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

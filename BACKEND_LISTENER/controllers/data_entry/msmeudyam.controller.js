...
const msmeudyam = require('../../models/data_entry/msmeudyam.model')
...
if (!req.body.status) {
    ...
    const obj = new msmeudyam({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "6723d7acf072dffc31fe29fa" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
nameofenterprise: req.body.nameofenterprise,
            nameofenterpriseRhs: null,
twelvedigitno: req.body.twelvedigitno,
            twelvedigitnoRhs: null,
majoractivity: req.body.majoractivity,
            majoractivityRhs: null,
socialcategory: req.body.socialcategory,
            socialcategoryRhs: null,
nictwo: req.body.nictwo,
            nictwoRhs: null,
nicfour: req.body.nicfour,
            nicfourRhs: null,
nicfive: req.body.nicfive,
            nicfiveRhs: null,
activitytype: req.body.activitytype,
            activitytypeRhs: null,
addedtomsmeon: req.body.addedtomsmeon,
            addedtomsmeonRhs: null,
dateofcommencement: req.body.dateofcommencement,
            dateofcommencementRhs: null,
dicname: req.body.dicname,
            dicnameRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await msmeudyam.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "msmeudyam" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving msmeudyam'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    msmeudyam
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving msmeudyam for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    msmeudyam.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    msmeudyam.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
state: req.body.state,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    msmeudyam
        ...
        msmeudyam.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await msmeudyam.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await msmeudyam.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return msmeudyam.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
// nameofenterpriseRhs: req.body.nameofenterpriseRhs,
// twelvedigitnoRhs: req.body.twelvedigitnoRhs,
// majoractivityRhs: req.body.majoractivityRhs,
// socialcategoryRhs: req.body.socialcategoryRhs,
// nictwoRhs: req.body.nictwoRhs,
// nicfourRhs: req.body.nicfourRhs,
// nicfiveRhs: req.body.nicfiveRhs,
// activitytypeRhs: req.body.activitytypeRhs,
// addedtomsmeonRhs: req.body.addedtomsmeonRhs,
// dateofcommencementRhs: req.body.dateofcommencementRhs,
// dicnameRhs: req.body.dicnameRhs,
// applieddateRhs: req.body.applieddateRhs,
// validtillRhs: req.body.validtillRhs,
// verifiedbyRhs: req.body.verifiedbyRhs,
// verifiedonRhs: req.body.verifiedonRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    msmeudyam.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,nameofenterpriseRhs: req.body.nameofenterpriseRhs,twelvedigitnoRhs: req.body.twelvedigitnoRhs,majoractivityRhs: req.body.majoractivityRhs,socialcategoryRhs: req.body.socialcategoryRhs,nictwoRhs: req.body.nictwoRhs,nicfourRhs: req.body.nicfourRhs,nicfiveRhs: req.body.nicfiveRhs,activitytypeRhs: req.body.activitytypeRhs,addedtomsmeonRhs: req.body.addedtomsmeonRhs,dateofcommencementRhs: req.body.dateofcommencementRhs,dicnameRhs: req.body.dicnameRhs,applieddateRhs: req.body.applieddateRhs,validtillRhs: req.body.validtillRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,stateRhs: req.body.stateRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    msmeudyam.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,nameofenterpriseRhs: req.body.nameofenterpriseRhs,twelvedigitnoRhs: req.body.twelvedigitnoRhs,majoractivityRhs: req.body.majoractivityRhs,socialcategoryRhs: req.body.socialcategoryRhs,nictwoRhs: req.body.nictwoRhs,nicfourRhs: req.body.nicfourRhs,nicfiveRhs: req.body.nicfiveRhs,activitytypeRhs: req.body.activitytypeRhs,addedtomsmeonRhs: req.body.addedtomsmeonRhs,dateofcommencementRhs: req.body.dateofcommencementRhs,dicnameRhs: req.body.dicnameRhs,applieddateRhs: req.body.applieddateRhs,validtillRhs: req.body.validtillRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,stateRhs: req.body.stateRhs,
status: req.body.status,
...
//added code nov-07
        ...
        if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
            ...
            await msmeudyam.findOneAndUpdate(
                { case: caseId, _id: componentId },
                {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'msmeudyam Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         msmeudyam.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,nameofenterpriseRhs: req.body.data.nameofenterpriseRhs,twelvedigitnoRhs: req.body.data.twelvedigitnoRhs,majoractivityRhs: req.body.data.majoractivityRhs,socialcategoryRhs: req.body.data.socialcategoryRhs,nictwoRhs: req.body.data.nictwoRhs,nicfourRhs: req.body.data.nicfourRhs,nicfiveRhs: req.body.data.nicfiveRhs,activitytypeRhs: req.body.data.activitytypeRhs,addedtomsmeonRhs: req.body.data.addedtomsmeonRhs,dateofcommencementRhs: req.body.data.dateofcommencementRhs,dicnameRhs: req.body.data.dicnameRhs,applieddateRhs: req.body.data.applieddateRhs,validtillRhs: req.body.data.validtillRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,stateRhs: req.body.data.stateRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id
...
//                                     let mailText = subclientNotificationData.template.content
//                                     let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'msmeudyam Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
//                                     let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    msmeudyam.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await msmeudyam.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await msmeudyam.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await msmeudyam.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In msmeudyam Create for CDE")
...
if (!req.body.nameofenterprise) {
            res.status(400).json({ message: "nameofenterprise is Mandatory" })
        }
if (!req.body.twelvedigitno) {
            res.status(400).json({ message: "twelvedigitno is Mandatory" })
        }
if (!req.body.majoractivity) {
            res.status(400).json({ message: "majoractivity is Mandatory" })
        }
if (!req.body.socialcategory) {
            res.status(400).json({ message: "socialcategory is Mandatory" })
        }
if (!req.body.nictwo) {
            res.status(400).json({ message: "nictwo is Mandatory" })
        }
if (!req.body.nicfour) {
            res.status(400).json({ message: "nicfour is Mandatory" })
        }
if (!req.body.nicfive) {
            res.status(400).json({ message: "nicfive is Mandatory" })
        }
if (!req.body.activitytype) {
            res.status(400).json({ message: "activitytype is Mandatory" })
        }
if (!req.body.addedtomsmeon) {
            res.status(400).json({ message: "addedtomsmeon is Mandatory" })
        }
if (!req.body.dateofcommencement) {
            res.status(400).json({ message: "dateofcommencement is Mandatory" })
        }
if (!req.body.dicname) {
            res.status(400).json({ message: "dicname is Mandatory" })
        }
if (!req.body.applieddate) {
            res.status(400).json({ message: "applieddate is Mandatory" })
        }
if (!req.body.validtill) {
            res.status(400).json({ message: "validtill is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In msmeudyam for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        msmeudyam.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

	...
	const permanentandcurrentaddress = require('../../models/data_entry/permanentandcurrentaddress.model')
...
const CheckHistory  = require('../../models/administration/checkHistory.model');
	...
	if (!req.body.status) {
	    ...
	    const obj = new permanentandcurrentaddress({
		case: req.body.case,
		personalDetailsData: req.body.personalDetails,
		component: req.body.component == null ? "6723e333f072dffc31fe4545" : req.body.component,
		checkId: checkId,
	...
	pos: req.body.pos,
		    posRhs: null,
	natureofoccupancy: req.body.natureofoccupancy,
		    natureofoccupancyRhs: null,
	...
	status: req.body.status,
		...
		.then(data => {
			...
			.then(async caseData => {
			    await permanentandcurrentaddress.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
			//.then(caseData => {
			    let checksEntered = 0
		    ...
		    Case
			.update({ _id: req.body.case }, { $push: { actualComponents: "permanentandcurrentaddress" } })
			.then(data => {
		...
		.catch(err => {
		    res.status(500).json({
			message: err.message || 'Some error while saving permanentandcurrentaddress'
		    })
		})
	};
...
exports.findAllForACase = (req, res) => {
		...
		.catch(err => {
		    res.status(500).json({
			message: err.message || 'Some error while retrieving permanentandcurrentaddress for cases'
		    })
		})
	};
	...
	exports.update = (req, res) => {
	    ...
	    permanentandcurrentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
	...
	exports.findOne = (req, res) => {
	    permanentandcurrentaddress.findOne({ case: req.params.caseId, _id: req.params.componentId })
		.then(data => {
		    res.json(data)
		})
		.catch(err => {
	...
	verifiedon: req.body.verifiedon,
	mov: req.body.mov,
	landmark: req.body.landmark,status: req.body.status,
	...
	exports.findComponentsFor = (req, res) => {
	    ...
	    permanentandcurrentaddress.find(query)
	...
	exports.findComponentsForVendorManager = (req, res) => {
		...
		permanentandcurrentaddress.find({ status: req.params.status })
		.sort({ _id: 1 })
		.skip(offSet)
		.limit(200)
		.populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
  ...
  try {
    ...
    const existing = await permanentandcurrentaddress.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await permanentandcurrentaddress.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return permanentandcurrentaddress.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
	...
	// cityRhs: req.body.cityRhs,
	// stateRhs: req.body.stateRhs,
	// postalcodeRhs: req.body.postalcodeRhs,
	// posRhs: req.body.posRhs,
	// natureofoccupancyRhs: req.body.natureofoccupancyRhs,
	// verifiedbyRhs: req.body.verifiedbyRhs,
	// verifiedonRhs: req.body.verifiedonRhs,
	...
	exports.updateFeVerificationStatus = (req, res) => {
	    permanentandcurrentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {addressRhs: req.body.addressRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,posRhs: req.body.posRhs,natureofoccupancyRhs: req.body.natureofoccupancyRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,landmarkRhs: req.body.landmarkRhs,
	status: req.body.status,
	...
	exports.updateVendorVerificationStatus = (req, res) => {
	    permanentandcurrentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
		addressRhs: req.body.addressRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,posRhs: req.body.posRhs,natureofoccupancyRhs: req.body.natureofoccupancyRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,landmarkRhs: req.body.landmarkRhs,
	status: req.body.status,
    ...
    try {
		...
		//added code nov-07
				...
				if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
					...
					await permanentandcurrentaddress.findOneAndUpdate(
						{ case: caseId, _id: componentId },
						{
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'permanentandcurrentaddress Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
	...
	// 	permanentandcurrentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {addressRhs: req.body.data.addressRhs,cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,postalcodeRhs: req.body.data.postalcodeRhs,posRhs: req.body.data.posRhs,natureofoccupancyRhs: req.body.data.natureofoccupancyRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,landmarkRhs: req.body.data.landmarkRhs,
	// status: req.body.status,
	// 	mentorReviewCompletionDate: new Date(),
	// 		mentorReviewComments: req.body.mentorReviewComments,
	// 		mentorReviewCompletedBy: req.user.user_id
	...
	// 				    let mailText = subclientNotificationData.template.content
	// 				    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'permanentandcurrentaddress Details'</td><td>${data.address}</td><td>${data.gradingComments}</td></tr></table>`
	// 				    let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    permanentandcurrentaddress.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await permanentandcurrentaddress.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await permanentandcurrentaddress.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await permanentandcurrentaddress.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In permanentandcurrentaddress Create for CDE")
...
if (!req.body.natureofoccupancy) {
            res.status(400).json({ message: "natureofoccupancy is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In permanentandcurrentaddress for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        permanentandcurrentaddress.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

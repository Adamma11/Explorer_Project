...
const digitcurrentandpermanentaddress = require('../../models/data_entry/digitcurrentandpermanentaddress.model')
...
if (!req.body.completeaddress) {
                    return res.status(400).json({ message: "completeaddress is Mandatory" })
                }
if (!req.body.city) {
...
if (!req.body.postalcode) {
                    return res.status(400).json({ message: "postalcode is Mandatory" })
                }
if (!req.body.landmark) {
                    return res.status(400).json({ message: "landmark is Mandatory" })
                }
if (!req.body.pos) {
                    return res.status(400).json({ message: "pos is Mandatory" })
                }
if (!req.body.noc) {
                    return res.status(400).json({ message: "noc is Mandatory" })
                }
if (!req.body.status) {
        res.status(400).json({ message: 'Status required' })
    }
    const obj = new digitcurrentandpermanentaddress({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "68b03a990d62c5e7c568772f" : req.body.component,
        checkId: checkId,
completeaddress: req.body.completeaddress,
            completeaddressRhs: null,
city: req.body.city,
            cityRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await digitcurrentandpermanentaddress.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "digitcurrentandpermanentaddress" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving digitcurrentandpermanentaddress'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    digitcurrentandpermanentaddress
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving digitcurrentandpermanentaddress for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    digitcurrentandpermanentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    digitcurrentandpermanentaddress.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
charges: req.body.charges,status: req.body.status,
...
exports.findComponentsFor = (req, res) => {
    ...
    digitcurrentandpermanentaddress.find(query)
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    digitcurrentandpermanentaddress
        ...
        digitcurrentandpermanentaddress.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await digitcurrentandpermanentaddress.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await digitcurrentandpermanentaddress.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return digitcurrentandpermanentaddress.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
exports.updateFeVerificationStatus = (req, res) => {
    digitcurrentandpermanentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {completeaddressRhs: req.body.completeaddressRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,landmarkRhs: req.body.landmarkRhs,posRhs: req.body.posRhs,nocRhs: req.body.nocRhs,geolRhs: req.body.geolRhs,geogRhs: req.body.geogRhs,resultRhs: req.body.resultRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,chargesRhs: req.body.chargesRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    digitcurrentandpermanentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        completeaddressRhs: req.body.completeaddressRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,postalcodeRhs: req.body.postalcodeRhs,landmarkRhs: req.body.landmarkRhs,posRhs: req.body.posRhs,nocRhs: req.body.nocRhs,geolRhs: req.body.geolRhs,geogRhs: req.body.geogRhs,resultRhs: req.body.resultRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,chargesRhs: req.body.chargesRhs,
status: req.body.status,
 ...
 return acc;
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await digitcurrentandpermanentaddress.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let mailText = subclientNotificationData.template.content;
		                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'digitcurrentandpermanentaddress Details'</td><td>${data.completeaddress}</td><td>${data.gradingComments}</td></tr></table>`
...
exports.updateOutputqcStatus = (req, res) => {
        digitcurrentandpermanentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {completeaddressRhs: req.body.data.completeaddressRhs,cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,postalcodeRhs: req.body.data.postalcodeRhs,landmarkRhs: req.body.data.landmarkRhs,posRhs: req.body.data.posRhs,nocRhs: req.body.data.nocRhs,geolRhs: req.body.data.geolRhs,geogRhs: req.body.data.geogRhs,resultRhs: req.body.data.resultRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,chargesRhs: req.body.data.chargesRhs,
status: req.body.status,
        outputqcCompletionDate: new Date(),
...
exports.deleteCheck = (req, res) => {
    digitcurrentandpermanentaddress.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await digitcurrentandpermanentaddress.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await digitcurrentandpermanentaddress.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await digitcurrentandpermanentaddress.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In digitcurrentandpermanentaddress Create for CDE")
    let caseId = req.caseId
    if (!req.body.case) {
        res.status(400).json({ message: "Case Id is Mandatory" })
    }
if (!req.body.completeaddress) {
            res.status(400).json({ message: "completeaddress is Mandatory" })
        }
if (!req.body.city) {
...
if (!req.body.postalcode) {
            res.status(400).json({ message: "postalcode is Mandatory" })
        }
if (!req.body.landmark) {
...
if (!req.body.noc) {
            res.status(400).json({ message: "noc is Mandatory" })
        }
if (!req.body.geol) {
            res.status(400).json({ message: "geol is Mandatory" })
        }
if (!req.body.geog) {
            res.status(400).json({ message: "geog is Mandatory" })
        }
if (!req.body.result) {
...
if (!req.body.charges) {
            res.status(400).json({ message: "charges is Mandatory" })
        }
if (!req.body.status) {
    res.status(400).json({ message: 'Status required' })
}
...
exports.findOneForCde = (req, res) => {
    console.log("In digitcurrentandpermanentaddress for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        digitcurrentandpermanentaddress.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

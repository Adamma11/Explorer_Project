...
const safeDob = formattedDob && !isNaN(new Date(formattedDob).getTime())
  ...
  : null;
    ...
    const obj = new criminalcourt({
        ...
        component: req.body.component == null ? "6722262eff5ce4ee231a98eb" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await criminalcourt.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await criminalcourt.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return criminalcourt.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
    ...
    try {
        ...
        //added code nov-07
                ...
                if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
                    ...
                    await criminalcourt.findOneAndUpdate(
                        { case: caseId, _id: componentId },
                        {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'criminalcourt Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
//         criminalcourt.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,fathernameRhs: req.body.data.fathernameRhs,dobRhs: req.body.data.dobRhs,addressRhs: req.body.data.addressRhs,posRhs: req.body.data.posRhs,proceedingsRhs: req.body.data.proceedingsRhs,searchRhs: req.body.data.searchRhs,sessioncourtRhs: req.body.data.sessioncourtRhs,magistratecourtRhs: req.body.data.magistratecourtRhs,civilcourtRhs: req.body.data.civilcourtRhs,appealshighcourtRhs: req.body.data.appealshighcourtRhs,highcourtRhs: req.body.data.highcourtRhs,supremecourtRhs: req.body.data.supremecourtRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,modeofverificationRhs: req.body.data.modeofverificationRhs,
// status: req.body.status,
//         mentorReviewCompletionDate: new Date(),
// 		mentorReviewComments: req.body.mentorReviewComments,
// 		mentorReviewCompletedBy: req.user.user_id

...
const academicreference = require('../../models/data_entry/academicreference.model')
...
if (!req.body.status) {
    ...
    const obj = new academicreference({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "672201dedec2aeecb2d5ae9d" : req.body.component,
        checkId: checkId,
name: req.body.name,
            nameRhs: null,
...
weakness: req.body.weakness,
            weaknessRhs: null,
stressful: req.body.stressful,
            stressfulRhs: null,
improvement: req.body.improvement,
            improvementRhs: null,
communicationskill: req.body.communicationskill,
            communicationskillRhs: null,
overallacademic: req.body.overallacademic,
            overallacademicRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await academicreference.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "academicreference" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving academicreference'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    academicreference
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving academicreference for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    academicreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    academicreference.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    academicreference
        ...
        academicreference.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
sinceRhs: req.body.sinceRhs,
feedbackRhs: req.body.feedbackRhs,
achievementsRhs: req.body.achievementsRhs,
timelineRhs: req.body.timelineRhs,
strengthRhs: req.body.strengthRhs,
weaknessRhs: req.body.weaknessRhs,
stressfulRhs: req.body.stressfulRhs,
improvementRhs: req.body.improvementRhs,
communicationskillRhs: req.body.communicationskillRhs,
overallacademicRhs: req.body.overallacademicRhs,
...
exports.updateFeVerificationStatus = (req, res) => {
    academicreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.nameRhs,contactRhs: req.body.contactRhs,emailidRhs: req.body.emailidRhs,relationshipwithrefereeRhs: req.body.relationshipwithrefereeRhs,sinceRhs: req.body.sinceRhs,feedbackRhs: req.body.feedbackRhs,achievementsRhs: req.body.achievementsRhs,timelineRhs: req.body.timelineRhs,strengthRhs: req.body.strengthRhs,weaknessRhs: req.body.weaknessRhs,stressfulRhs: req.body.stressfulRhs,improvementRhs: req.body.improvementRhs,communicationskillRhs: req.body.communicationskillRhs,overallacademicRhs: req.body.overallacademicRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
exports.updateVendorVerificationStatus = (req, res) => {
    academicreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,contactRhs: req.body.contactRhs,emailidRhs: req.body.emailidRhs,relationshipwithrefereeRhs: req.body.relationshipwithrefereeRhs,sinceRhs: req.body.sinceRhs,feedbackRhs: req.body.feedbackRhs,achievementsRhs: req.body.achievementsRhs,timelineRhs: req.body.timelineRhs,strengthRhs: req.body.strengthRhs,weaknessRhs: req.body.weaknessRhs,stressfulRhs: req.body.stressfulRhs,improvementRhs: req.body.improvementRhs,communicationskillRhs: req.body.communicationskillRhs,overallacademicRhs: req.body.overallacademicRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,
status: req.body.status,
...
/*exports.updateMentorReviewStatus = (req, res) => {
        ...
        academicreference.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {nameRhs: req.body.data.nameRhs,contactRhs: req.body.data.contactRhs,emailidRhs: req.body.data.emailidRhs,relationshipwithrefereeRhs: req.body.data.relationshipwithrefereeRhs,sinceRhs: req.body.data.sinceRhs,feedbackRhs: req.body.data.feedbackRhs,achievementsRhs: req.body.data.achievementsRhs,timelineRhs: req.body.data.timelineRhs,strengthRhs: req.body.data.strengthRhs,weaknessRhs: req.body.data.weaknessRhs,stressfulRhs: req.body.data.stressfulRhs,improvementRhs: req.body.data.improvementRhs,communicationskillRhs: req.body.data.communicationskillRhs,overallacademicRhs: req.body.data.overallacademicRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,
status: req.body.status,
                        ...
                        if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                            Case
                                ...
                                .then(caseData => {
                                    ...
                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'academicreference Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
...
exports.deleteCheck = (req, res) => {
    academicreference.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await academicreference.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await academicreference.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await academicreference.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In academicreference Create for CDE")
...
if (!req.body.relationshipwithreferee) {
            res.status(400).json({ message: "relationshipwithreferee is Mandatory" })
        }
if (!req.body.since) {
            res.status(400).json({ message: "since is Mandatory" })
        }
if (!req.body.feedback) {
            res.status(400).json({ message: "feedback is Mandatory" })
        }
if (!req.body.achievements) {
            res.status(400).json({ message: "achievements is Mandatory" })
        }
if (!req.body.timeline) {
            res.status(400).json({ message: "timeline is Mandatory" })
        }
if (!req.body.strength) {
            res.status(400).json({ message: "strength is Mandatory" })
        }
if (!req.body.weakness) {
            res.status(400).json({ message: "weakness is Mandatory" })
        }
if (!req.body.stressful) {
            res.status(400).json({ message: "stressful is Mandatory" })
        }
if (!req.body.improvement) {
            res.status(400).json({ message: "improvement is Mandatory" })
        }
if (!req.body.communicationskill) {
            res.status(400).json({ message: "communicationskill is Mandatory" })
        }
if (!req.body.overallacademic) {
            res.status(400).json({ message: "overallacademic is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In academicreference for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        academicreference.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await academicreference.findOne({ case: caseId, _id: componentId });
    ...
    if (req.body.status === 'VERIFICATION-COMPLETED' || req.body.verificationStatus === 'FE-COMPLETED') {
      ...
      const updated = await academicreference.findOneAndUpdate(
    ...
    if (req.body.status === 'DRAFT') {
      return academicreference.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
          ...updateData,
          stage: 'WIP'
...
if (req.body.status === "MENTOR-REVIEW-ACCEPTED") {
    ...
    await academicreference.findOneAndUpdate(
        { case: caseId, _id: componentId },
        {
    ...
    await caseHistory.create(
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let mailText = subclientNotificationData.template.content;
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'academicreference Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
                let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails);

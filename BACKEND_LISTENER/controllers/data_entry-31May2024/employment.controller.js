...
const Company = require("../../models/masters/company.model")
...
if (!req.body.organization) {
                    return res.status(400).json({ message: "organization is Mandatory" })
                }
if (!req.body.location) {
                    return res.status(400).json({ message: "location is Mandatory" })
                }
if (!req.body.contactno) {
                    return res.status(400).json({ message: "contactno is Mandatory" })
                }
if (!req.body.empid) {
                    return res.status(400).json({ message: "empid is Mandatory" })
                }
if (!req.body.doj) {
...
if (!req.body.remuneration) {
                    return res.status(400).json({ message: "remuneration is Mandatory" })
                }
...
if (!req.body.status) {
    ...
    const obj = new employment({
        case: req.body.case,
	    checkId: checkId,
        personalDetailsData: req.body.personalDetails,
        component: req.body.component == null ? "undefined" : req.body.component,
organization: req.body.organization,
            organizationRhs: null,
...
verifiername: req.body.verifiername,
            verifiernameRhs: null,
verifierdesignation: req.body.verifierdesignation,
            verifierdesignationRhs: null,
verifieremailid: req.body.verifieremailid,
            verifieremailidRhs: null,
dutiesandresponsibilities: req.body.dutiesandresponsibilities,
            dutiesandresponsibilitiesRhs: null,
integrity: req.body.integrity,
            integrityRhs: null,
officialresg: req.body.officialresg,
            officialresgRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await employment.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "employment" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving employment'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    employment
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving employment for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    employment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    employment.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    employment
        ...
        employment.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
organizationRhs: req.body.organizationRhs,
locationRhs: req.body.locationRhs,
contactnoRhs: req.body.contactnoRhs,
...
dutiesandresponsibilitiesRhs: req.body.dutiesandresponsibilitiesRhs,
integrityRhs: req.body.integrityRhs,
officialresgRhs: req.body.officialresgRhs,
eligibleRhs: req.body.eligibleRhs,
...
status: req.body.status,
        ...
        const employmentData = await employment.findOne({ case: req.params.caseId, _id: req.params.componentId })
        ...
        } else if (!employmentData.secondInsufficiencyRaisedDate) {
        ...
        } else if (!employmentData.thirdInsufficiencyRaisedDate) {
        ...
        } else if (!employmentData.fourthInsufficiencyRaisedDate) {
        ...
        } else if (!employmentData.fifthInsufficiencyRaisedDate) {
...
exports.updateFeVerificationStatus = (req, res) => {
    employment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        organizationRhs: req.body.organizationRhs,locationRhs: req.body.locationRhs,contactnoRhs: req.body.contactnoRhs,empidRhs: req.body.empidRhs,dojRhs: req.body.dojRhs,dorRhs: req.body.dorRhs,designationRhs: req.body.designationRhs,remunerationRhs: req.body.remunerationRhs,reasonforleavingRhs: req.body.reasonforleavingRhs,activeRhs: req.body.activeRhs,verifiernameRhs: req.body.verifiernameRhs,verifierdesignationRhs: req.body.verifierdesignationRhs,verifieremailidRhs: req.body.verifieremailidRhs,dutiesandresponsibilitiesRhs: req.body.dutiesandresponsibilitiesRhs,integrityRhs: req.body.integrityRhs,officialresgRhs: req.body.officialresgRhs,eligibleRhs: req.body.eligibleRhs,exitformalitiesRhs: req.body.exitformalitiesRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,movRhs: req.body.movRhs,status: req.body.status,
...
exports.updateMentorReviewStatus = (req, res) => {
    ...
    employment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
	 organizationRhs: req.body.data.organizationRhs,
locationRhs: req.body.data.locationRhs,
contactnoRhs: req.body.data.contactnoRhs,
empidRhs: req.body.data.empidRhs,
dojRhs: req.body.data.dojRhs,
dorRhs: req.body.data.dorRhs,
designationRhs: req.body.data.designationRhs,
remunerationRhs: req.body.data.remunerationRhs,
reasonforleavingRhs: req.body.data.reasonforleavingRhs,
activeRhs: req.body.data.activeRhs,
...
dutiesandresponsibilitiesRhs: req.body.data.dutiesandresponsibilitiesRhs,
integrityRhs: req.body.data.integrityRhs,
officialresgRhs: req.body.data.officialresgRhs,
eligibleRhs: req.body.data.eligibleRhs,
exitformalitiesRhs: req.body.data.exitformalitiesRhs,
                        ...
                        if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                            Case
                                ...
                                .then(caseData => {
                                    ...
                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'employment Details'</td><td>${data.organization}</td><td>${data.gradingComments}</td></tr></table>`
...
exports.approveInsuff2 = async (req, res) => {
    ...
    try {
        ...
        if (!employmenttData.secondInsufficiencyRaisedDate) {

            const data = await employment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.searchACaseForInsuffForClient = (req, res) => {
    ...
    console.log("In search for insuff case employment, case id required is ", req.query.caseId)

    Case
        .findOne({ caseId: req.query.caseId })
        .then(caseData => {
            console.log("Case Data found for employment insuff")
            ...
            UserSubclientAccess.find({ user: req.user.user_id }, { _id: 0, subclient: 1 })
                .then(userSubclientData => {
                    console.log("In employment insuff user subclient access is ", userSubclientData)
                    employment
                        ...
                        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
                        .then(data => {
                            console.log("Found the employment insuff data ", data)
                            res.json(data)
                        })
                        .catch(err => {
                            res.status(500).json({
                                message: "Error searching insuff for employment"
                            })
                        })
                })
                .catch(err => {
...
exports.approveInsuffClearance = async (req, res) => {
    ...
    try {
        ...
        if (req.body.status == "INSUF-2-CLEARED") {
            ...
            if (!employmentData.secondInsufficiencyClearedDate) {
            ...
            } else if (!employmentData.thirdInsufficiencyClearedDate) {
            ...
            } else if (!employmentData.fourthInsufficiencyClearedDate) {
            ...
            } else if (!employmentData.fifthInsufficiencyClearedDate) {
...
exports.deleteCheck = (req, res) => {
    employment.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.getChecksWhereGradeOneIsNullAndGradeNotNull = (req, res) => {
    employment
        ...
        .then(data => {
            data.forEach(item => {
                console.log("About to update subclient of employment", item._id)
                employment
                    .findOneAndUpdate({ _id: item._id }, { subclient: item.case.subclient._id, client: item.case.subclient.client._id })
                    .then(data => {
                    })
                    .catch(err => {
                        console.log("Error in updating employment ", err)
                    })
            })
            res.json({ message: "Completed" })
        })
        .catch(err => {
            console.log("Error reading employment", err)
            res.status(500).json({
...
exports.createForCde = (req, res) => {
    console.log("In employment Create for CDE")
    let caseId = req.caseId
    if (!req.body.case) {
        res.status(400).json({ message: "Case Id is Mandatory" })
    }
if (!req.body.organization) {
            res.status(400).json({ message: "organization is Mandatory" })
        }
if (!req.body.location) {
            res.status(400).json({ message: "location is Mandatory" })
        }
if (!req.body.contactno) {
            res.status(400).json({ message: "contactno is Mandatory" })
        }
if (!req.body.empid) {
            res.status(400).json({ message: "empid is Mandatory" })
        }
if (!req.body.doj) {
...
if (!req.body.remuneration) {
            res.status(400).json({ message: "remuneration is Mandatory" })
        }
if (!req.body.reasonforleaving) {
            res.status(400).json({ message: "reasonforleaving is Mandatory" })
        }
if (!req.body.active) {
            res.status(400).json({ message: "active is Mandatory" })
        }
if (!req.body.verifiername) {
            res.status(400).json({ message: "verifiername is Mandatory" })
        }
if (!req.body.verifierdesignation) {
            res.status(400).json({ message: "verifierdesignation is Mandatory" })
        }
if (!req.body.verifieremailid) {
            res.status(400).json({ message: "verifieremailid is Mandatory" })
        }
if (!req.body.dutiesandresponsibilities) {
            res.status(400).json({ message: "dutiesandresponsibilities is Mandatory" })
        }
if (!req.body.integrity) {
            res.status(400).json({ message: "integrity is Mandatory" })
        }
if (!req.body.officialresg) {
            res.status(400).json({ message: "officialresg is Mandatory" })
        }
if (!req.body.eligible) {
            res.status(400).json({ message: "eligible is Mandatory" })
        }
...
if (!req.body.status) {
    ...
    console.log("Case Id for employment CDE ", caseId)
    if (caseId != null) {
        const obj = new employment({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
...
status: req.body.status,
        ...
        console.log("Object for saving created in CDE for employment")
        if (req.body.status == 'CDE-COMPLETED') {
            obj.dataEntryCompletionDate = new Date()
        } else {
            obj.insufficiencyComments = req.body.insufficiencyComments
        }
        console.log("About to save employment for CDE")
        obj
            .save(obj)
            .then(data => {
            ...
            .catch(err => {
                console.log("Error Occurred while creating the employment for CDE ", err)
                res.status(500).json({
                    message: err.message || 'Some error while saving employment'
                })
            })
...
exports.findOneForCde = (req, res) => {
    console.log("In employment for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        employment.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await employment.findOne({ _id: req.body._id })
        const caseComments = []
	 ...
	 const commentToPush = {user: mongoose.Types.ObjectId(req.user.user_id), date: new Date(), comment: req.body.comment, colorType: req.body.colorType }
        ...
        const updatedCaseData = await employment.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await employment.findOne({ _id: req.params.case_id })
...
exports.getNamesFromEmploymentMasters = async (req, res) => {
    console.log("printing all the employment details");
    try {
        const searchString = req.query.search
        const employmentName = await Company.find({ name: { "$regex": searchString, $options: 'i' } })
        console.log("@@@@@",employmentName)
        return res.json(employmentName)
    }
    catch (error) {
        console.log("error");
        res.status(500).json({
            message: "error while retriving the names of employment"
        })
    }
}

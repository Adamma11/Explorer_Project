...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c2d73c176fe8818613ab4":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     emergencycontact.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       contactnumberoneRhs:req.body.data.contactnumberoneRhs,
       relationshiponeRhs:req.body.data.relationshiponeRhs,
       contactnumbertwoRhs:req.body.data.contactnumbertwoRhs,
       relationshiptwoRhs:req.body.data.relationshiptwoRhs,

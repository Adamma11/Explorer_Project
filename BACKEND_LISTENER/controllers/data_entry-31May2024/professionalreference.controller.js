...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650a7c21c176fe88186128aa":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     professionalreference.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       emailRhs:req.body.data.emailRhs,
       rwrRhs:req.body.data.rwrRhs,
       knowthecandidateRhs:req.body.data.knowthecandidateRhs,
       communicationskillsRhs:req.body.data.communicationskillsRhs,
       pressureRhs:req.body.data.pressureRhs,
       skillsRhs:req.body.data.skillsRhs,
       managementskillsRhs:req.body.data.managementskillsRhs,
       reliabilityRhs:req.body.data.reliabilityRhs,
       honestyRhs:req.body.data.honestyRhs,
       punctualityRhs:req.body.data.punctualityRhs,
       interferingRhs:req.body.data.interferingRhs,
       ratingRhs:req.body.data.ratingRhs,
       ...
       goalsandobjectivesRhs:req.body.data.goalsandobjectivesRhs,
       strengthsRhs:req.body.data.strengthsRhs,
       weaknessesRhs:req.body.data.weaknessesRhs,

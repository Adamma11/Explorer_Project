...
const checkId = `${caseObj.caseId}-${numComponents}`
   ...
   if(!req.body.emailid){
       res.status(400).json({message:'Reference Email ID required'})
   }
   if(!req.body.status){
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c35afc176fe8818613bd2":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     academicreference.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       relationshipwithrefereeRhs:req.body.data.relationshipwithrefereeRhs,
       sinceRhs:req.body.data.sinceRhs,
       feedbackRhs:req.body.data.feedbackRhs,
       achievementsRhs:req.body.data.achievementsRhs,
       timelineRhs:req.body.data.timelineRhs,
       strengthRhs:req.body.data.strengthRhs,
       weaknessRhs:req.body.data.weaknessRhs,
       stressfulRhs:req.body.data.stressfulRhs,
       improvementRhs:req.body.data.improvementRhs,
       communicationskillRhs:req.body.data.communicationskillRhs,
       overallacademicRhs:req.body.data.overallacademicRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c3805c176fe8818613c68":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     companyverificationonline.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       companytypeRhs:req.body.data.companytypeRhs,
       fakesearchRhs:req.body.data.fakesearchRhs,
       negativewebsearchRhs:req.body.data.negativewebsearchRhs,
       addressactiveRhs:req.body.data.addressactiveRhs,
       addresstypeRhs:req.body.data.addresstypeRhs,
       numberRhs:req.body.data.numberRhs,
       emailidRhs:req.body.data.emailidRhs,
       epfoRhs:req.body.data.epfoRhs,
       gststatusRhs:req.body.data.gststatusRhs,
       gstnumberRhs:req.body.data.gstnumberRhs,
       existingsinceRhs:req.body.data.existingsinceRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c08d0c176fe8818613716":req.body.component,
       name:req.body.name,
       nameRhs:null,
       dob:req.body.dob,
       dobRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     directorship.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       dinnumberRhs:req.body.data.dinnumberRhs,
       statusRhs:req.body.data.statusRhs,
       legalobligationsRhs:req.body.data.legalobligationsRhs,

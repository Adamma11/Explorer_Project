...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c28f1c176fe88186139f4":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     cpc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       policeststusRhs:req.body.data.policeststusRhs,
       dateRhs:req.body.data.dateRhs,
       policestationRhs:req.body.data.policestationRhs,
       contactdtailsRhs:req.body.data.contactdtailsRhs,
       numberofyearscoverdRhs:req.body.data.numberofyearscoverdRhs,
       resultRhs:req.body.data.resultRhs,
       additionalcommentsRhs:req.body.data.additionalcommentsRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c11adc176fe88186137fc":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     pvc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       liasoningRhs:req.body.data.liasoningRhs,
       verificationRhs:req.body.data.verificationRhs,
       stationRhs:req.body.data.stationRhs,
       stationaddrerssRhs:req.body.data.stationaddrerssRhs,
       numberofyearRhs:req.body.data.numberofyearRhs,
       pvcresultRhs:req.body.data.pvcresultRhs,

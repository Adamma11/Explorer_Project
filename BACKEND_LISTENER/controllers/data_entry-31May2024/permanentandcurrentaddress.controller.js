 ...
 //  if(!req.body.name){
  ...
  // }
   ...
   if(!req.body.postalcode){
       res.status(400).json({message:'Postal Code required'})
   }
   if(!req.body.status){
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650abf46c176fe8818612f1b":req.body.component,
      // name:req.body.name,
       //nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     permanentandcurrentaddress.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       postalcodeRhs:req.body.data.postalcodeRhs,
       landmarkRhs:req.body.data.landmarkRhs,
       posRhs:req.body.data.posRhs,
       natureofoccupancyRhs:req.body.data.natureofoccupancyRhs,

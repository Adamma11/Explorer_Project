...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c25b7c176fe88186139a6":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     webandmedia.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       racismRhs:req.body.data.racismRhs,
       behaviorRhs:req.body.data.behaviorRhs,
       unlawfulactivityRhs:req.body.data.unlawfulactivityRhs,
       sexuallyRhs:req.body.data.sexuallyRhs,
       religiousbeliefsRhs:req.body.data.religiousbeliefsRhs,
       profileandcredentialsRhs:req.body.data.profileandcredentialsRhs,

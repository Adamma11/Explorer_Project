...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650ab705c176fe8818612e1d":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     workpermit.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       validtoRhs:req.body.data.validtoRhs,
       workpermitRhs:req.body.data.workpermitRhs,

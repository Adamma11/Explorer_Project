...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650bc4e7c176fe881861336f":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     identityanddigital.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       photoRhs:req.body.data.photoRhs,
       resultRhs:req.body.data.resultRhs,
       discrepancyRhs:req.body.data.discrepancyRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c2a08c176fe8818613a54":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     cvc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       numberofyearsRhs:req.body.data.numberofyearsRhs,
       resultRhs:req.body.data.resultRhs,
       dateRhs:req.body.data.dateRhs,
       commentsRhs:req.body.data.commentsRhs,
       ...
       appealsRhs:req.body.data.appealsRhs,
       highcourtRhs:req.body.data.highcourtRhs,
       supremeRhs:req.body.data.supremeRhs,

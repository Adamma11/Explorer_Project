...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650ab986c176fe8818612e8f":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     gapanalysis.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       gapineduRhs:req.body.data.gapineduRhs,
       gapinempRhs:req.body.data.gapinempRhs,
       reasoninempRhs:req.body.data.reasoninempRhs,
       verifiedbyRhs:req.body.data.verifiedbyRhs,
       verifiedonRhs:req.body.data.verifiedonRhs,
       movRhs:req.body.data.movRhs,
       reasonineduRhs:req.body.data.reasonineduRhs,
	     status:req.body.status,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650be2e7c176fe88186135aa":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     dinverification.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       directornameRhs:req.body.data.directornameRhs,
       dinnumberRhs:req.body.data.dinnumberRhs,
       dobRhs:req.body.data.dobRhs,
       sourceRhs:req.body.data.sourceRhs,

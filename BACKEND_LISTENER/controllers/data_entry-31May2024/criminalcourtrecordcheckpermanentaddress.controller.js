...
status: req.body.status,
        ...
        const criminalcourtrecordcheckpermanentaddressData = await criminalcourtrecordcheckpermanentaddress.findOne({ case: req.params.caseId, _id: req.params.componentId })
        ...
        } else if (!criminalcourtrecordcheckpermanentaddressData.secondInsufficiencyRaisedDate) {
        ...
        } else if (!criminalcourtrecordcheckpermanentaddressData.thirdInsufficiencyRaisedDate) {
        ...
        } else if (!criminalcourtrecordcheckpermanentaddressData.fourthInsufficiencyRaisedDate) {
        ...
        } else if (!criminalcourtrecordcheckpermanentaddressData.fifthInsufficiencyRaisedDate) {
...
/*exports.approveInsuff2 = async (req, res) => {
    ...
    try {
        ...
        if (!criminalcourtrecordcheckpermanentaddresstData.secondInsufficiencyRaisedDate) {

            const data = await criminalcourtrecordcheckpermanentaddress.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.searchACaseForInsuffForClient = (req, res) => {
    ...
    console.log("In search for insuff case criminalcourtrecordcheckpermanentaddress, case id required is ", req.query.caseId)

    Case
        .findOne({ caseId: req.query.caseId })
        .then(caseData => {
            console.log("Case Data found for criminalcourtrecordcheckpermanentaddress insuff")
            ...
            UserSubclientAccess.find({ user: req.user.user_id }, { _id: 0, subclient: 1 })
                .then(userSubclientData => {
                    console.log("In criminalcourtrecordcheckpermanentaddress insuff user subclient access is ", userSubclientData)
                    criminalcourtrecordcheckpermanentaddress
                        ...
                        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
                        .then(data => {
                            console.log("Found the criminalcourtrecordcheckpermanentaddress insuff data ", data)
                            res.json(data)
                        })
                        .catch(err => {
                            res.status(500).json({
                                message: "Error searching insuff for criminalcourtrecordcheckpermanentaddress"
                            })
                        })
                })
                .catch(err => {
...
exports.approveInsuffClearance = async (req, res) => {
    ...
    try {
        ...
        if (req.body.status == "INSUF-2-CLEARED") {
            ...
            if (!criminalcourtrecordcheckpermanentaddressData.secondInsufficiencyClearedDate) {
            ...
            } else if (!criminalcourtrecordcheckpermanentaddressData.thirdInsufficiencyClearedDate) {
            ...
            } else if (!criminalcourtrecordcheckpermanentaddressData.fourthInsufficiencyClearedDate) {
            ...
            } else if (!criminalcourtrecordcheckpermanentaddressData.fifthInsufficiencyClearedDate) {
...
exports.getChecksWhereGradeOneIsNullAndGradeNotNull = (req, res) => {
    criminalcourtrecordcheckpermanentaddress
        ...
        .then(data => {
            data.forEach(item => {
                console.log("About to update subclient of criminalcourtrecordcheckpermanentaddress", item._id)
                criminalcourtrecordcheckpermanentaddress
                    .findOneAndUpdate({ _id: item._id }, { subclient: item.case.subclient._id, client: item.case.subclient.client._id })
                    .then(data => {
                    })
                    .catch(err => {
                        console.log("Error in updating criminalcourtrecordcheckpermanentaddress ", err)
                    })
            })
            res.json({ message: "Completed" })
        })
        .catch(err => {
            console.log("Error reading criminalcourtrecordcheckpermanentaddress", err)
            res.status(500).json({
...
if (!req.body.status) {
    ...
    console.log("Case Id for criminalcourtrecordcheckpermanentaddress CDE ", caseId)
    if (caseId != null) {
        const obj = new criminalcourtrecordcheckpermanentaddress({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
...
status: req.body.status,
        ...
        console.log("Object for saving created in CDE for criminalcourtrecordcheckpermanentaddress")
        if (req.body.status == 'CDE-COMPLETED') {
            obj.dataEntryCompletionDate = new Date()
        } else {
            obj.insufficiencyComments = req.body.insufficiencyComments
        }
        console.log("About to save criminalcourtrecordcheckpermanentaddress for CDE")
        obj
            .save(obj)
            .then(data => {
            ...
            .catch(err => {
                console.log("Error Occurred while creating the criminalcourtrecordcheckpermanentaddress for CDE ", err)
                res.status(500).json({
                    message: err.message || 'Some error while saving criminalcourtrecordcheckpermanentaddress'
                })
            })

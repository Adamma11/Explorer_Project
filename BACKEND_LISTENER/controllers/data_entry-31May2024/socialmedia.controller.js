...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650aa6edc176fe8818612d87":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     socialmedia.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       violentbehaviourRhs:req.body.data.violentbehaviourRhs,
       ...
       misrepresentationRhs:req.body.data.misrepresentationRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650d1e69c176fe8818613eb2":req.body.component,
       name:req.body.name,
       nameRhs:null,
       dob:req.body.dob,
       dobRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     uan.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       uannumberRhs:req.body.data.uannumberRhs,
       resultRhs:req.body.data.resultRhs,
       previouscompanyoneRhs:req.body.data.previouscompanyoneRhs,
       dojoneRhs:req.body.data.dojoneRhs,
       doroneRhs:req.body.data.doroneRhs,
       previouscompanytwoRhs:req.body.data.previouscompanytwoRhs,
       dojtwoRhs:req.body.data.dojtwoRhs,
       dortwoRhs:req.body.data.dortwoRhs,
       previouscompanythreeRhs:req.body.data.previouscompanythreeRhs,
       dojthreeRhs:req.body.data.dojthreeRhs,
       dorthreeRhs:req.body.data.dorthreeRhs,
       previouscompanyfourRhs:req.body.data.previouscompanyfourRhs,
       dojfourRhs:req.body.data.dojfourRhs,
       dorfourRhs:req.body.data.dorfourRhs,
       previouscompanyfiveRhs:req.body.data.previouscompanyfiveRhs,
       dojfiveRhs:req.body.data.dojfiveRhs,
       dorfiveRhs:req.body.data.dorfiveRhs,
       previouscompanysixRhs:req.body.data.previouscompanysixRhs,
       dojsixRhs:req.body.data.dojsixRhs,
       dorsixRhs:req.body.data.dorsixRhs,

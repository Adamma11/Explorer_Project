...
const criminalcourt = require('../../models/data_entry/criminalcourt.model')
...
search: req.body.search,
            searchRhs: null,
sessioncourt: req.body.sessioncourt,
            sessioncourtRhs: null,
magistratecourt: req.body.magistratecourt,
            magistratecourtRhs: null,
civilcourt: req.body.civilcourt,
            civilcourtRhs: null,
appealshighcourt: req.body.appealshighcourt,
            appealshighcourtRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await criminalcourt.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "criminalcourt" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving criminalcourt'
            })
        })
};
...
exports.findAllForACase = (req, res) => {
    criminalcourt
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while retrieving criminalcourt for cases'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    criminalcourt.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    criminalcourt.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    criminalcourt
        ...
        criminalcourt.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
sessioncourtRhs: req.body.sessioncourtRhs,
magistratecourtRhs: req.body.magistratecourtRhs,
civilcourtRhs: req.body.civilcourtRhs,
appealshighcourtRhs: req.body.appealshighcourtRhs,
highcourtRhs: req.body.highcourtRhs,
...
status: req.body.status,
        ...
        const criminalcourtData = await criminalcourt.findOne({ case: req.params.caseId, _id: req.params.componentId })
        ...
        } else if (!criminalcourtData.secondInsufficiencyRaisedDate) {
        ...
        } else if (!criminalcourtData.thirdInsufficiencyRaisedDate) {
        ...
        } else if (!criminalcourtData.fourthInsufficiencyRaisedDate) {
        ...
        } else if (!criminalcourtData.fifthInsufficiencyRaisedDate) {
...
exports.updateFeVerificationStatus = (req, res) => {
    criminalcourt.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
        nameRhs: req.body.nameRhs,fathernameRhs: req.body.fathernameRhs,dobRhs: req.body.dobRhs,addressRhs: req.body.addressRhs,posRhs: req.body.posRhs,proceedingsRhs: req.body.proceedingsRhs,searchRhs: req.body.searchRhs,sessioncourtRhs: req.body.sessioncourtRhs,magistratecourtRhs: req.body.magistratecourtRhs,civilcourtRhs: req.body.civilcourtRhs,appealshighcourtRhs: req.body.appealshighcourtRhs,highcourtRhs: req.body.highcourtRhs,supremecourtRhs: req.body.supremecourtRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,modeofverificationRhs: req.body.modeofverificationRhs,status: req.body.status,
...
addressRhs: req.body.data.addressRhs,
posRhs: req.body.data.posRhs,
proceedingsRhs: req.body.data.proceedingsRhs,
searchRhs: req.body.data.searchRhs,
sessioncourtRhs: req.body.data.sessioncourtRhs,
magistratecourtRhs: req.body.data.magistratecourtRhs,
civilcourtRhs: req.body.data.civilcourtRhs,
appealshighcourtRhs: req.body.data.appealshighcourtRhs,
highcourtRhs: req.body.data.highcourtRhs,
supremecourtRhs: req.body.data.supremecourtRhs,
                        ...
                        if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                            Case
                                ...
                                .then(caseData => {
                                    ...
                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'criminalcourt Details'</td><td>${data.name}</td><td>${data.gradingComments}</td></tr></table>`
...
/*exports.approveInsuff2 = async (req, res) => {
    ...
    try {
        ...
        if (!criminalcourttData.secondInsufficiencyRaisedDate) {

            const data = await criminalcourt.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.searchACaseForInsuffForClient = (req, res) => {
    ...
    console.log("In search for insuff case criminalcourt, case id required is ", req.query.caseId)

    Case
        .findOne({ caseId: req.query.caseId })
        .then(caseData => {
            console.log("Case Data found for criminalcourt insuff")
            ...
            UserSubclientAccess.find({ user: req.user.user_id }, { _id: 0, subclient: 1 })
                .then(userSubclientData => {
                    console.log("In criminalcourt insuff user subclient access is ", userSubclientData)
                    criminalcourt
                        ...
                        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
                        .then(data => {
                            console.log("Found the criminalcourt insuff data ", data)
                            res.json(data)
                        })
                        .catch(err => {
                            res.status(500).json({
                                message: "Error searching insuff for criminalcourt"
                            })
                        })
                })
                .catch(err => {
...
exports.approveInsuffClearance = async (req, res) => {
    ...
    try {
        ...
        if (req.body.status == "INSUF-2-CLEARED") {
            ...
            if (!criminalcourtData.secondInsufficiencyClearedDate) {
            ...
            } else if (!criminalcourtData.thirdInsufficiencyClearedDate) {
            ...
            } else if (!criminalcourtData.fourthInsufficiencyClearedDate) {
            ...
            } else if (!criminalcourtData.fifthInsufficiencyClearedDate) {
...
exports.deleteCheck = (req, res) => {
    criminalcourt.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.getChecksWhereGradeOneIsNullAndGradeNotNull = (req, res) => {
    criminalcourt
        ...
        .then(data => {
            data.forEach(item => {
                console.log("About to update subclient of criminalcourt", item._id)
                criminalcourt
                    .findOneAndUpdate({ _id: item._id }, { subclient: item.case.subclient._id, client: item.case.subclient.client._id })
                    .then(data => {
                    })
                    .catch(err => {
                        console.log("Error in updating criminalcourt ", err)
                    })
            })
            res.json({ message: "Completed" })
        })
        .catch(err => {
            console.log("Error reading criminalcourt", err)
            res.status(500).json({
...
exports.createForCde = (req, res) => {
    console.log("In criminalcourt Create for CDE")
...
if (!req.body.sessioncourt) {
            res.status(400).json({ message: "sessioncourt is Mandatory" })
        }
if (!req.body.magistratecourt) {
            res.status(400).json({ message: "magistratecourt is Mandatory" })
        }
if (!req.body.civilcourt) {
            res.status(400).json({ message: "civilcourt is Mandatory" })
        }
if (!req.body.appealshighcourt) {
            res.status(400).json({ message: "appealshighcourt is Mandatory" })
        }
if (!req.body.highcourt) {
            res.status(400).json({ message: "highcourt is Mandatory" })
        }
...
if (!req.body.status) {
    ...
    console.log("Case Id for criminalcourt CDE ", caseId)
    if (caseId != null) {
        const obj = new criminalcourt({
        case: req.body.case,
        personalDetailsData: req.body.personalDetails,
...
status: req.body.status,
        ...
        console.log("Object for saving created in CDE for criminalcourt")
        if (req.body.status == 'CDE-COMPLETED') {
            obj.dataEntryCompletionDate = new Date()
        } else {
            obj.insufficiencyComments = req.body.insufficiencyComments
        }
        console.log("About to save criminalcourt for CDE")
        obj
            .save(obj)
            .then(data => {
            ...
            .catch(err => {
                console.log("Error Occurred while creating the criminalcourt for CDE ", err)
                res.status(500).json({
                    message: err.message || 'Some error while saving criminalcourt'
                })
            })
...
exports.findOneForCde = (req, res) => {
    console.log("In criminalcourt for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        criminalcourt.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await criminalcourt.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await criminalcourt.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await criminalcourt.findOne({ _id: req.params.case_id })

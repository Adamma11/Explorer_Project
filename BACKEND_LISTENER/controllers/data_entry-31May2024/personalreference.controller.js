...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650ab877c176fe8818612e53":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     personalreference.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       refereedetailsRhs:req.body.data.refereedetailsRhs,
       contactRhs:req.body.data.contactRhs,
       relationshipRhs:req.body.data.relationshipRhs,

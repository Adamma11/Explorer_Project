...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650d16c8c176fe8818613dc6":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     companyverificationphysical.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       singboardRhs:req.body.data.singboardRhs,
       feallowedRhs:req.body.data.feallowedRhs,
       officelocationRhs:req.body.data.officelocationRhs,
       companysizeRhs:req.body.data.companysizeRhs,
       companyexistingsinceRhs:req.body.data.companyexistingsinceRhs,
       nameoftheindividualRhs:req.body.data.nameoftheindividualRhs,
       contactnumberoftheindividualRhs:req.body.data.contactnumberoftheindividualRhs,
       designationoftheindividualRhs:req.body.data.designationoftheindividualRhs,
       designationoftheindividualwhoprovideddetailsRhs:req.body.data.designationoftheindividualwhoprovideddetailsRhs,
       locationRhs:req.body.data.locationRhs,
       pincodeRhs:req.body.data.pincodeRhs,
       stateRhs:req.body.data.stateRhs,
       countryRhs:req.body.data.countryRhs,
       landmarkRhs:req.body.data.landmarkRhs,

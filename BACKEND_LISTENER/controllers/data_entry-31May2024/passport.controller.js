...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650be021c176fe8818613538":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     passport.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       passportidRhs:req.body.data.passportidRhs,
       validfromRhs:req.body.data.validfromRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650aa10cc176fe8818612cdf":req.body.component,
...
exports.updateMentorReviewStatus=(req,res)=>{
     fca.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
               firstnameRhs:req.body.data.firstnameRhs,
       middlenameRhs:req.body.data.middlenameRhs,
       lastnameRhs:req.body.data.lastnameRhs,

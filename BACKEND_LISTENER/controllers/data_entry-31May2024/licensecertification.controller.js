...
const checkId = `${caseObj.caseId}-${numComponents}`
   if(!req.body.name){
       res.status(400).json({message:'Name of the Institute or Certificate issuing Authority required'})
   }
   if(!req.body.city){
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c2e62c176fe8818613af6":req.body.component,
       name:req.body.name,
       nameRhs:null,
       city:req.body.city,
       cityRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     licensecertification.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       areaRhs:req.body.data.areaRhs,
       regnumberRhs:req.body.data.regnumberRhs,
       monthandyearoflicenseRhs:req.body.data.monthandyearoflicenseRhs,

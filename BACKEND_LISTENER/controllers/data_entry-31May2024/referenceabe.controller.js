...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c3bc0c176fe8818613cc6":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     referenceabe.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       contactRhs:req.body.data.contactRhs,
       emailidRhs:req.body.data.emailidRhs,
       relationshipwithcandidateRhs:req.body.data.relationshipwithcandidateRhs,
       capacityRhs:req.body.data.capacityRhs,
       accomplishmentsduringthetimeRhs:req.body.data.accomplishmentsduringthetimeRhs,
       ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs:req.body.data.ifyouwerepullingtogetherateamwouldyouhirethecandidateRhs,
       inwhatcapacitydoyouseethecandidateRhs:req.body.data.inwhatcapacitydoyouseethecandidateRhs,
       whatarethecandidatestrengthsRhs:req.body.data.whatarethecandidatestrengthsRhs,
       haveyouseenthecandidateoperateunderstressRhs:req.body.data.haveyouseenthecandidateoperateunderstressRhs,
       transitionintotheneworganizationRhs:req.body.data.transitionintotheneworganizationRhs,
       motivatesRhs:req.body.data.motivatesRhs,
       interfacewithotherdepartmentsRhs:req.body.data.interfacewithotherdepartmentsRhs,
       communicationsskillsoralandwrittenRhs:req.body.data.communicationsskillsoralandwrittenRhs,
       misbehaviorRhs:req.body.data.misbehaviorRhs,
       otherthoughtsaboutthecandidateRhs:req.body.data.otherthoughtsaboutthecandidateRhs,
       leadershipcapacityRhs:req.body.data.leadershipcapacityRhs,
       rateRhs:req.body.data.rateRhs,
       previousjobRhs:req.body.data.previousjobRhs,

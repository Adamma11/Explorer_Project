...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650d1a2fc176fe8818613e30":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     msmeudyam.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       nameofenterpriseRhs:req.body.data.nameofenterpriseRhs,
       twelvedigitnoRhs:req.body.data.twelvedigitnoRhs,
       majoractivityRhs:req.body.data.majoractivityRhs,
       socialcategoryRhs:req.body.data.socialcategoryRhs,
       nictwoRhs:req.body.data.nictwoRhs,
       nicfourRhs:req.body.data.nicfourRhs,
       nicfiveRhs:req.body.data.nicfiveRhs,
       activitytypeRhs:req.body.data.activitytypeRhs,
       addedtomsmeonRhs:req.body.data.addedtomsmeonRhs,
       dateofcommencementRhs:req.body.data.dateofcommencementRhs,
       dicnameRhs:req.body.data.dicnameRhs,
       applieddateRhs:req.body.data.applieddateRhs,
       validtillRhs:req.body.data.validtillRhs,

...
const checkId = `${caseObj.caseId}-${numComponents}`
  ...
  checkId: checkId,
   component:req.body.component ==null ? "650c179ec176fe88186138b8":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateMentorReviewStatus=(req,res)=>{
     directorproprietorcrc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       magistrateRhs:req.body.data.magistrateRhs,
       appelsRhs:req.body.data.appelsRhs,

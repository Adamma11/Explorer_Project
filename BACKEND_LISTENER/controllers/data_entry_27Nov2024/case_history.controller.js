...
const fs = require('fs')
exports.create = (acase,component,check,operation,status,remarks,nextfollowupdate,allocatedToVendor,allocatedToFe,allocatedToVerifier,user)=>{
	console.log("response",acase);

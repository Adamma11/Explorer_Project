const RequestForPaymentEmployment = require('../../models/data_entry/request_for_payment_employment.model')
...
exports.create=(req,res)=>{
    ...
    const requestForPaymentEmployment = new RequestForPaymentEmployment({
        case:req.body.case,
    ...
    requestForPaymentEmployment
    .save(requestForPaymentEmployment)
    .then(data=>{
        res.json(data);
    })
    .catch(err=>{
...
exports.readAllForAComponent=(req,res)=>{
    ...
    .catch(err=>{
        res.status(500).json({
            message:err.message | "An error occurred while reading Request for Payment for Employment details"
        })
    })
};

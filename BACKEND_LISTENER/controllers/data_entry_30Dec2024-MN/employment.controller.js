...
if (!req.body.status) {
    ...
    const obj = new employment({
        ...
        component: req.body.component == null ? "6723b60c1272f0f57d27d642" : req.body.component,
        checkId: checkId,
...
verifiedon: req.body.verifiedon,
mov: req.body.mov,
worktype: req.body.worktype,status: req.body.status,
...
exports.updateMentorReviewStatus = (req, res) => {
        ...
        employment.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {organizationRhs: req.body.data.organizationRhs,locationRhs: req.body.data.locationRhs,contactnoRhs: req.body.data.contactnoRhs,empidRhs: req.body.data.empidRhs,dojRhs: req.body.data.dojRhs,dorRhs: req.body.data.dorRhs,designationRhs: req.body.data.designationRhs,remunerationRhs: req.body.data.remunerationRhs,reasonforleavingRhs: req.body.data.reasonforleavingRhs,activeRhs: req.body.data.activeRhs,verifiernameRhs: req.body.data.verifiernameRhs,verifierdesignationRhs: req.body.data.verifierdesignationRhs,verifieremailidRhs: req.body.data.verifieremailidRhs,dutiesandresponsibilitiesRhs: req.body.data.dutiesandresponsibilitiesRhs,integrityRhs: req.body.data.integrityRhs,officialresgRhs: req.body.data.officialresgRhs,eligibleRhs: req.body.data.eligibleRhs,exitformalitiesRhs: req.body.data.exitformalitiesRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,movRhs: req.body.data.movRhs,worktypeRhs: req.body.data.worktypeRhs,
status: req.body.status,
...
exports.getNamesFromEmploymentMasters = async (req, res) => {
    ...
    try {
        const searchString = req.query.search
        const employmentName = await Company.find({ name: new RegExp('^' + searchString, "i") })

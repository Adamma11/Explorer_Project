...
if(!req.body.case){
   ...
   if(!req.body.institutename){
       res.status(400).json({message:'Institute Nmae required'})
   }
   if(!req.body.universityname){
       res.status(400).json({message:'University Name required'})
   }
   if(!req.body.city){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "65097f48900d66838e3c609a":req.body.component,

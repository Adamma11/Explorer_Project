...
mov: req.body.mov,   
                ...
                inputqcCompletionDate: new Date(),
                branchAllocatedTo: req.body.branch,
                verificationAllocatedTo: Types.ObjectId('67036de2a4891314b60aa4cc')
            }
...
exports.getChecksForDropbox = async (req, res) => {
    try {
        ...
        for (let i = 0; i < components.length; i++) {
	     ...
	     const data = await currComponent.find({ $or: [{ status: 'INPUTQC-ACCEPTED', verificationAllocatedTo: "67036de2a4891314b60aa4cc" }, { status: 'MENTOR-REVIEW-REJECTED', verificationAllocatedTo: "67036de2a4891314b60aa4cc" }, { status: "OUTPUTQC-REJECTED", verificationAllocatedTo: "67036de2a4891314b60aa4cc" }] })
                //.populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
		      .populate({
        path: 'case',
        populate: {

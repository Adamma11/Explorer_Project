...
if (!req.body.institutename) {
                    return res.status(400).json({ message: "institutename is Mandatory" })
                }
if (!req.body.universityname) {
                    return res.status(400).json({ message: "universityname is Mandatory" })
                }
if (!req.body.city) {
...
if (!req.body.contactnumber) {
                    return res.status(400).json({ message: "contactnumber is Mandatory" })
                }
if (!req.body.degree) {
                    return res.status(400).json({ message: "degree is Mandatory" })
                }
if (!req.body.registrationnumber) {
                    return res.status(400).json({ message: "registrationnumber is Mandatory" })
                }
if (!req.body.yearofpassing) {
                    return res.status(400).json({ message: "yearofpassing is Mandatory" })
                }
if (!req.body.status) {
    ...
    const obj = new education({
        ...
        component: req.body.component == null ? "6723b0c41272f0f57d27cfaf" : req.body.component,
        checkId: checkId,
institutename: req.body.institutename,
            institutenameRhs: null,
universityname: req.body.universityname,
            universitynameRhs: null,
city: req.body.city,
            cityRhs: null,
state: req.body.state,
            stateRhs: null,
contactnumber: req.body.contactnumber,
            contactnumberRhs: null,
degree: req.body.degree,
            degreeRhs: null,
registrationnumber: req.body.registrationnumber,
            registrationnumberRhs: null,
yearofpassing: req.body.yearofpassing,
            yearofpassingRhs: null,
    ...
    obj
        ...
        .then(data => {
            ...
            Case
                ...
                .then(async caseData => {
                    await education.findOneAndUpdate({ _id: obj._id }, { client: caseData.client, subclient: caseData.subclient })
		//.then(caseData => {
                    let checksEntered = 0
            ...
            Case
                .update({ _id: req.body.case }, { $push: { actualComponents: "education" } })
                .then(data => {
        ...
        .catch(err => {
            res.status(500).json({
                message: err.message || 'Some error while saving education'
            })
        })
};
...
exports.update = (req, res) => {
    ...
    education.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {
...
exports.findOne = (req, res) => {
    education.findOne({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
            res.json(data)
        })
        .catch(err => {
...
verifiedby: req.body.verifiedby,
verifiedon: req.body.verifiedon,
modeofverification: req.body.modeofverification,status: req.body.status,
...
exports.findComponentsForVendorManager = (req, res) => {
    ...
    education
        ...
        education.find({ status: req.params.status })
        .sort({ _id: 1 })
        .skip(offSet)
        .limit(200)
        .populate({ path: 'case', populate: { path: 'subclient', populate: { path: 'client' } } })
...
exports.updateVerificationStatus = async (req, res) => {
  try {
    ...
    const existing = await education.findOne({ case: caseId, _id: componentId });
...
exports.updateFeVerificationStatus = (req, res) => {
    education.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {institutenameRhs: req.body.institutenameRhs,universitynameRhs: req.body.universitynameRhs,cityRhs: req.body.cityRhs,stateRhs: req.body.stateRhs,contactnumberRhs: req.body.contactnumberRhs,degreeRhs: req.body.degreeRhs,registrationnumberRhs: req.body.registrationnumberRhs,yearofpassingRhs: req.body.yearofpassingRhs,verifiernameRhs: req.body.verifiernameRhs,verifierdesignationRhs: req.body.verifierdesignationRhs,verifieremailidRhs: req.body.verifieremailidRhs,verifiedbyRhs: req.body.verifiedbyRhs,verifiedonRhs: req.body.verifiedonRhs,modeofverificationRhs: req.body.modeofverificationRhs,
status: req.body.status,
    ...
    try {
        ...
        if (updated.grade == "602f8b3743383ec9a722496f") {
            ...
            if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                ...
                let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'education Details'</td><td>${updated.institutename}</td><td>${updated.gradingComments}</td></tr></table>`;
...
/*exports.updateMentorReviewStatus = (req, res) => {
        ...
        education.findOneAndUpdate({ case: req.params.caseId, _id: req.params.componentId }, {institutenameRhs: req.body.data.institutenameRhs,universitynameRhs: req.body.data.universitynameRhs,cityRhs: req.body.data.cityRhs,stateRhs: req.body.data.stateRhs,contactnumberRhs: req.body.data.contactnumberRhs,degreeRhs: req.body.data.degreeRhs,registrationnumberRhs: req.body.data.registrationnumberRhs,yearofpassingRhs: req.body.data.yearofpassingRhs,verifiernameRhs: req.body.data.verifiernameRhs,verifierdesignationRhs: req.body.data.verifierdesignationRhs,verifieremailidRhs: req.body.data.verifieremailidRhs,verifiedbyRhs: req.body.data.verifiedbyRhs,verifiedonRhs: req.body.data.verifiedonRhs,modeofverificationRhs: req.body.data.modeofverificationRhs,
status: req.body.status,
        mentorReviewCompletionDate: new Date(),
		mentorReviewComments: req.body.mentorReviewComments,
		mentorReviewCompletedBy: req.user.user_id
                        ...
                        if (subclientNotificationData != null && subclientNotificationData.subclient.email != null) {
                            Case
                                ...
                                .then(caseData => {
                                    ...
                                    let mailText = subclientNotificationData.template.content
                                    let checkDetails = `<table border='1px'><tr><td>Case Id</td><td>Candidate Name</td><td>Component</td><td>Field Value</td><td>Comments</td></tr><tr><td>${caseData.caseId}</td><td>${caseData.candidateName}</td><td>'education Details'</td><td>${data.institutename}</td><td>${data.gradingComments}</td></tr></table>`
                                    let changedMailText = mailText.replace('&lt;&lt;DISCREPANCY-TABLE&gt;&gt;', checkDetails)
...
exports.deleteCheck = (req, res) => {
    education.findOneAndDelete({ case: req.params.caseId, _id: req.params.componentId })
        .then(data => {
...
exports.addquicknote = async (req, res) => {
    try {
        const caseData = await education.findOne({ _id: req.body._id })
        const caseComments = []
        ...
        const updatedCaseData = await education.findOneAndUpdate({ _id: req.body._id }, { comments: caseComments })
...
exports.getAllquicknoteForACheck = async (req, res) => {
    try {
        ...
        const caseData = await education.findOne({ _id: req.params.case_id })
...
exports.createForCde = (req, res) => {
    console.log("In education Create for CDE")
    let caseId = req.caseId
    if (!req.body.case) {
        res.status(400).json({ message: "Case Id is Mandatory" })
    }
if (!req.body.institutename) {
            res.status(400).json({ message: "institutename is Mandatory" })
        }
if (!req.body.universityname) {
            res.status(400).json({ message: "universityname is Mandatory" })
        }
if (!req.body.city) {
...
if (!req.body.contactnumber) {
            res.status(400).json({ message: "contactnumber is Mandatory" })
        }
if (!req.body.degree) {
            res.status(400).json({ message: "degree is Mandatory" })
        }
if (!req.body.registrationnumber) {
            res.status(400).json({ message: "registrationnumber is Mandatory" })
        }
if (!req.body.yearofpassing) {
            res.status(400).json({ message: "yearofpassing is Mandatory" })
        }
...
exports.findOneForCde = (req, res) => {
    console.log("In education for CDE Find One")
    let caseId = req.caseId
    if (caseId != null) {
        education.findOne({ case: req.params.caseId, serialNumber: req.params.serialNumber })
            .then(data => {
                res.json(data)
            })
            .catch(err => {

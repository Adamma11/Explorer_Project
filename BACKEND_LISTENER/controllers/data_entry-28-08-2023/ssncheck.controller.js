...
if(!req.body.case){
   ...
   if(!req.body.ssnnumber){
       res.status(400).json({message:'SSN Number required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e0711da4885b59f88ff20":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     ssncheck.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       ssnnumberRhs:req.body.ssnnumberRhs,
         status:req.body.status,

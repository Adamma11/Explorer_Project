...
if(!req.body.case){
   ...
   if(!req.body.firstnameasperpassportidproofsubmitted){
       res.status(400).json({message:'First Name As per Passport ID proof submitted required'})
   }
   if(!req.body.middlenameasperpassportidproofsubmitted){
       res.status(400).json({message:'Middle Name As per Passport ID proof submitted required'})
   }
   if(!req.body.lastnameasperpassportidproofsubmitted){
       res.status(400).json({message:'Last Name As per Passport ID proof submitted required'})
   }
   ...
   if(!req.body.passportnumber){
       res.status(400).json({message:'Passport Number required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e0cdbda4885b59f890007":req.body.component,
       firstnameasperpassportidproofsubmitted:req.body.firstnameasperpassportidproofsubmitted,
       firstnameasperpassportidproofsubmittedRhs:null,
       middlenameasperpassportidproofsubmitted:req.body.middlenameasperpassportidproofsubmitted,
       middlenameasperpassportidproofsubmittedRhs:null,
       lastnameasperpassportidproofsubmitted:req.body.lastnameasperpassportidproofsubmitted,
       lastnameasperpassportidproofsubmittedRhs:null,
       dateofbirth:req.body.dateofbirth,
       dateofbirthRhs:null,
       fathersname:req.body.fathersname,
       fathersnameRhs:null,
       passportnumber:req.body.passportnumber,
       passportnumberRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     fda.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       firstnameasperpassportidproofsubmittedRhs:req.body.firstnameasperpassportidproofsubmittedRhs,
       middlenameasperpassportidproofsubmittedRhs:req.body.middlenameasperpassportidproofsubmittedRhs,
       lastnameasperpassportidproofsubmittedRhs:req.body.lastnameasperpassportidproofsubmittedRhs,
       dateofbirthRhs:req.body.dateofbirthRhs,
       fathersnameRhs:req.body.fathersnameRhs,
       passportnumberRhs:req.body.passportnumberRhs,
         status:req.body.status,

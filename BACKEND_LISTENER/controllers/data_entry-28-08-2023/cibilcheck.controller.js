...
if(!req.body.case){
   ...
   if(!req.body.birthdate){
       res.status(400).json({message:'Birth Date required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e0632da4885b59f88fee2":req.body.component,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     cibilcheck.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       birthdateRhs:req.body.birthdateRhs,

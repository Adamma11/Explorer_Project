const identityanddigitalfacerecognitioncheck = require('../../models/data_entry/identityanddigitalfacerecognitioncheck.model')
...
if(!req.body.case){
   ...
   const obj = new identityanddigitalfacerecognitioncheck({
   case:req.body.case,
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645de4d3da4885b59f88fad5":req.body.component,
       name:req.body.name,
       nameRhs:null,
       ...
       idnumberRhs:null,
       photocaptureduringinterviewavailable:req.body.photocaptureduringinterviewavailable,
       photocaptureduringinterviewavailableRhs:null,
       result:req.body.result,
       resultRhs:null,
       facerecognitiondiscrepancy:req.body.facerecognitiondiscrepancy,
       facerecognitiondiscrepancyRhs:null,
   ...
   Case
   .update({_id:req.body.case},{$push:{actualComponents:"identityanddigitalfacerecognitioncheck"}})
   .then(data=>{
   ...
   .catch(err=>{
       res.status(500).json({
          message:err.message || 'Some error while saving identityanddigitalfacerecognitioncheck'
       })
   })
};
exports.findAllForACase=(req,res)=>{

 identityanddigitalfacerecognitioncheck
 ...
 .catch(err=>{
       res.status(500).json({
          message:err.message || 'Some error while retrieving identityanddigitalfacerecognitioncheck for cases'
       })
   })
};
...
if(!req.body.case){
   ...
   identityanddigitalfacerecognitioncheck.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       name:req.body.name,
       idtype:req.body.idtype,
       idnumber:req.body.idnumber,
       photocaptureduringinterviewavailable:req.body.photocaptureduringinterviewavailable,
...
exports.findOne=(req,res)=>{
   identityanddigitalfacerecognitioncheck.findOne({case:req.params.caseId,_id:req.params.componentId})
    .then(data=>{
         res.json(data)
     })
    .catch(err=>{
...
exports.findComponentsFor=(req,res)=>{
 ...
 if(req.params.for=='UPDATE-LHS'){
    ...
    identityanddigitalfacerecognitioncheck.find(query)
...
exports.findComponentsForVendorManager=(req,res)=>{
    ...
    identityanddigitalfacerecognitioncheck.find({status:req.params.status})
                    .sort({_id:1})
                    .skip(offSet)
                    .limit(200)
                    .populate({path:'case',populate:{path:'subclient',populate:{path:'client'}}})
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     identityanddigitalfacerecognitioncheck.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       photocaptureduringinterviewavailableRhs:req.body.photocaptureduringinterviewavailableRhs,
       resultRhs:req.body.resultRhs,
       facerecognitiondiscrepancyRhs:req.body.facerecognitiondiscrepancyRhs,
...
exports.deleteCheck=(req,res)=>{
   identityanddigitalfacerecognitioncheck.findOneAndDelete({case:req.params.caseId,_id:req.params.componentId})
                   .then(data=>{

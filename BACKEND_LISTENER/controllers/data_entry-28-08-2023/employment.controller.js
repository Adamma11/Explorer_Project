...
if(!req.body.case){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e0a41da4885b59f88ff85":req.body.component,
       ...
       dateofjoiningRhs:null,
       dateofreliving:req.body.dateofreliving,
       dateofrelivingRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     employment.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       dateofjoiningRhs:req.body.dateofjoiningRhs,
       dateofrelivingRhs:req.body.dateofrelivingRhs,

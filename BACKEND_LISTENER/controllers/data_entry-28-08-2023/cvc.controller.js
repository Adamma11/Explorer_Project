...
if(!req.body.case){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e11ccda4885b59f8900cd":req.body.component,
       name:req.body.name,
       nameRhs:null,
       ...
       addressRhs:null,
       cvcresult:req.body.cvcresult,
       cvcresultRhs:null,
       verifiedby:req.body.verifiedby,
       verifiedbyRhs:null,
       verificationdate:req.body.verificationdate,
       verificationdateRhs:null,
       additionalcomments:req.body.additionalcomments,
       additionalcommentsRhs:null,
       proceedings:req.body.proceedings,
       proceedingsRhs:null,
       searchincludescriminalpetitionsappealmiscellaneouspetitionrevisionappealandspecialsessionscase:req.body.searchincludescriminalpetitionsappealmiscellaneouspetitionrevisionappealandspecialsessionscase,
       searchincludescriminalpetitionsappealmiscellaneouspetitionrevisionappealandspecialsessionscaseRhs:null,
       ...
       numberofyearscoveredinverification:req.body.numberofyearscoveredinverification,
       numberofyearscoveredinverificationRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     cvc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       cvcresultRhs:req.body.cvcresultRhs,
       verifiedbyRhs:req.body.verifiedbyRhs,
       verificationdateRhs:req.body.verificationdateRhs,
       additionalcommentsRhs:req.body.additionalcommentsRhs,
       proceedingsRhs:req.body.proceedingsRhs,
       searchincludescriminalpetitionsappealmiscellaneouspetitionrevisionappealandspecialsessionscaseRhs:req.body.searchincludescriminalpetitionsappealmiscellaneouspetitionrevisionappealandspecialsessionscaseRhs,
       ...
       numberofyearscoveredinverificationRhs:req.body.numberofyearscoveredinverificationRhs,
         status:req.body.status,

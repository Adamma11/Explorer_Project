...
if(!req.body.case){
   ...
   if(!req.body.companyaddress){
       res.status(400).json({message:'Company Address required'})
   }
   if(!req.body.companylocation){
       res.status(400).json({message:'Company Location required'})
   }
   if(!req.body.companytype){
       res.status(400).json({message:'Company Type required'})
   }
   if(!req.body.featuredinfakesearch){
       res.status(400).json({message:'Featured in Fake search required'})
   }
   if(!req.body.websiteaddressactive){
       res.status(400).json({message:'Website Address Active required'})
   }
   if(!req.body.addresstype){
       res.status(400).json({message:'Address Type required'})
   }
   if(!req.body.featurednegativewebsearch){
       res.status(400).json({message:'Featured Negative Web search required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e1472da4885b59f890186":req.body.component,
       companyname:req.body.companyname,
       companynameRhs:null,
       companyaddress:req.body.companyaddress,
       companyaddressRhs:null,
       companylocation:req.body.companylocation,
       companylocationRhs:null,
       companytype:req.body.companytype,
       companytypeRhs:null,
       featuredinfakesearch:req.body.featuredinfakesearch,
       featuredinfakesearchRhs:null,
       websiteaddressactive:req.body.websiteaddressactive,
       websiteaddressactiveRhs:null,
       addresstype:req.body.addresstype,
       addresstypeRhs:null,
       contactnumber:req.body.contactnumber,
       contactnumberRhs:null,
       contactemailid:req.body.contactemailid,
       contactemailidRhs:null,
       companyfoundunderepfo:req.body.companyfoundunderepfo,
       companyfoundunderepfoRhs:null,
       companygststatus:req.body.companygststatus,
       companygststatusRhs:null,
       companygstnumber:req.body.companygstnumber,
       companygstnumberRhs:null,
       companyexistingsince:req.body.companyexistingsince,
       companyexistingsinceRhs:null,
       featurednegativewebsearch:req.body.featurednegativewebsearch,
       featurednegativewebsearchRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     companyverificationonline.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       companynameRhs:req.body.companynameRhs,
       companyaddressRhs:req.body.companyaddressRhs,
       companylocationRhs:req.body.companylocationRhs,
       companytypeRhs:req.body.companytypeRhs,
       featuredinfakesearchRhs:req.body.featuredinfakesearchRhs,
       websiteaddressactiveRhs:req.body.websiteaddressactiveRhs,
       addresstypeRhs:req.body.addresstypeRhs,
       contactnumberRhs:req.body.contactnumberRhs,
       contactemailidRhs:req.body.contactemailidRhs,
       companyfoundunderepfoRhs:req.body.companyfoundunderepfoRhs,
       companygststatusRhs:req.body.companygststatusRhs,
       companygstnumberRhs:req.body.companygstnumberRhs,
       companyexistingsinceRhs:req.body.companyexistingsinceRhs,
       featurednegativewebsearchRhs:req.body.featurednegativewebsearchRhs,
         status:req.body.status,

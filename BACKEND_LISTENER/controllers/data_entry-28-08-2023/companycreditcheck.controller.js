...
if(!req.body.case){
   ...
   if(!req.body.nameasperpancard){
       res.status(400).json({message:'Name as per Pan card required'})
   }
   if(!req.body.fathersnameasperpancard){
       res.status(400).json({message:'Fathers Name as per Pan Card required'})
   }
   if(!req.body.pannumber){
       res.status(400).json({message:'Pan Number required'})
   }
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645df4beda4885b59f88fc71":req.body.component,
       nameasperpancard:req.body.nameasperpancard,
       nameasperpancardRhs:null,
       fathersnameasperpancard:req.body.fathersnameasperpancard,
       fathersnameasperpancardRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     companycreditcheck.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       nameasperpancardRhs:req.body.nameasperpancardRhs,
       fathersnameasperpancardRhs:req.body.fathersnameasperpancardRhs,

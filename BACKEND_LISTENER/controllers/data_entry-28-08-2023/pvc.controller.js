...
if(!req.body.case){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645de3f5da4885b59f88fab7":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     pvc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       policestationaddressRhs:req.body.policestationaddressRhs,

...
if(!req.body.case){
   ...
   if(!req.body.validto){
       res.status(400).json({message:'Valid To required'})
   }
   if(!req.body.workpermitprovidedby){
       res.status(400).json({message:'Work Permit Provided By required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e08fdda4885b59f88ff76":req.body.component,
       validfrom:req.body.validfrom,
       validfromRhs:null,
       validto:req.body.validto,
       validtoRhs:null,
       workpermitprovidedby:req.body.workpermitprovidedby,
       workpermitprovidedbyRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     workpermit.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       workpermitprovidedbyRhs:req.body.workpermitprovidedbyRhs,

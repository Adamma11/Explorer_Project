...
if(!req.body.case){
   ...
   if(!req.body.directorname){
       res.status(400).json({message:'Director Name required'})
   }
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645df333da4885b59f88fc37":req.body.component,
       ...
       verifiedonRhs:null,
       sourceofverification:req.body.sourceofverification,
       sourceofverificationRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     dinverification.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       sourceofverificationRhs:req.body.sourceofverificationRhs,
         status:req.body.status,

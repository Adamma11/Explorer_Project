...
if(!req.body.case){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645dff03da4885b59f88fcf1":req.body.component,
       name:req.body.name,
       nameRhs:null,
       ...
       verifieddateRhs:null,
       verifiedby:req.body.verifiedby,
       verifiedbyRhs:null,
       verificationsource:req.body.verificationsource,
       verificationsourceRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     kyc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       verifieddateRhs:req.body.verifieddateRhs,
       verifiedbyRhs:req.body.verifiedbyRhs,
       verificationsourceRhs:req.body.verificationsourceRhs,

...
if(!req.body.case){
   ...
   if(!req.body.fathersname){
       res.status(400).json({message:'Fathers Name required'})
   }
   if(!req.body.uannumber){
       res.status(400).json({message:'UAN Number required'})
   }
   if(!req.body.result){
       res.status(400).json({message:'Result required'})
   }
   if(!req.body.previouscompany1){
       res.status(400).json({message:'Previous Company 1 required'})
   }
   if(!req.body.dojofthepreviousemployment1){
       res.status(400).json({message:'DOJ of the Previous Employment 1 required'})
   }
   if(!req.body.dorfromthepreviousemployment1){
       res.status(400).json({message:'DOR from the Previous Employment 1 required'})
   }
   if(!req.body.previouscompany2){
       res.status(400).json({message:'Previous Company 2 required'})
   }
   if(!req.body.dojofthepreviousemployment2){
       res.status(400).json({message:'DOJ of the Previous Employment 2 required'})
   }
   if(!req.body.dorfromthepreviousemployment2){
       res.status(400).json({message:'DOR from the Previous Employment 2 required'})
   }
   if(!req.body.previouscompany3){
       res.status(400).json({message:'Previous Company 3 required'})
   }
   if(!req.body.dojofthepreviousemployment3){
       res.status(400).json({message:'DOJ of the Previous Employment 3 required'})
   }
   if(!req.body.dorfromthepreviousemployment3){
       res.status(400).json({message:'DOR from the Previous Employment 3 required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645df1afda4885b59f88fbf1":req.body.component,
       name:req.body.name,
       nameRhs:null,
       dob:req.body.dob,
       dobRhs:null,
       ...
       resultRhs:null,
       previouscompany1:req.body.previouscompany1,
       previouscompany1Rhs:null,
       dojofthepreviousemployment1:req.body.dojofthepreviousemployment1,
       dojofthepreviousemployment1Rhs:null,
       dorfromthepreviousemployment1:req.body.dorfromthepreviousemployment1,
       dorfromthepreviousemployment1Rhs:null,
       previouscompany2:req.body.previouscompany2,
       previouscompany2Rhs:null,
       dojofthepreviousemployment2:req.body.dojofthepreviousemployment2,
       dojofthepreviousemployment2Rhs:null,
       dorfromthepreviousemployment2:req.body.dorfromthepreviousemployment2,
       dorfromthepreviousemployment2Rhs:null,
       previouscompany3:req.body.previouscompany3,
       previouscompany3Rhs:null,
       dojofthepreviousemployment3:req.body.dojofthepreviousemployment3,
       dojofthepreviousemployment3Rhs:null,
       dorfromthepreviousemployment3:req.body.dorfromthepreviousemployment3,
       dorfromthepreviousemployment3Rhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     uan.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       previouscompany1Rhs:req.body.previouscompany1Rhs,
       dojofthepreviousemployment1Rhs:req.body.dojofthepreviousemployment1Rhs,
       dorfromthepreviousemployment1Rhs:req.body.dorfromthepreviousemployment1Rhs,
       previouscompany2Rhs:req.body.previouscompany2Rhs,
       dojofthepreviousemployment2Rhs:req.body.dojofthepreviousemployment2Rhs,
       dorfromthepreviousemployment2Rhs:req.body.dorfromthepreviousemployment2Rhs,
       previouscompany3Rhs:req.body.previouscompany3Rhs,
       dojofthepreviousemployment3Rhs:req.body.dojofthepreviousemployment3Rhs,
       dorfromthepreviousemployment3Rhs:req.body.dorfromthepreviousemployment3Rhs,

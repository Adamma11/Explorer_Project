...
if(!req.body.case){
   ...
   if(!req.body.gapineducationbetweenfrom){
       res.status(400).json({message:'Gap in Education between From MM/YYYY to MM/YYYY required'})
   }
   if(!req.body.reasonforgapineducation){
       res.status(400).json({message:'Reason for Gap in Education required'})
   }
   if(!req.body.gapinemploymentbetweenfrom){
       res.status(400).json({message:'Gap in Employment between From MM/YYYY to MM/YYYY required'})
   }
   if(!req.body.reasonforgapinemployment){
       res.status(400).json({message:'Reason for Gap in Employment required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645e0833da4885b59f88ff51":req.body.component,
       gapineducationbetweenfrom:req.body.gapineducationbetweenfrom,
       gapineducationbetweenfromRhs:null,
       reasonforgapineducation:req.body.reasonforgapineducation,
       reasonforgapineducationRhs:null,
       gapinemploymentbetweenfrom:req.body.gapinemploymentbetweenfrom,
       gapinemploymentbetweenfromRhs:null,
       reasonforgapinemployment:req.body.reasonforgapinemployment,
       reasonforgapinemploymentRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     gapanalysis.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       gapineducationbetweenfromRhs:req.body.gapineducationbetweenfromRhs,
       reasonforgapineducationRhs:req.body.reasonforgapineducationRhs,
       gapinemploymentbetweenfromRhs:req.body.gapinemploymentbetweenfromRhs,
       reasonforgapinemploymentRhs:req.body.reasonforgapinemploymentRhs,
         status:req.body.status,

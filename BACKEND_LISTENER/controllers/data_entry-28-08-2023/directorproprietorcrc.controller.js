...
if(!req.body.case){
   ...
   if(!req.body.periodofstay){
       res.status(400).json({message:'Period of Stay required'})
   }
   if(!req.body.status){
  ...
  personalDetailsData:req.body.personalDetails,
   component:req.body.component ==null ? "645df44cda4885b59f88fc53":req.body.component,
       name:req.body.name,
       nameRhs:null,
...
exports.updateVerificationStatus=(req,res)=>{
 if(req.body.status=='VERIFICATION-COMPLETED' || req.body.verificationStatus=='FE-COMPLETED'){
     directorproprietorcrc.findOneAndUpdate({case:req.params.caseId,_id:req.params.componentId},{
       ...
       periodofstayRhs:req.body.periodofstayRhs,

...
const bankruptcyandinsolvencySchema = mongoose.Schema({
...
CandidateFatherNameRhs:{type:String},
DOB:{type:Date},
DOBRhs:{type:Date},
...
module.exports = mongoose.model('bankruptcyandinsolvency',bankruptcyandinsolvencySchema);

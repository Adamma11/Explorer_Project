...
router.post("/",addressonline.createForCde);
//router.get("/:case",addressonline.findAllForACase);
router.get("/findone/:caseId/:serialNumber",addressonline.findOneForCde);
router.post("/uploadfile",addressonline.uploadFileForCde);
...
router.delete("/deletefile/:caseId/:componentName/:componentId",addressonline.deleteFileForCde);
router.delete("/deleteallfiles/:caseId/:componentName/:componentId",addressonline.deleteAllFilesForCde);
router.get("/downloadfile/:caseId/:componentName/:componentId",addressonline.downloadFileForCde);
...
router.get("/readfilenames/:caseId/:componentName/:componentId",addressonline.readFileNamesForCde);
...
router.put("/:caseId/:componentId",addressonline.updateForCde);

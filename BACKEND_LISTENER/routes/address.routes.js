...
router.get("/findone/:caseId/:componentId",address.findOne);
router.post("/uploadfile",address.uploadFile);
...
router.delete("/deletefile/:caseId/:componentName/:componentId/:fileName",address.deleteFile);
router.delete("/deleteproofofwork/:caseId/:componentName/:componentId",address.deleteProofOfWork);
router.get("/downloadfile/:caseId/:componentName/:componentId",address.downloadFile);
router.get("/downloadproofofwork/:caseId/:componentName/:componentId",address.downloadProofOfWork);
//13-jan-23
router.get("/downloadproofofworkasjson/:caseId/:componentName/:componentId",address.downloadProofOfWorkAsJson);
//13-jan-23
router.get("/downloadpaymentproof/:caseId/:componentName/:componentId",address.downloadPaymentProof);
router.get("/readfilenames/:caseId/:componentName/:componentId",address.readFileNames);
...
router.get("/insuff/searchacaseininsuffforclient",address.searchACaseForInsuffForClient);
...
router.get("/",address.getChecksWhereGradeOneIsNullAndGradeNotNull)
router.get("/",address.getChecksWhereVerifierNotFoundInUser)

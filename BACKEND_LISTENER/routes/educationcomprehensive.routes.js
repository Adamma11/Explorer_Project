...
router.post("/",educationcomprehensive.create);
router.get("/:case",educationcomprehensive.findAllForACase);
router.get("/findone/:caseId/:componentId",educationcomprehensive.findOne);
router.post("/uploadfile",educationcomprehensive.uploadFile);
...
router.delete("/deletefile/:caseId/:componentName/:componentId/:fileName",educationcomprehensive.deleteFile);
router.delete("/deleteproofofwork/:caseId/:componentName/:componentId",educationcomprehensive.deleteProofOfWork);
router.get("/downloadfile/:caseId/:componentName/:componentId",educationcomprehensive.downloadFile);
...
router.get("/readfilenames/:caseId/:componentName/:componentId",educationcomprehensive.readFileNames);
...
router.get("/insuff/searchacaseininsuffforclient",educationcomprehensive.searchACaseForInsuffForClient);
...
router.get("/",educationcomprehensive.getChecksWhereGradeOneIsNullAndGradeNotNull)

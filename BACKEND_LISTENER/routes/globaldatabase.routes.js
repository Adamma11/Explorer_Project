...
router.post("/",globaldatabase.create);
router.get("/:case",globaldatabase.findAllForACase);
router.get("/findone/:caseId/:componentId",globaldatabase.findOne);
router.post("/uploadfile",globaldatabase.uploadFile);
...
router.delete("/deletefile/:caseId/:componentName/:componentId/:fileName",globaldatabase.deleteFile);
router.delete("/deleteproofofwork/:caseId/:componentName/:componentId",globaldatabase.deleteProofOfWork);
router.get("/downloadfile/:caseId/:componentName/:componentId",globaldatabase.downloadFile);
...
router.get("/readfilenames/:caseId/:componentName/:componentId",globaldatabase.readFileNames);
...
router.put("/:caseId/:componentId",globaldatabase.update);
...
router.get("/insuff/searchacaseininsuffforclient",globaldatabase.searchACaseForInsuffForClient);
router.get("/",globaldatabase.getChecksWhereGradeOneIsNullAndGradeNotNull)

...
router.post("/",refbasic.create);
router.get("/:case",refbasic.findAllForACase);
router.get("/findone/:caseId/:componentId",refbasic.findOne);
router.post("/uploadfile",refbasic.uploadFile);
...
router.delete("/deletefile/:caseId/:componentName/:componentId/:fileName",refbasic.deleteFile);
router.delete("/deleteproofofwork/:caseId/:componentName/:componentId",refbasic.deleteProofOfWork);
router.get("/downloadfile/:caseId/:componentName/:componentId",refbasic.downloadFile);
...
router.get("/readfilenames/:caseId/:componentName/:componentId",refbasic.readFileNames);
...
router.put("/:caseId/:componentId",refbasic.update);
...
router.get("/insuff/searchacaseininsuffforclient",refbasic.searchACaseForInsuffForClient);
...
router.get("/",refbasic.getChecksWhereGradeOneIsNullAndGradeNotNull)

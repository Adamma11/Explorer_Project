...
router.post("/",empbasic.create);
router.get("/:case",empbasic.findAllForACase);
router.get("/findone/:caseId/:componentId",empbasic.findOne);
router.post("/uploadfile",empbasic.uploadFile);
...
router.delete("/deletefile/:caseId/:componentName/:componentId",empbasic.deleteFile);
router.delete("/deleteproofofwork/:caseId/:componentName/:componentId",empbasic.deleteProofOfWork);
router.get("/downloadfile/:caseId/:componentName/:componentId",empbasic.downloadFile);
...
router.get("/readfilenames/:caseId/:componentName/:componentId",empbasic.readFileNames);
...
router.put("/:caseId/:componentId",empbasic.update);
...
router.get("/insuff/searchacaseininsuffforclient",empbasic.searchACaseForInsuffForClient);
router.get("/",empbasic.getChecksWhereGradeOneIsNullAndGradeNotNull)

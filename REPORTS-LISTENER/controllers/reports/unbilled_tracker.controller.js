...
//    console.log("Sheet added")	
    sheet.addRow(["Case Id","Candidate Name","Candidate Id","Client","Subclient","Profile Name","Initiation Date","Insuff. Raised Date","Insuff. Cleared Date","TAT End Date","Status","Grade","Closure Type","Completion Date","TAT Days","Actual Days Taken","Total Price","Check 1 - Name","Check 1 - Field 1","Check 1 - Field 2","Check 1 - Field 3","Check 1 - Status","Check 1 - Completion Date","Check 1 - Color Code","Check 1 Written Price","Check 1 Verbal Price","Check 1 Online Price","Check 1 PV Price","Check 1 Total Price","Check 2 - Name","Check 2 - Field 1","Check 2 - Field 2","Check 2 - Field 3","Check 2 - Status","Check 2 - Completion Date","Check 2 - Color Code","Check 2 Written Price","Check 2 Verbal Price","Check 2 Online Price","Check 2 PV Price","Check 2 Total Price","Check 3 - Name","Check 3 - Field 1","Check 3 - Field 2","Check 3 - Field 3","Check 3 - Status","Check 3 - Completion Date","Check 3 - Color Code","Check 3 Written Price","Check 3 Verbal Price","Check 3 Online Price","Check 3 PV Price","Check 3 Total Price","Check 4 - Name","Check 4 - Field 1","Check 4 - Field 2","Check 4 - Field 3","Check 4 - Status","Check 4- Completion Date","Check 4 - Color Code","Check 4 Written Price","Check 4 Verbal Price","Check 4 Online Price","Check 4 PV Price","Check 4 Total Price","Check 5 - Name","Check 5 - Field 1","Check 5 - Field 2","Check 5 - Field 3","Check 5 - Status","Check 5 - Completion Date","Check 5 - Color Code","Check 5 Written Price","Check 5 Verbal Price","Check 5 Online Price","Check 5 PV Price","Check 5 Total Price","Check 6 - Name","Check 6 - Field 1","Check 6 - Field 2","Check 6 - Field 3","Check 6 - Status","Check 6 - Completion Date","Check 6 - Color Code","Check 6 Written Price","Check 6 Verbal Price","Check 6 Online Price","Check 6 PV Price","Check 6 Total Price","Check 7 - Name","Check 7 - Field 1","Check 7 - Field 2","Check 7 - Field 3","Check 7 - Status","Check 7 - Completion Date","Check 7 - Color Code","Check 7 Written Price","Check 7 Verbal Price","Check 7 Online Price","Check 7 PV Price","Check 7 Total Price","Check 8 - Name","Check 8 - Field 1","Check 8 - Field 2","Check 8 - Field 3","Check 8 - Status","Check 8 - Completion Date","Check 8 - Color Code","Check 8 Written Price","Check 8 Verbal Price","Check 8 Online Price","Check 8 PV Price","Check 8 Total Price","Check 9 - Name","Check 9 - Field 1","Check 9 - Field 2","Check 9 - Field 3","Check 9 - Status","Check 9 - Completion Date","Check 9 - Color Code","Check 9 Written Price","Check 9 Verbal Price","Check 9 Online Price","Check 9 PV Price","Check 9 Total Price","Check 10 - Name","Check 10 - Field 1","Check 10 - Field 2","Check 10 - Field 3","Check 10 - Status","Check 10 - Completion Date","Check 10 - Color Code","Check 10 Written Price","Check 10 Verbal Price","Check 10 Online Price","Check 10 PV Price","Check 10 Total Price","Check 11 - Name","Check 11 - Field 1","Check 11 - Field 2","Check 11 - Field 3","Check 11 - Status","Check 11 - Completion Date","Check 11 - Color Code","Check 11 Written Price","Check 11 Verbal Price","Check 11 Online Price","Check 11 PV Price","Check 11 Total Price","Check 12 - Name","Check 12 - Field 1","Check 12 - Field 2","Check 12 - Field 3","Check 12 - Status","Check 12 - Completion Date","Check 12 - Color Code","Check 12 Written Price","Check 12 Verbal Price","Check 12 Online Price","Check 12 Total Price","Check 13 - Name","Check 13 - Field 1","Check 13 - Field 2","Check 13 - Field 3","Check 13 - Status","Check 13 - Completion Date","Check 13 - Color Code","Check 13 Written Price","Check 13 Verbal Price","Check 13 Online Price","Check 13 PV Price","Check 13 total Price","Check 14 - Name","Check 14 - Field 1","Check 14 - Field 2","Check 14 - Field 3","Check 14 - Status","Check 14 - Completion Date","Check 14 - Color Code","Check 14 Written Price","Check 14 Verbal Price","Check 14 Online Price","Check 14 PV Price","Check 14 Total Price","Check 15 - Name","Check 15 - Field 1","Check 15 - Field 2","Check 15 - Field 3","Check 15 - Status","Check 15 - Completion Date","Check 15 - Color Code","Check 15 Written Price","Check 15 Verbal Price ","Check 15 Online Price","Check 15 PV Price","Check 15 Total Price","Check 16 - Name","Check 16 - Field 1","Check 16 - Field 2","Check 16 - Field 3","Check 16 - Status","Check 16 - Completion Date","Check 16 - Color Code","Check 16 Written Price","Check 16 Verbal Price","Check 16 Online Price","Check 16 PV Price","Check 16 Total Price","Check 17 - Name","Check 17 - Field 1","Check 17 - Field 2","Check 17 - Field 3","Check 17 - Status","Check 17 - Completion Date","Check 17 - Color Code","Check 17 Written Price","Check 17 Verbal Price","Check 17 Online Price","Check 17 PV Price","Check 17 Total Price","Check 18 - Name","Check 18 - Field 1","Check 18 - Field 2","Check 18 - Field 3","Check 18 - Status","Check 18 - Completion Date","Check 18 - Color Code","Check 18 Written Price","Check 18 Verbal Price","Check 18 Online Price","Check 18 PV Price","Check 18 total Price","Check 19 - Name","Check 19 - Field 1","Check 19 - Field 2","Check 19 - Field 3","Check 19 - Status","Check 19 - Completion Date","Check 19 - Color Code","Check 19 Written Price","Check 19 Verbal Price","Check 19 Online Price","Check 19 PV Price","Check 19 Total Price","Check 20 - Name","Check 20 - Field 1","Check 20 - Field 2","Check 20 - Field 3","Check 20 - Status","Check 20 - Completion Date","Check 20 - Color Code","Check 20 Written Price","Check 20 Verbal Price","Check 20 Online Price","Check 20 PV Price","Check 20 Total Price"])
...
/*    let query = {status:{$ne:'OUTPUTQC-ACCEPTED'}}
    ...
    if(req.query.reportfor == 'COMPLETED'){*/
      let query = {status:"OUTPUTQC-ACCEPTED",outputqcCompletionDate:{$gte:req.query.fromDate,$lte:req.query.toDate},invoiceNumber:null,invoiceDate:null,invoiceAmount:0}	    
/*    }	   
...
/*                let uniqueComponents = new Array()
    ...
    let getEmploymentDetails = function(acase,packagePrice,contractDetails){
//	console.log("Trying to fetch employment details for case status report for the case ")    
		...
		for(let i=0; i < data.length;i++){
		   ...
		   let pvPrice = 0
		   let totalPrice = 0
		   console.log("Item Mode is ",item.mode)	
	           console.log("Package price is ",packagePrice)	
		   if(packagePrice == 0){
	             console.log("Contract Details are........",contractDetails)		   
	             console.log("Component details are ....",item.component)		   
		     let clientContractComponentDetails = await getClientContractComponentDetails(contractDetails._id,item.component._id) 	  
		     console.log("Item Mode is ",item.mode)	   
	             if(item.mode=='WRITTEN'){
		       writtenPrice = clientContractComponentDetails.price    	     
		     }else if (item.mode=='VERBAL'){
		       verbalPrice = clientContractComponentDetails.verbalPrice	     
		     }else if(item.mode=='ONLINE'){
		       onlinePrice = clientContractComponentDetails.onlinePrice	     
		     }
		     totalPrice = writtenPrice + verbalPrice + onlinePrice + pvPrice	  
	             totalForTheCase = totalForTheCase + totalPrice		   
		   }else{
                     totalForTheCase = packagePrice
                   } 	
                   details = details + "^" + item.empstatus + "^" + item.nameofemployer + "^" + item.branch + "^" + ((item.status == 'MENTOR-REVIEW-ACCEPTED' || item.status=='OUTPUTQC-ACCEPTED')? "Completed" :(item.status.substring(0,5) == "INSUF" ? "Insufficiency" : "In Progress")) + "^" + ((item.status == 'MENTOR-REVIEW-ACCEPTED' || item.status=='OUTPUTQC-ACCEPTED') ?  moment(item.mentorReviewCompletionDate).format('DD-MMM-YYYY'):"") + "^" + ((item.status  == "MENTOR-REVIEW-ACCEPTED" || item.status=='OUTPUTQC-ACCEPTED')? (item.grade != null ? getColorCodeName(item.grade) : "Green"):"")+"^"+writtenPrice+"^"+verbalPrice+"^"+onlinePrice+"^"+pvPrice+"^"+totalPrice
//	           sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployer,item.branch,item.deputedto,item.empstatus,item.empid,item.doj,item.lwd,item.designation,item.reportingmgr,item.reasonforleaving])		
    ...
    let getEmpBasicDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            empbasic
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                       sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployer,item.branch,item.deputedto,item.empstatus,item.empid,item.doj,item.lwd,item.designation,item.reportingmgr,item.reasonforleaving])
    ...
    let getEmpAdvanceDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            empadvance
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
		...
		let details = ""    
		     ...
		     totalForTheCase = totalForTheCase + totalPrice	   
                   ...
                   details = details  + "^" + item.empstatus + "^" + item.nameofemployer + "^" + item.branch + "^" + ((item.status == 'MENTOR-REVIEW-ACCEPTED' || item.status=='OUTPUTQC-ACCEPTED')? "Completed" :(item.status.substring(0,5) == "INSUF" ? "Insufficiency" : "In Progress")) + "^" + ((item.status == 'OUTPUTQC-ACCEPTED' || item.status=='MENTOR-REVIEW-ACCEPTED') ?  moment(item.mentorReviewCompletionDate).format('DD-MMM-YYYY'):"") + "^" + ((item.status  == "OUTPUTQC-ACCEPTED" || item.status=='MENTOR-REVIEW-ACCEPTED')? (item.grade != null ? getColorCodeName(item.grade) : "Green"):"")+"^"+writtenPrice+"^"+verbalPrice+"^"+onlinePrice+"^"+pvPrice+"^"+totalPrice
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployer,item.branch,item.deputedto,item.empstatus,item.empid,item.doj,item.lwd,item.designation,item.reportingmgr,item.reasonforleaving])
    ...
    let getEducationDetails = function(acase,packagePrice,contractDetails){
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofuniversity,item.nameofschool,item.cityofstudy,item.typeofqualification,item.qualification,item.specialization,item.rollnumber,item.yearofjoining,item.yearofcompletion,item.marks])
    ...
    let getEducationAdvancedDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            educationadvanced
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofuniverskty,item.nameofschool,item.cityofstudy,item.typeofqualification,item.qualification,item.specialization,item.rollnumber,item.yearofjoining,item.yearofcompletion,item.marks])
    ...
    let getEducationComprehensiveDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofuniversity,item.nameofschool,item.cityofstudy,item.typeofqualification,item.qualification,item.specialization,item.rollnumber,item.yearofjoining,item.yearofcompletion,item.marks])
    ...
    let getAddressDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            address
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.address,item.landmark,item.pin,item.city,item.typeofaddress,item.tenureofstay,item.primarycontact,item.alternatecontact,contactNumber])
    ...
    let getAddressComprehensiveDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.fulladdress,item.landmark,item.pin,item.city,item.typeofaddress,item.tenureofstay,item.primarycontact,item.alternatecontact])
    ...
    let getAddressOnlineDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            addressonline
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.fulladdresswithpin,item.landmark,item.pin,item.city,item.typeofaddress,item.tenure,item.primarycontact,item.alternatecontact])
    ...
    let getAddressTelephoneDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            addresstelephone
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([item.component.displayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.address,item.landmark,item.pin,item.city,item.typeofaddress,item.tenureofstay,item.primarycontact,item.alternatecontact])
    ...
    let getCourtRecordDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            courtrecord
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.addresswithpin,item.pin,item.city,item.typeofaddress,item.tenure])
    ...
    let getCriminalRecordDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            criminalrecord
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.fulladdress,item.pin,item.city,item.typeofaddress,item.tenureofstay])
    ...
    let getReferenceDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            reference
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofreference,item.deisgnation,item.contactdetails])
    ...
    let getRefBasicDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            refbasic
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.name,item.designation,item.contact])
    ...
    let getIdentityDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            identity
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.typeofid,item.nameasperid,item.idnumber,item.issuedby])
    ...
    let getCreditCheckDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            creditcheck
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.taxid,item.nameasperpan,item.dateofbirth,item.issuedby])
    ...
    let getCreditTransDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            credittrans
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.pannumber,item.nameasperpan,item.dateofbirth,item.issuedby])
    ...
    let getCreditEquifaxDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            creditequifax
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.pannumber,item.panname,item.dobofpan,item.gender,item.fulladdress,item.contact,item.altcontact])
    ...
    let getGlobaldatabaseDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            globaldatabase
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.searchname])
    ...
    let getDrugTestFiveDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            drugtestfive
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployee,item.fulladdress,item.pin,item.city,item.contact])
    ...
    let getDrugTestSixDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            drugtestsix
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployee,item.fulladdress,item.pin,item.city,item.contact])
    ...
    let getDrugTestSevenDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            drugtestseven
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemploybee,item.fulladdress,item.pin,item.city,item.contactnumber])
    ...
    let getDrugTestEightDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            drugtesteight
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployee,item.address,item.pin,item.city,item.contact])
    ...
    let getDrugTestNineDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            drugtestnine
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.consent,item.fulladdress,item.pin,item.city,item.contact])
    ...
    let getDrugTestTenDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            drugtestten
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.nameofemployee,item.address,item.pin,item.city,item.contact])
    ...
    let getDlCheckDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            dlcheck
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.dlnumber,item.nameperdl,item.dob,item.issuedate,item.dlvalid])
    ...
    let getDirectorshipCheckDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            directorshipcheck
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.directorname,item.dinnumber,item.dob,item.verifiedon])
    ...
    let getVoterIdDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            voterid
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.epicnumber,item.epicname,item.fulladdress,item.pin,item.city,item.contactnumber])
    ...
    let getVddAdvanceDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            vddadvance
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.companyname,item.regdadd,item.cin,item.pan,item.gst])
    ...
    let getBankStmtDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            bankstmt
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.tenure,item.nameofbank,item.transaction])
    ...
    let getSiteCheckDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            sitecheck
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.name,item.fulladdress,item.pin,item.city])
    ...
    let getPsychometricDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            physostan
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.name,item.emailid,item.contact,item.gender])
    ...
    let getSocialMediaDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            socialmedia
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
  ...
  //                 sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.searchname])
    ...
    let getFacisl3Details = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            facisl3
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.applicantname,item.dateofbirth,item.stcode])
    ...
    let getOfacDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            ofac
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
 ...
 //                  sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.candname,item.ofac])
    ...
    let getGapVfnDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            gapvfn
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//                   sheet.addRow([componentDisplayName,item.status,item.case.initiationDate,item.case.tatEndDate,verifier,fe,vendor,item.tenureofgap,item.reasonforgap,item.address,item.PIN,item.CITY])
    ...
    let getPassportDetails = function(acase,packagePrice,contractDetails){
        return new Promise((resolve,reject)=>{
            passport
            .find({case:acase})
            .populate({path:'verificationAllocatedTo'})
...
//		console.log("About to get employment details")
		...
		console.log("got Personal details")    
                let employmentDetails = await getEmploymentDetails(item._id,packagePrice,contractDetails)
		console.log("got employment details")    
                let empbasicDetails = await getEmpBasicDetails(item._id,packagePrice,contractDetails)
		console.log("got employment basic details")    
                let empadvanceDetails = await getEmpAdvanceDetails(item._id,packagePrice,contractDetails)
		console.log("Got employment advanced details")    
                let educationDetails = await getEducationDetails(item._id,packagePrice,contractDetails)
		console.log("Got education details")    
                let educationAdvancedDetails = await getEducationAdvancedDetails(item._id,packagePrice,contractDetails)
                let educationComprehensiveDetails = await getEducationComprehensiveDetails(item._id,packagePrice,contractDetails)
                let addressDetails = await getAddressDetails(item._id,packagePrice,contractDetails)
                let addressComprehensiveDetails = await getAddressComprehensiveDetails(item._id,packagePrice,contractDetails)
                let addressOnlineDetails = await getAddressOnlineDetails(item._id,packagePrice,contractDetails)
                let addressTelephoneDetails = await getAddressTelephoneDetails(item._id,packagePrice,contractDetails)
                let courtRecordDetails = await getCourtRecordDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get criminal record for case status")
                let criminalRecordDetails = await getCriminalRecordDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get reference details for case status")
                let referenceRecordDetails = await getReferenceDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get ref basic for case status")
                let refBasicDetails = await getRefBasicDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get identity details for case status")
                let identityDetails = await getIdentityDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get credi check for case status")
                let creditCheckDetails = await getCreditCheckDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get credit trans  for case status")
                let credittransDetails = await getCreditTransDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get credit equifax for case status")
                let creditEquifaxDetails = await getCreditEquifaxDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get globaldatabase check for case status")
                let globaldatabaseDetails = await getGlobaldatabaseDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get drug test five for case status")
                let drugtestfiveDetails = await getDrugTestFiveDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get drug test six for case status")
                let drugtestsixDetails = await getDrugTestSixDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get drug test seven for case status")
                let drugtestsevenDetails = await getDrugTestSevenDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get drug test eight for case status")
                let drugtesteightDetails = await getDrugTestEightDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get drug test nine for case status")
                let drugtestnineDetails = await getDrugTestNineDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get drug test ten for case status")
                let drugtesttenDetails = await getDrugTestTenDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get dl check for case status")
                let dlCheckDetails = await getDlCheckDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get dirctorship for case status")
                let directorshipCheckDetails = await getDirectorshipCheckDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get voter id details for case status")
                let voterIdDetails = await getVoterIdDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get vdd advance details for case status")
                let vddAdvanceDetails = await getVddAdvanceDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get bank stmt for case status")
                let bankStmtDetails = await getBankStmtDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get site check details for case status")
                let siteCheckDetails = await getSiteCheckDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get psychometric details for case status")
                let psychometricDetails = await getPsychometricDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get social media details for case status")
                let socialmediaCheckDetails = await getSocialMediaDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get facisl l3 details for case status")
                let facisl3Details = await getFacisl3Details(item._id,packagePrice,contractDetails)
//		console.log("About to gat ofac details for case status")
                let ofacDetails = await getOfacDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get gap vfn details for case status")
                let gapvfnDetails = await getGapVfnDetails(item._id,packagePrice,contractDetails)
//		console.log("About to get passport details for case status")
                let passportDetails = await getPassportDetails(item._id,packagePrice,contractDetails)
		let rowValues = []

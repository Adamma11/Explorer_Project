...
exports.capgeminiWordReport = (req,res)=>{
 ...
 function getCamDetails(camCode){
    return new Promise((resolve,reject)=>{	 
      User
      .findOne({_id:camCode})
      .lean()	 
 ...
 let getProfileDetails = function(profileCode){
...
//   		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/employment/" + item._id + "/proofofwork",req.user.user_id)
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/empbasic/" + item._id + "/proofofwork",req.user.user_id)		       
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
		  execSumEmpDet.push(det)     
                }
                resolve(data)
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/empadvance/" + item._id + "/proofofwork",req.user.user_id)     
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
                  execSumEmpDet.push(det)
                }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/education/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/educationadvanced/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
                  execSumEduDet.push(det)
                }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/educationcomprehensive/" + item._id + "/proofofwork",req.user.user_id)    
//                  await new Promise(resolve => setTimeout(resolve, 10000));
                  execSumEduDet.push(det)
                }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/address/" + item._id + "/proofofwork",req.user.user_id)     
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/addresscomprehensive/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
                  execSumAddressDet.push(det)
                }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/addressonline/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
                  execSumAddressDet.push(det)
                }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/addesstelephone/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
                  execSumAddressDet.push(det)
                }
...
//          	  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/courtrecord/" + item._id + "/proofofwork",req.user.user_id)     
...
//                  execSumDet.push(det)
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/criminalrecord/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/reference/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
//     		  execSumDet.push(det)
	       }	    
               resolve(data)
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/refbasic/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
  //                execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/identity/" + item._id + "/proofofwork",req.user.user_id)    
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/creditcheck/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
//                  execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/credittrans/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
  //                execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/creditequifax/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
//                  execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/globaldatabase/" + item._id + "/proofofwork",req.user.user_id)     
//		   await new Promise(resolve => setTimeout(resolve, 10000));     
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/drugtestfive/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
  //                execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/drugtestsix/" + item._id + "/proofofwork",req.user.user_id)     
//		  await new Promise(resolve => setTimeout(resolve, 10000));     
//                  execSumDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/drugtestseven/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/drugtesteight/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/drugtestnine/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/drugtestten/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/dlcheck/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/directorshipcheck/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
//                  execSumDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/voterid/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
//                  execSumDet.push(det)
               }
	       resolve(data)	    
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/vddadvance/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/bankstmt/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));
		       
                  execSumBankStmtDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/sitecheck/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/physostan/" + item._id + "/proofofwork",req.user.user_id)
///		  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/socialmedia/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/facisl3/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//                  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/ofac/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//		  await createJpgs("/REPO_STORAGE/case_uploads/" + item.case.caseId + "/gapvfn/" + item._id + "/proofofwork",req.user.user_id)
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
//                  execSumDet.push(det)
               }
...
//          createJpgs("/REPO_STORAGE/case_uploads/"+ caseDetails.caseId + "/loa",req.user.user_id)
...
//	  await new Promise(resolve => setTimeout(resolve,10000))      
	...
	let camDetails = await getCamDetails(caseDetails.subclient.cam)    
	let personalDetailsFromDb = await getPersonalDetailsFromDb(caseDetails._id)    
//        let personalDetails  = await getPersonalDetails()
//	let profileName = await getProfileDetails(caseDetails.profile)    
//	let reportTypeTable = await getReportTypeTable(caseDetails)
...
// get check related data for the report
	...
	let loaDetails = await getLoaDetails(caseDetails) 
        ...
        let result = await writeWordDocument(addressDetails,addressComprehensiveDetails,addressOnlineDetails,addressTelephoneDetails,courtRecordDetails,criminalRecordDetails,educationDetails,educationAdvancedDetails,educationComprehensiveDetails,employmentDetails,empbasicDetails,empadvanceDetails,referenceRecordDetails,refBasicDetails,identityDetails,creditCheckDetails,credittransDetails,creditEquifaxDetails,globaldatabaseDetails,drugtestfiveDetails,drugtestsixDetails,drugtestsevenDetails,drugtesteightDetails,drugtestnineDetails,drugtesttenDetails,dlCheckDetails,directorshipCheckDetails,voterIdDetails,vddAdvanceDetails,bankStmtDetails,siteCheckDetails,psychometricDetails,socialMediaDetails,facisl3Details,ofacDetails,gapvfnDetails,passportDetails,colorMasterDetails,camDetails,caseDetails,personalDetailsFromDb,execSumAddressDet,execSumCourtRecordDet,execSumEduDet,execSumEmpDet,execSumGlobalDatabaseDet,execSumBankStmtDet,getProfileDetails(caseDetails.profile),getPackageDetails(caseDetails.package));

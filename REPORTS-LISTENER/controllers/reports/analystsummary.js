...
exports.getNewAnalystsummaryTrackerReport = (req, res) => {
  ...
  const sheet = workBook.addWorksheet('Analyst Summary')
  console.log("Sheet added")
  let addedRow = sheet.addRow(["COMPONENT NAME","COUNT","WEIGHTAGE"])
  addedRow.commit()
  let query = ""
  if (req.query.reportType == 'PENDING') {
    query = { $and: [{ status: { $ne: "MENTOR-REVIEW-ACCEPTED" } }, { status: { $ne: "OUTPUTQC-ACCEPTED" } },{verificationAllocatedTo:req.user.user_id}] }
  ...
  if (req.query.reportType == 'COMPLETED') {
    query = { $and: [{ $or: [{ status: 'MENTOR-REVIEW-ACCEPTED' }, { status: 'OUTPUTQC-ACCEPTED' }] }, { mentorReviewCompletionDate: { $gte: req.query.dateFrom, $lte: req.query.dateTo + "T23:59:59.999Z" } },{verificationAllocatedTo:req.user.user_id}] }
  }
  ...
  let getEmploymentDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .count(query)
        .then(data=>{
	 finalCount = (data*weightageNo)	
    console.log("Employment count is ",data)    
    let ar = sheet.addRow(["Employment Verification - Comprehensive" ,data, finalCount])
    ar.commit() 
    resolve(data)    
        })
        .catch(err=>{
...
let getEmpBasicDetails = function(){
    ...
    let ar = sheet.addRow(["Education Verification - Basic" ,data, finalCount])
    ar.commit()   
            resolve(data)
        })
        .catch(err=>{
...
let getEmpAdvanceDetails = function(){
    ...
    let ar = sheet.addRow(["Employment Verification - Advanced" ,data, finalCount])
    ar.commit() 
            resolve(data)
        })
        .catch(err=>{
...
console.log("In Education Advanced Details")    
    ...
    let ar = sheet.addRow(["Education Verification - Advanced" ,data, finalCount])
    ar.commit()   
            resolve(data)
        })
        .catch(err=>{
...
let getEducationComprehensiveDetails = function(){
    ...
    let ar = sheet.addRow(["Education Verification - Comprehensive" ,data, finalCount])
    ar.commit() 
            resolve(data)
        })
        .catch(err=>{
...
let getAddressDetails = function(){
    ...
    let ar = sheet.addRow(["Address Verification - Advanced" ,data, finalCount])
    ar.commit()    
            resolve(data)
        })
        .catch(err=>{
...
let getAddressComprehensiveDetails = function(){
    ...
    let ar = sheet.addRow(["Address Verification - Comprehensive" ,data, finalCount])
    ar.commit()      
            resolve(data)
        })
        .catch(err=>{
...
let getAddressOnlineDetails = function(){
    ...
    let ar = sheet.addRow(["Address Check - Online" ,data, finalCount])
    ar.commit() 
            resolve(data)
        })
        .catch(err=>{
...
let getAddressTelephoneDetails = function(){
    ...
    let ar = sheet.addRow(["Address Check - Telephonic" ,data, finalCount])
    ar.commit()  
            resolve(data)
        })
        .catch(err=>{
...
console.log("In Court Record , query is ",query)    
    ...
    let ar = sheet.addRow(["Court Record Check - Online" ,data, finalCount])
    ar.commit() 
            resolve(data)
        })
        .catch(err=>{
...
let getCriminalRecordDetails = function(){
    ...
    let ar = sheet.addRow(["Criminal Record Check" ,data, finalCount])
    ar.commit() 
            resolve(data)
        })
        .catch(err=>{
...
let getReferenceDetails = function(){
    ...
    let ar = sheet.addRow(["Reference Check - Advanced" ,data, finalCount])
    ar.commit()   
            resolve(data)
        })
        .catch(err=>{
...
let getRefBasicDetails = function(){
    ...
    let ar = sheet.addRow(["Reference Check - Basic" ,data, finalCount])
    ar.commit()    
            resolve(data)
        })
        .catch(err=>{
...
let getIdentityDetails = function(){
    ...
    let ar = sheet.addRow(["Identity Check" ,data, finalCount])
    ar.commit()   
            resolve(data)
        })
        .catch(err=>{
...
const weightageNo = 0.85
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
        let ar = sheet.addRow(["Credit Check - Basic" ,data, finalCount])
        ar.commit()  
            resolve(data)
        })
        .catch(err=>{
...
let getCreditTransDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Credit Check - TransUnion" ,data, finalCount])
          ar.commit()  
            resolve(data)
        })
        .catch(err=>{
...
let getCreditEquifaxDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Credit Check - Equifax" ,data, finalCount])
          ar.commit()  
            resolve(data)
        })
        .catch(err=>{
...
let getGlobaldatabaseDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Global Database Search" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDrugTestFiveDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Drug Test - 5 Panel" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDrugTestSixDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Drug Test 6 Panel" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDrugTestSevenDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Drug Test 7 Panel" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDrugTestEightDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Drug Test 8 Panel" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDrugTestNineDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Drug Test 9 Panel" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDrugTestTenDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Drug Test 10 Panel" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDlCheckDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Driving License Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getDirectorshipCheckDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Directorship Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getVoterIdDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Voter ID Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getVddAdvanceDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Vendor Due Diligence" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getSiteCheckDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Site Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getPsychometricDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Psychometric Standard" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getSocialMediaDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Social Media Search" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getFacisl3Details = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["FACIS L3 Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getOfacDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["OFAC Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getGapVfnDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["GAP Verification" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{
...
let getPassportDetails = function(){
    ...
    return new Promise((resolve,reject)=>{
        ...
        .then(data=>{
		finalCount = (data*weightageNo)
          let ar = sheet.addRow(["Passport Check" ,data, finalCount])
          ar.commit()
            resolve(data)
        })
        .catch(err=>{

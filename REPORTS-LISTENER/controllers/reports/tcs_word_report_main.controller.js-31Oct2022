...
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
		  execSumDet.push(det)   
            ...
            .catch(err=>{
		console.log("Error in employment basic details ",err)    
                reject()
            })
        })
...
//                  await new Promise(resolve => setTimeout(resolve, 10000));		       
	...
	console.log("Got address online details")    
	...
	console.log("Got court record details")    
	...
	console.log("Got Identity Details")    
	...
	console.log("Got Global Database Details")    
